...
class YAMLChecker:
    ...
    TYPER_DICT = {
        ...
        "major"                     : (float, int, type(None)),
        "minor"                     : (float, int, type(None)),
        "numberOfThreads"           : (float, int, type(None)),
        "numberOfProblems"          : (float, int, type(None)),
        "numberOfDenseOutput"       : (float, int, type(None)),
        "threadsPerBlock"           : (float, int, type(None)),
        "initialTimeStep"           : (float, int, type(None)),
        "preferSharedMemory"        : (bool, type(None)),
        "maximumTimeStep"           : (float, int, type(None)),
        "minimumTimeStep"           : (float, int, type(None)),
        "eventDirection"            : (dict, type(None)),
        "denseOutputMinimumTimeStep": (float, int, type(None)),
        "denseOutputSaveFrequency"  : (float, int, type(None)),
        "tolerance"                 : (dict, type(None)),
        "timeDomainInit"            : (float, int, type(None)),
        "timeDomainEnd"             : (float, int, type(None))
    }
