...
def createXML(workingdir, modelfilename, omlibrary):
    ...
    try:
        ...
        compile_string = "omc +s --simCodeTarget=XML {model} {others} --removeSimpleEquations=none --postOptModules-=wrapFunctionCalls -d=evaluateAllParameters Modelica".format(
            model=modelfilename,
