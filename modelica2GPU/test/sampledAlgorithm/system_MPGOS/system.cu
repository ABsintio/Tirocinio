...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "ACC_x_sampled" << ',';
        DataFile.width(Width); DataFile << "ACC_$PRE.x_sampled" << ',';
        ...
        DataFile.width(Width); DataFile << "ACCi_sample_ACCi_6" << ',';
        DataFile.width(Width); DataFile << "ACCi_sample_ACCi_7" << ',';
