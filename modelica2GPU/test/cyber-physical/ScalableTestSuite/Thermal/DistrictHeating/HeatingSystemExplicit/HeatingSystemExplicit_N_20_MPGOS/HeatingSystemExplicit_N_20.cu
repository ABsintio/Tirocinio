...
#include "HeatingSystemExplicit_N_20_SystemDefinition.cuh"
...
void FillSolverObject(
    ...
    while (k_begin < k_end) {
        ...
        Solver.SetHost(ProblemNumber, TimeDomain, 1, 20000);  
...
int main() {
    ...
    ofstream DataFile;
    DataFile.open ( "HeatingSystemExplicit_N_20.csv" );
