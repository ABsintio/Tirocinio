...
#include "CounterCurrentHeatExchangerEquations_N_80_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "ACC_TB[80]" << ',';
...
int main() {
    ...
    ofstream DataFile;
    DataFile.open ( "CounterCurrentHeatExchangerEquations_N_80.csv" );
