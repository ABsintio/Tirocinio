...
model CounterCurrentHeatExchangerEquations_model "countercurrent heat exchanger implemented by equations"
  ...
  parameter Real cpA "specific heat capacity of fluid A";
  parameter Real cpB "specific heat capacity of fluid B";
  parameter Real cpW "specific heat capacity of the wall";
  parameter Real gammaA "heat transfer coefficient of fluid A";
  parameter Real gammaB "heat transfer coefficient of fluid B";
  parameter Real omega "perimeter";
  final parameter Real l = L / (N - 1) "length of the each wall segment";
  Real wA "mass flow rate of fluid A";
  Real QA[N - 1] "heat flow rate of fluid A in the segments";
...
end CounterCurrentHeatExchangerEquations_model;