...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "ACC_e[4]" << ',';
        DataFile.width(Width); DataFile << "ACC_e[5]" << ',';
        DataFile.width(Width); DataFile << "ACC_$PRE.e[1]" << ',';
        DataFile.width(Width); DataFile << "ACC_$PRE.e[2]" << ',';
