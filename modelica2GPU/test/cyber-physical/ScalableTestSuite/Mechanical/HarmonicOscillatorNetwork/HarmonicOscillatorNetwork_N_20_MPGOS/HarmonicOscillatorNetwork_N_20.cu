...
#include "HarmonicOscillatorNetwork_N_20_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_xm[1]" << ',';
        DataFile.width(Width); DataFile << "X_xm[2]" << ',';
        DataFile.width(Width); DataFile << "X_xm[3]" << ',';
        DataFile.width(Width); DataFile << "X_xm[4]" << ',';
        DataFile.width(Width); DataFile << "X_xm[5]" << ',';
        DataFile.width(Width); DataFile << "X_xm[6]" << ',';
        DataFile.width(Width); DataFile << "X_xm[7]" << ',';
        DataFile.width(Width); DataFile << "X_xm[8]" << ',';
        DataFile.width(Width); DataFile << "X_xm[9]" << ',';
        DataFile.width(Width); DataFile << "X_xm[10]" << ',';
        DataFile.width(Width); DataFile << "X_xm[11]" << ',';
        DataFile.width(Width); DataFile << "X_xm[12]" << ',';
        DataFile.width(Width); DataFile << "X_xm[13]" << ',';
        DataFile.width(Width); DataFile << "X_xm[14]" << ',';
        DataFile.width(Width); DataFile << "X_xm[15]" << ',';
        DataFile.width(Width); DataFile << "X_xm[16]" << ',';
        DataFile.width(Width); DataFile << "X_xm[17]" << ',';
        DataFile.width(Width); DataFile << "X_xm[18]" << ',';
        DataFile.width(Width); DataFile << "X_xm[19]" << ',';
        DataFile.width(Width); DataFile << "X_xm[20]" << ',';
        DataFile.width(Width); DataFile << "sPAR_k" << ',';
        DataFile.width(Width); DataFile << "sPAR_m" << ',';
        DataFile.width(Width); DataFile << "sPARi_N" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[1]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[2]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[3]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[4]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[5]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[6]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[7]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[8]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[9]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[10]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[11]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[12]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[13]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[14]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[15]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[16]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[17]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[18]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[19]" << ',';
        DataFile.width(Width); DataFile << "ACC_xs[20]" << ',';
...
int main() {
    ...
    ofstream DataFile;
    DataFile.open ( "HarmonicOscillatorNetwork_N_20.csv" );
