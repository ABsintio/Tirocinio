...
#include "DTS_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "sPAR_A[1,1]" << ',';
        DataFile.width(Width); DataFile << "sPAR_A[1,2]" << ',';
        DataFile.width(Width); DataFile << "sPAR_A[2,1]" << ',';
        DataFile.width(Width); DataFile << "sPAR_A[2,2]" << ',';
        DataFile.width(Width); DataFile << "sPAR_T" << ',';
        DataFile.width(Width); DataFile << "ACC_x[1]" << ',';
        DataFile.width(Width); DataFile << "ACC_x[2]" << ',';
