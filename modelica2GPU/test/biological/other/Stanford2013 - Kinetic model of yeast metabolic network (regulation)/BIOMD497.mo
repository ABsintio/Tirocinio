...
model BIOMD497 "Stanford2013 - Kinetic model of yeast metabolic network (regulation)"
	...
	input Real zero_flux;
        output Real y;
    algorithm
        y :=  MAX(V_o * (1 + a_s_0463r_1814 * ln(s_0463 / s_0463_or_1814)), zero_flux);
    end function_284;
