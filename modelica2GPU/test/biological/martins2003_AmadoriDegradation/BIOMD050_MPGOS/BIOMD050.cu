...
#include "BIOMD050_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_DFG" << ',';
        ...
        DataFile.width(Width); DataFile << "X_MG" << ',';
        DataFile.width(Width); DataFile << "X_Man" << ',';
        DataFile.width(Width); DataFile << "X_Mel" << ',';
        DataFile.width(Width); DataFile << "X__1DG" << ',';
        DataFile.width(Width); DataFile << "X__3DG" << ',';
