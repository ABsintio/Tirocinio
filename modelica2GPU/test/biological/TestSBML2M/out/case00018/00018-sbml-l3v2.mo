...
model case00018 "00018-sbml-l3v2"
...
equation
    ...
    der(S2_amount) = (compartment * k1 * S1) + (compartment * k4 * S3 * S4) - (compartment * k2 * S2) - (compartment * k3 * S2);
    der(S3_amount) = (compartment * k3 * S2) - (compartment * k4 * S3 * S4);
    der(S4_amount) = (compartment * k3 * S2) - (compartment * k4 * S3 * S4);
    S1 = S1_conc;
    S2 = S2_conc;
    S3 = S3_conc;
    S4 = S4_conc;
