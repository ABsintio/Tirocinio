...
#include "BIOMD576_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_Alb" << ',';
        DataFile.width(Width); DataFile << "X_Alb_CortOUT" << ',';
        DataFile.width(Width); DataFile << "X_CBG" << ',';
        DataFile.width(Width); DataFile << "X_CBG_CortOUT" << ',';
        DataFile.width(Width); DataFile << "X_CYPgene_PXRprot_DEX" << ',';
        DataFile.width(Width); DataFile << "X_CYPgene_PXRprot_Ligand2" << ',';
        DataFile.width(Width); DataFile << "X_CortAdded" << ',';
        DataFile.width(Width); DataFile << "X_Cortisone" << ',';
        DataFile.width(Width); DataFile << "X_DEX" << ',';
        DataFile.width(Width); DataFile << "X_DEX_degr" << ',';
        DataFile.width(Width); DataFile << "X_DEXout" << ',';
        DataFile.width(Width); DataFile << "X_GRgene_GRprot_DEX" << ',';
        DataFile.width(Width); DataFile << "X_GRprot_DEX" << ',';
        DataFile.width(Width); DataFile << "X_Ligand2" << ',';
        DataFile.width(Width); DataFile << "X_PXRgene_GRprot_DEX" << ',';
        DataFile.width(Width); DataFile << "X_PXRprot_DEX" << ',';
        DataFile.width(Width); DataFile << "X_PXRprot_Ligand2" << ',';
        DataFile.width(Width); DataFile << "X_TAT_PROT" << ',';
        DataFile.width(Width); DataFile << "X_TATgene_GRprot_DEX" << ',';
        ...
        DataFile.width(Width); DataFile << "X_s165" << ',';
        DataFile.width(Width); DataFile << "X_s172" << ',';
        DataFile.width(Width); DataFile << "X_s173" << ',';
        DataFile.width(Width); DataFile << "X_s178" << ',';
        DataFile.width(Width); DataFile << "X_s183" << ',';
        DataFile.width(Width); DataFile << "X_s185" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_GRprotein" << ',';
        DataFile.width(Width); DataFile << "ACC_PXRprotein" << ',';
...
int main() {
    ...
    Solver.SolverOption(AbsoluteTolerance, 12, 1e-17);
    Solver.SolverOption(AbsoluteTolerance, 13, 1e-17);
    Solver.SolverOption(AbsoluteTolerance, 14, 1e-17);
    Solver.SolverOption(AbsoluteTolerance, 15, 1e-17);
