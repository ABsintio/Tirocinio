...
#include "BIOMD269_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_ACC" << ',';
        DataFile.width(Width); DataFile << "X_Auxin" << ',';
        DataFile.width(Width); DataFile << "X_CK" << ',';
        DataFile.width(Width); DataFile << "X_CK_ex" << ',';
        DataFile.width(Width); DataFile << "X_CTR1T" << ',';
        DataFile.width(Width); DataFile << "X_CTR1_star" << ',';
        DataFile.width(Width); DataFile << "X_ET" << ',';
        DataFile.width(Width); DataFile << "X_IAA" << ',';
        DataFile.width(Width); DataFile << "X_PLSm" << ',';
        DataFile.width(Width); DataFile << "X_PLSp" << ',';
        DataFile.width(Width); DataFile << "X_RaT" << ',';
        DataFile.width(Width); DataFile << "X_Ra_star" << ',';
        DataFile.width(Width); DataFile << "X_ReT" << ',';
        DataFile.width(Width); DataFile << "X_Re_star" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k10a" << ',';
        DataFile.width(Width); DataFile << "sPAR_k11" << ',';
        DataFile.width(Width); DataFile << "sPAR_k12" << ',';
        DataFile.width(Width); DataFile << "sPAR_k12a" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k16a" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k2a" << ',';
        DataFile.width(Width); DataFile << "sPAR_k2b" << ',';
        DataFile.width(Width); DataFile << "sPAR_k2c" << ',';
        DataFile.width(Width); DataFile << "sPAR_k3" << ',';
        DataFile.width(Width); DataFile << "sPAR_k3a" << ',';
        DataFile.width(Width); DataFile << "sPAR_k4" << ',';
        DataFile.width(Width); DataFile << "sPAR_k5" << ',';
        DataFile.width(Width); DataFile << "sPAR_k6" << ',';
        DataFile.width(Width); DataFile << "sPAR_k6a" << ',';
        DataFile.width(Width); DataFile << "sPAR_k7" << ',';
        DataFile.width(Width); DataFile << "sPAR_k8" << ',';
        DataFile.width(Width); DataFile << "sPAR_k9" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_auxin" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_cytokinin" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_ethylene" << ',';
        DataFile.width(Width); DataFile << "ACC_CTR1" << ',';
        DataFile.width(Width); DataFile << "ACC_Ra" << ',';
        DataFile.width(Width); DataFile << "ACC_Re" << ',';
