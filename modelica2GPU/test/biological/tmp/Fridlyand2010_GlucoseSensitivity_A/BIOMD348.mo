...
model BIOMD348.sbml "Fridlyand2010_GlucoseSensitivity_A"
...
equation
    ...
    Cac = CaR + kACa * pow(ATP * (1 / ADP), hCa) * (1 / (pow(KAD, hCa) + pow(ATP * (1 / ADP), hCa)));
    ...
    der(Vm) = (Jhres + -Jph + -Jhl + -(2 * Juni) + -JNCa) * F * (1 / Cmit);
