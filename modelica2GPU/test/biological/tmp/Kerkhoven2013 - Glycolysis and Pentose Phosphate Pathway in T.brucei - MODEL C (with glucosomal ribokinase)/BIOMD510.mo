...
model BIOMD510 "Kerkhoven2013 - Glycolysis and Pentose Phosphate Pathway in T.brucei - MODEL C (with glucosomal ribokinase)"
    ...
    parameter Real AK_c_k1_14 = 480.0;
    parameter Real AK_c_k2_14 = 1000.0;
    ...
    parameter Real _6PGDH_g_Vmax_16 = 10.6;
    parameter Real _6PGDH_g_Keq_16 = 47.0;
    parameter Real _6PGDH_g_Km6PG_16 = 0.0035;
    parameter Real _6PGDH_g_KmNADP_16 = 0.001;
    parameter Real _6PGDH_g_KmRul5P_16 = 0.03;
    parameter Real _6PGDH_g_KmNADPH_16 = 0.0006;
    ...
    parameter Real AK_g_k1_18 = 480.0;
    parameter Real AK_g_k2_18 = 1000.0;
...
equation
    ...
    der(ADP_c) = (v2sub2prod(HXK_c_Vmax_12, HXK_c_Keq_12, Glc_c, HXK_c_KmGlc_12, ATP_c, HXK_c_KmATP_12, Glc6P_c, HXK_c_KmGlc_126P, ADP_c, HXK_c_KmADP_12)) + (ATPu_c_k_31 * ATP_c / ADP_c) - (PYK_c_Vmax_1 * ADP_c * (1 - Pyr_c * ATP_c / (PYK_c_Keq_1 * PEP_c * ADP_c)) * pow(PEP_c / (PYK_c_KmPEP_1 * (1 + ADP_c / PYK_c_KiADP_1 + ATP_c / PYK_c_KiATP_1)), PYK_c_n_1) / (PYK_c_KmADP_1 * (1 + pow(PEP_c / (PYK_c_KmPEP_1 * (1 + ADP_c / PYK_c_KiADP_1 + ATP_c / PYK_c_KiATP_1)), PYK_c_n_1) + Pyr_c / PYK_c_KmPyr_1) * (1 + ADP_c / PYK_c_KmADP_1 + ATP_c / PYK_c_KmATP_1))) - (2.0 * vAK(ADP_c, AMP_c, ATP_c, AK_c_k1_14, AK_c_k2_14));
    ...
    der(NADPH_c) = (v2sub2prod(G6PDH_c_Vmax_6, G6PDH_c_Keq_6, Glc6P_c, G6PDH_c_KmGlc6P_6, NADP_c, G6PDH_c_KmNADP_6, _6PGL_c, G6PDH_c_Km6PGL_6, NADPH_c, G6PDH_c_KmNADP_6H)) + (v2sub2prod(_6PGDH_c_Vmax_22, _6PGDH_c_Keq_22, _6PG_c, _6PGDH_c_Km6PG_22, NADP_c, _6PGDH_c_KmNADP_22, Rul5P_c, _6PGDH_c_KmRul5P_22, NADPH_c, _6PGDH_c_KmNADP_22H)) - (mass_action_irrev(NADPHu_c_k_11, NADPH_c)) - (v2sub2prod(TR_c_Vmax_28, TR_c_Keq_28, TS2_c, TR_c_KmTS2_28, NADPH_c, TR_c_KmNADP_28H_28, TSH2_c, TR_c_KmTSH2_28, NADP_c, TR_c_KmNADP_28));
    ...
    der(Pi_g) = 0.0;
    der(O2_c) = 0.0;
    der(NADP_c) = (mass_action_irrev(NADPHu_c_k_11, NADPH_c)) + (v2sub2prod(TR_c_Vmax_28, TR_c_Keq_28, TS2_c, TR_c_KmTS2_28, NADPH_c, TR_c_KmNADP_28H_28, TSH2_c, TR_c_KmTSH2_28, NADP_c, TR_c_KmNADP_28)) - (v2sub2prod(G6PDH_c_Vmax_6, G6PDH_c_Keq_6, Glc6P_c, G6PDH_c_KmGlc6P_6, NADP_c, G6PDH_c_KmNADP_6, _6PGL_c, G6PDH_c_Km6PGL_6, NADPH_c, G6PDH_c_KmNADP_6H)) - (v2sub2prod(_6PGDH_c_Vmax_22, _6PGDH_c_Keq_22, _6PG_c, _6PGDH_c_Km6PG_22, NADP_c, _6PGDH_c_KmNADP_22, Rul5P_c, _6PGDH_c_KmRul5P_22, NADPH_c, _6PGDH_c_KmNADP_22H));
    der(ATP_c) = (PYK_c_Vmax_1 * ADP_c * (1 - Pyr_c * ATP_c / (PYK_c_Keq_1 * PEP_c * ADP_c)) * pow(PEP_c / (PYK_c_KmPEP_1 * (1 + ADP_c / PYK_c_KiADP_1 + ATP_c / PYK_c_KiATP_1)), PYK_c_n_1) / (PYK_c_KmADP_1 * (1 + pow(PEP_c / (PYK_c_KmPEP_1 * (1 + ADP_c / PYK_c_KiADP_1 + ATP_c / PYK_c_KiATP_1)), PYK_c_n_1) + Pyr_c / PYK_c_KmPyr_1) * (1 + ADP_c / PYK_c_KmADP_1 + ATP_c / PYK_c_KmATP_1))) + (vAK(ADP_c, AMP_c, ATP_c, AK_c_k1_14, AK_c_k2_14)) - (v2sub2prod(HXK_c_Vmax_12, HXK_c_Keq_12, Glc_c, HXK_c_KmGlc_12, ATP_c, HXK_c_KmATP_12, Glc6P_c, HXK_c_KmGlc_126P, ADP_c, HXK_c_KmADP_12)) - (ATPu_c_k_31 * ATP_c / ADP_c);
    der(NADP_g) = (mass_action_irrev(NADPHu_g_k_13, NADPH_g)) - (v2sub2prod(G6PDH_g_Vmax_3, G6PDH_g_Keq_3, Glc6P_g, G6PDH_g_KmGlc6P_3, NADP_g, G6PDH_g_KmNADP_3, _6PGL_g, G6PDH_g_Km6PGL_3, NADPH_g, G6PDH_g_KmNADP_3H)) - (v2sub2prod(_6PGDH_g_Vmax_16, _6PGDH_g_Keq_16, _6PG_g, _6PGDH_g_Km6PG_16, NADP_g, _6PGDH_g_KmNADP_16, Rul5P_g, _6PGDH_g_KmRul5P_16, NADPH_g, _6PGDH_g_KmNADP_16H));
    der(_6PG_g) = (glycosome * PGL_g_k_27 * (_6PGL_g - _6PG_g / PGL_g_Keq_27) + v1sub1prod(PGL_g_Vmax_27, PGL_g_Keq_27, _6PGL_g, PGL_g_Km6PG_27L_27, _6PG_g, PGL_g_Km6PG_27)) - (v2sub2prod(_6PGDH_g_Vmax_16, _6PGDH_g_Keq_16, _6PG_g, _6PGDH_g_Km6PG_16, NADP_g, _6PGDH_g_KmNADP_16, Rul5P_g, _6PGDH_g_KmRul5P_16, NADPH_g, _6PGDH_g_KmNADP_16H));
    der(CO2_c) = 0.0;
    ...
    der(Rul5P_g) = (v2sub2prod(_6PGDH_g_Vmax_16, _6PGDH_g_Keq_16, _6PG_g, _6PGDH_g_Km6PG_16, NADP_g, _6PGDH_g_KmNADP_16, Rul5P_g, _6PGDH_g_KmRul5P_16, NADPH_g, _6PGDH_g_KmNADP_16H)) - (v1sub1prod(PPI_g_Vmax_24, PPI_g_Keq_24, Rul5P_g, PPI_g_KmRul5P_24, Rib5P_g, PPI_g_KmRib5P_24));
    der(Glc6P_c) = (v2sub2prod(HXK_c_Vmax_12, HXK_c_Keq_12, Glc_c, HXK_c_KmGlc_12, ATP_c, HXK_c_KmATP_12, Glc6P_c, HXK_c_KmGlc_126P, ADP_c, HXK_c_KmADP_12)) - (v2sub2prod(G6PDH_c_Vmax_6, G6PDH_c_Keq_6, Glc6P_c, G6PDH_c_KmGlc6P_6, NADP_c, G6PDH_c_KmNADP_6, _6PGL_c, G6PDH_c_Km6PGL_6, NADPH_c, G6PDH_c_KmNADP_6H)) - (v1sub1prod(G6PP_c_Vmax_15, G6PP_c_Keq_15, Glc6P_c, G6PP_c_KmGlc_156P_15, Glc_c, G6PP_c_KmGlc_15));
    der(Rib5P_c) = 0.0;
    ...
    der(Glc_c) = (v1sub1prod(G6PP_c_Vmax_15, G6PP_c_Keq_15, Glc6P_c, G6PP_c_KmGlc_156P_15, Glc_c, G6PP_c_KmGlc_15)) + (GlcT_c_Vmax_26 * (Glc_e - Glc_c) / (GlcT_c_KmGlc_26 + Glc_e + Glc_c + GlcT_c_alpha_26 * Glc_e * Glc_c / GlcT_c_KmGlc_26)) - (v2sub2prod(HXK_c_Vmax_12, HXK_c_Keq_12, Glc_c, HXK_c_KmGlc_12, ATP_c, HXK_c_KmATP_12, Glc6P_c, HXK_c_KmGlc_126P, ADP_c, HXK_c_KmADP_12)) - (mass_action_rev(GlcT_g_k1_25, Glc_c, GlcT_g_k2_25, Glc_g));
    der(Rib5P_g) = (v1sub1prod(PPI_g_Vmax_24, PPI_g_Keq_24, Rul5P_g, PPI_g_KmRul5P_24, Rib5P_g, PPI_g_KmRib5P_24)) - (v2sub2prod(RK_g_Vmax_9, RK_g_Keq_9, Rib5P_g, RK_g_KmRib_95P_9, ADP_g, RK_g_KmADP_9, Rib_g, RK_g_KmRib_9, ATP_g, RK_g_KmATP_9));
    ...
    der(Glc_e) = 0.0;
    der(NADPH_g) = (v2sub2prod(G6PDH_g_Vmax_3, G6PDH_g_Keq_3, Glc6P_g, G6PDH_g_KmGlc6P_3, NADP_g, G6PDH_g_KmNADP_3, _6PGL_g, G6PDH_g_Km6PGL_3, NADPH_g, G6PDH_g_KmNADP_3H)) + (v2sub2prod(_6PGDH_g_Vmax_16, _6PGDH_g_Keq_16, _6PG_g, _6PGDH_g_Km6PG_16, NADP_g, _6PGDH_g_KmNADP_16, Rul5P_g, _6PGDH_g_KmRul5P_16, NADPH_g, _6PGDH_g_KmNADP_16H)) - (mass_action_irrev(NADPHu_g_k_13, NADPH_g));
    der(Rib_g) = 0.0;
    ...
    der(Gly_e) = 0.0;
    der(TSH2_c) = (v2sub2prod(TR_c_Vmax_28, TR_c_Keq_28, TS2_c, TR_c_KmTS2_28, NADPH_c, TR_c_KmNADP_28H_28, TSH2_c, TR_c_KmTSH2_28, NADP_c, TR_c_KmNADP_28)) - (mass_action_irrev(TOX_c_k_19, TSH2_c));
    der(CO2_g) = 0.0;
    der(Gly3P_c) = (Gly3P_g * GDA_g_k_20 * DHAP_c - Gly3P_c * GDA_g_k_20 * DHAP_g) - (v1sub(GPO_c_Vmax_35, Gly3P_c, GPO_c_KmGly3P_35));
    der(Gly3P_g) = (v2sub2prod(G3PDH_g_Vmax_30, G3PDH_g_Keq_30, DHAP_g, G3PDH_g_KmDHAP_30, NADH_g, G3PDH_g_KmNAD_30H_30, Gly3P_g, G3PDH_g_KmGly3P_30, NAD_g, G3PDH_g_KmNAD_30)) - (Gly3P_g * GDA_g_k_20 * DHAP_c - Gly3P_c * GDA_g_k_20 * DHAP_g) - (v2sub2prod(GK_g_Vmax_32, GK_g_Keq_32, Gly3P_g, GK_g_KmGly_323P_32, ADP_g, GK_g_KmADP_32, Gly_e, GK_g_KmGly_32, ATP_g, GK_g_KmATP_32));
    ...
    der(TS2_c) = (mass_action_irrev(TOX_c_k_19, TSH2_c)) - (v2sub2prod(TR_c_Vmax_28, TR_c_Keq_28, TS2_c, TR_c_KmTS2_28, NADPH_c, TR_c_KmNADP_28H_28, TSH2_c, TR_c_KmTSH2_28, NADP_c, TR_c_KmNADP_28));
    ...
    der(AMP_g) = (vAK(ADP_g, AMP_g, ATP_g, AK_g_k1_18, AK_g_k2_18)) ;
    der(_3PGA_g) = (v2sub2prod(PGK_g_Vmax_29, PGK_g_Keq_29, _13BPGA_g, PGK_g_Km13BPGA_29, ADP_g, PGK_g_KmADP_29, _3PGA_g, PGK_g_Km3PGA_29, ATP_g, PGK_g_KmATP_29)) - (mass_action_rev(_3PGAT_g_k_10, _3PGA_g, _3PGAT_g_k_10, _3PGA_c));
    der(AMP_c) = (vAK(ADP_c, AMP_c, ATP_c, AK_c_k1_14, AK_c_k2_14)) ;
