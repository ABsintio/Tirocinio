...
#include "BIOMD341_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_Eg0" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_si" << ',';
        DataFile.width(Width); DataFile << "sPAR_sigma" << ',';
