...
#include "BIOMD375_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_Sj" << ',';
        DataFile.width(Width); DataFile << "sPAR_Sm_f" << ',';
        DataFile.width(Width); DataFile << "sPAR_Sm_s" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_Vj" << ',';
        DataFile.width(Width); DataFile << "sPAR_Vm_f" << ',';
        DataFile.width(Width); DataFile << "sPAR_Vm_s" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_sloper" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_Jmp" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_g_K_ATP" << ',';
