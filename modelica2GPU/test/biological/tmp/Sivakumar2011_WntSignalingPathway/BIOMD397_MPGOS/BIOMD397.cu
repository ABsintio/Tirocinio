...
#include "BIOMD397_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_s121" << ',';
        DataFile.width(Width); DataFile << "X_s123" << ',';
        DataFile.width(Width); DataFile << "X_s129" << ',';
        DataFile.width(Width); DataFile << "X_s155" << ',';
        DataFile.width(Width); DataFile << "X_s159" << ',';
        DataFile.width(Width); DataFile << "X_s16" << ',';
        DataFile.width(Width); DataFile << "X_s164" << ',';
        DataFile.width(Width); DataFile << "X_s170" << ',';
        DataFile.width(Width); DataFile << "X_s171" << ',';
        DataFile.width(Width); DataFile << "X_s172" << ',';
        DataFile.width(Width); DataFile << "X_s173" << ',';
        DataFile.width(Width); DataFile << "X_s174" << ',';
        DataFile.width(Width); DataFile << "X_s176" << ',';
        DataFile.width(Width); DataFile << "X_s179" << ',';
        DataFile.width(Width); DataFile << "X_s183" << ',';
        DataFile.width(Width); DataFile << "X_s188" << ',';
        DataFile.width(Width); DataFile << "X_s195" << ',';
        DataFile.width(Width); DataFile << "X_s232" << ',';
        DataFile.width(Width); DataFile << "X_s239" << ',';
        DataFile.width(Width); DataFile << "X_s245" << ',';
        DataFile.width(Width); DataFile << "X_s252" << ',';
        DataFile.width(Width); DataFile << "X_s259" << ',';
        DataFile.width(Width); DataFile << "X_s260" << ',';
        DataFile.width(Width); DataFile << "X_s266" << ',';
        DataFile.width(Width); DataFile << "X_s267" << ',';
        DataFile.width(Width); DataFile << "X_s268" << ',';
        DataFile.width(Width); DataFile << "X_s27" << ',';
        DataFile.width(Width); DataFile << "X_s270" << ',';
        DataFile.width(Width); DataFile << "X_s275" << ',';
        DataFile.width(Width); DataFile << "X_s278" << ',';
        DataFile.width(Width); DataFile << "X_s28" << ',';
        DataFile.width(Width); DataFile << "X_s286" << ',';
        DataFile.width(Width); DataFile << "X_s288" << ',';
        DataFile.width(Width); DataFile << "X_s292" << ',';
        DataFile.width(Width); DataFile << "X_s30" << ',';
        DataFile.width(Width); DataFile << "X_s304" << ',';
        DataFile.width(Width); DataFile << "X_s305" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_c4" << ',';
        DataFile.width(Width); DataFile << "sPAR_default" << ',';
        DataFile.width(Width); DataFile << "sPAR_kI_r86_s304" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r1" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r102" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r103" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r104_s30" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r105" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r106" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r107" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r47" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r48" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r5" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r54" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r58" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r63" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r64" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r65" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r66" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r67" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r68" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r85_s30" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r86_s37" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r88" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r90" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r91" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r92" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r96" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r98" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_r99" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_re64" << ',';
        DataFile.width(Width); DataFile << "sPAR_kass_re65" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r1" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r102" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r103" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r104_s30" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r105" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r106" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r107" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r47" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r48" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r5" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r54" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r58" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r63" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r64" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r65" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r66" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r67" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r85_s30" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r86_s37" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r88" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r90" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r91" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r92" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r96" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r98" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdiss_r99" << ',';
