...
model BIOMD203 "Chickarmane2006 - Stem cell switch reversible"
...
equation
    ...
    der(Protein) = ((g1 * OCT4_SOX2 + eta7) / (1 + eta7 / f + h1 * OCT4_SOX2 + h2 * OCT4_SOX2 * NANOG)) - (gamma4 * Protein);
