...
equation
    ...
    der(V) = (compartment * Constant_flux__irrev_0ersible(v_0)) + (2.0 * compartment * Michaellis_Menten(V, Km_1, Vmax_1)) + (compartment * k1_5 * V * C) - (compartment * Michaellis_Menten(V, Km_1, Vmax_1)) - (compartment * k1_2 * V * C) - (compartment * k1_3 * V) - (compartment * k1_5 * V * C);
    der(C) = (compartment * k1_2 * V * C) + (compartment * Constant_flux__irrev_4ersible(v_4)) - (compartment * k1_2 * V * C) - (compartment * k1_5 * V * C) - (compartment * k1_6 * C);
