...
#include "BIOMD204_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_eta1" << ',';
        DataFile.width(Width); DataFile << "sPAR_eta3" << ',';
        DataFile.width(Width); DataFile << "sPAR_eta5" << ',';
        DataFile.width(Width); DataFile << "sPAR_eta7" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k3c" << ',';
