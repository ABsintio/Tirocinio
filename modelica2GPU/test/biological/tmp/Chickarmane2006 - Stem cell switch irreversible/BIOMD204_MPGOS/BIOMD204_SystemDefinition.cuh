...
#ifndef BIOMD204_PERTHREAD_SYSTEMDEFINITION_H
#define BIOMD204_PERTHREAD_SYSTEMDEFINITION_H
...
template<class Precision> __forceinline__ __device__ void PerThread_OdeFunction(
    ...
    F[11]=0.0;
    F[9]=0.0;
    F[6]=((((sPAR[23] * X[5]) + sPAR[18]) / (1.0 + ((sPAR[18] / sPAR[21]) + (X[5] * (sPAR[28] + (sPAR[29] * X[1])))))) - (sPAR[27] * X[6]));
