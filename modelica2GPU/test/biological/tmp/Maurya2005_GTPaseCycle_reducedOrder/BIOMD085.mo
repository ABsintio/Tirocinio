...
equation
    ...
    der(species_0) =  - (1.0 * (k1_reaction_7 * species_5 * species_0 - k2_reaction_7 * species_11)) - (1.0 * (k1_reaction_8 * species_6 * species_0 - k2_reaction_8 * species_12)) - (1.0 * (k1_reaction_19 * species_10 * species_0 - k2_reaction_19 * species_15));
    der(species_1) = (1.0 * (k1_reaction_4 * species_6 - k2_reaction_4 * species_1 * species_8)) - (1.0 * (k1_reaction_1 * species_1 * species_3 - k2_reaction_1 * species_5));
    der(species_2) = (1.0 * (k1_reaction_14 * species_12 - k2_reaction_14 * species_2 * species_8)) - (1.0 * (k1_reaction_16 * species_2 * species_4 - k2_reaction_16 * species_14));
    der(species_3) =  - (1.0 * (k1_reaction_1 * species_1 * species_3 - k2_reaction_1 * species_5)) - (1.0 * (k1_reaction_5 * species_9 * species_3 - k2_reaction_5 * species_10)) - (1.0 * (k1_reaction_17 * species_14 * species_3 - k2_reaction_17 * species_15));
    der(species_4) =  - (1.0 * (k1_reaction_6 * species_5 * species_4 - k2_reaction_6 * species_10)) - (1.0 * (k1_reaction_9 * species_6 * species_4 - k2_reaction_9 * species_13)) - (1.0 * (k1_reaction_16 * species_2 * species_4 - k2_reaction_16 * species_14));
    ...
    der(species_9) = (1.0 * (k1_reaction_11 * species_13 - k2_reaction_11 * species_9 * species_8)) - (1.0 * (k1_reaction_5 * species_9 * species_3 - k2_reaction_5 * species_10));
    ...
    der(species_11) = (1.0 * (k1_reaction_7 * species_5 * species_0 - k2_reaction_7 * species_11)) - (1.0 * (k1_reaction_13 * species_11 - k2_reaction_13 * species_12 * species_7));
    der(species_12) = (1.0 * (k1_reaction_8 * species_6 * species_0 - k2_reaction_8 * species_12)) + (1.0 * (k1_reaction_13 * species_11 - k2_reaction_13 * species_12 * species_7)) - (1.0 * (k1_reaction_14 * species_12 - k2_reaction_14 * species_2 * species_8));
    der(species_13) = (1.0 * (k1_reaction_9 * species_6 * species_4 - k2_reaction_9 * species_13)) + (1.0 * (k1_reaction_10 * species_10 - k2_reaction_10 * species_13 * species_7)) - (1.0 * (k1_reaction_11 * species_13 - k2_reaction_11 * species_9 * species_8));
    der(species_14) = (1.0 * (k1_reaction_16 * species_2 * species_4 - k2_reaction_16 * species_14)) + (1.0 * (k1_reaction_23 * species_16 - k2_reaction_23 * species_14 * species_8)) - (1.0 * (k1_reaction_17 * species_14 * species_3 - k2_reaction_17 * species_15));
    der(species_15) = (1.0 * (k1_reaction_17 * species_14 * species_3 - k2_reaction_17 * species_15)) + (1.0 * (k1_reaction_19 * species_10 * species_0 - k2_reaction_19 * species_15)) - (1.0 * (k1_reaction_20 * species_15 - k2_reaction_20 * species_16 * species_7));
    der(species_16) = (1.0 * (k1_reaction_20 * species_15 - k2_reaction_20 * species_16 * species_7)) - (1.0 * (k1_reaction_23 * species_16 - k2_reaction_23 * species_14 * species_8));
