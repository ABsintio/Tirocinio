...
equation
    ...
    der(SAM) = (1.0 * (Vmmat_MAT / (1 + (Kmmat_MAT / Met) * (1 + SAM / Kimetmat_MAT)))) - (1.0 * ((Vmaxsamdc / (1 + S / Kissamdc_SAMdc)) * SAM / (Kmsamdc_SAMdc * (1 + Kapsamdc_SAMdc / P + A / Kiasamdc_SAMdc) + SAM)));
    der(A) = (1.0 * ((Vmaxsamdc / (1 + S / Kissamdc_SAMdc)) * SAM / (Kmsamdc_SAMdc * (1 + Kapsamdc_SAMdc / P + A / Kiasamdc_SAMdc) + SAM))) - (1.0 * (Vmspds_SpdS * A * P / (Kiaspds_SpdS * Kpspds_SpdS * (1 + D / Kidspds_SpdS) + Kpspds_SpdS * A + KaSpds_SpdS * (1 + D / Kidspds_SpdS) * P + A * P))) - (1.0 * (Vmspms_SpmS * A * D / (Kiaspms_SpmS * Kdspms_SpmS * (1 + S / Kisspms_SpmS) + Kdspms_SpmS * A + Kaspms_SpmS * (1 + S / Kisspms_SpmS) * D + A * D)));
    der(P) = (1.0 * (Vmaxodc * ORN / (Kmodc_ODC * (1 + P / Kipodc_ODC) + ORN))) + (1.0 * (Vmpao_PAO_for_aD * aD / (Kmadpao_PAO_for_aD * (1 + aD / Kmadpao_PAO_for_aD + aS / Kmaspao_PAO_for_aD + D / Kmdpao_PAO_for_aD + S / Kmspao_PAO_for_aD)))) - (1.0 * (Vmspds_SpdS * A * P / (Kiaspds_SpdS * Kpspds_SpdS * (1 + D / Kidspds_SpdS) + Kpspds_SpdS * A + KaSpds_SpdS * (1 + D / Kidspds_SpdS) * P + A * P))) - (1.0 * Kpefflux_P_efflux * P);
    der(S) = (1.0 * (Vmspms_SpmS * A * D / (Kiaspms_SpmS * Kdspms_SpmS * (1 + S / Kisspms_SpmS) + Kdspms_SpmS * A + Kaspms_SpmS * (1 + S / Kisspms_SpmS) * D + A * D))) - (1.0 * ((1 / C) * Vmaxssat * S * AcCoA / (Kmsssat_SSAT_for_S * (1 + D / Kmdssat_SSAT_for_S) * Kmaccoassat_SSAT_for_S * (1 + CoA / Kmcoassat_SSAT_for_S) + Kmaccoassat_SSAT_for_S * (1 + CoA / Kmcoassat_SSAT_for_S) * S + Kmsssat_SSAT_for_S * (1 + D / Kmdssat_SSAT_for_S) * AcCoA + S * AcCoA)));
    der(D) = (1.0 * (Vmpao_PAO_for_aS * aS / (Kmaspao_PAO_for_aS * (1 + aD / Kmadpao_PAO_for_aS + aS / Kmaspao_PAO_for_aS + D / Kmdpao_PAO_for_aS + S / Kmspao_PAO_for_aS)))) + (1.0 * (Vmspds_SpdS * A * P / (Kiaspds_SpdS * Kpspds_SpdS * (1 + D / Kidspds_SpdS) + Kpspds_SpdS * A + KaSpds_SpdS * (1 + D / Kidspds_SpdS) * P + A * P))) - (1.0 * (Vmaxssat * D * AcCoA / (Kmdssat_SSAT_for_D * (1 + S / Kmsssat_SSAT_for_D) * Kmaccoassat_SSAT_for_D * (1 + CoA / Kmcoassat_SSAT_for_D) + Kmaccoassat_SSAT_for_D * (1 + CoA / Kmcoassat_SSAT_for_D) * D + Kmdssat_SSAT_for_D * (1 + S / Kmsssat_SSAT_for_D) * AcCoA + D * AcCoA))) - (1.0 * (Vmspms_SpmS * A * D / (Kiaspms_SpmS * Kdspms_SpmS * (1 + S / Kisspms_SpmS) + Kdspms_SpmS * A + Kaspms_SpmS * (1 + S / Kisspms_SpmS) * D + A * D)));
    der(aS) = (1.0 * ((1 / C) * Vmaxssat * S * AcCoA / (Kmsssat_SSAT_for_S * (1 + D / Kmdssat_SSAT_for_S) * Kmaccoassat_SSAT_for_S * (1 + CoA / Kmcoassat_SSAT_for_S) + Kmaccoassat_SSAT_for_S * (1 + CoA / Kmcoassat_SSAT_for_S) * S + Kmsssat_SSAT_for_S * (1 + D / Kmdssat_SSAT_for_S) * AcCoA + S * AcCoA))) - (1.0 * (Vmpao_PAO_for_aS * aS / (Kmaspao_PAO_for_aS * (1 + aD / Kmadpao_PAO_for_aS + aS / Kmaspao_PAO_for_aS + D / Kmdpao_PAO_for_aS + S / Kmspao_PAO_for_aS))));
    der(aD) = (1.0 * (Vmaxssat * D * AcCoA / (Kmdssat_SSAT_for_D * (1 + S / Kmsssat_SSAT_for_D) * Kmaccoassat_SSAT_for_D * (1 + CoA / Kmcoassat_SSAT_for_D) + Kmaccoassat_SSAT_for_D * (1 + CoA / Kmcoassat_SSAT_for_D) * D + Kmdssat_SSAT_for_D * (1 + S / Kmsssat_SSAT_for_D) * AcCoA + D * AcCoA))) - (1.0 * (Vmpao_PAO_for_aD * aD / (Kmadpao_PAO_for_aD * (1 + aD / Kmadpao_PAO_for_aD + aS / Kmaspao_PAO_for_aD + D / Kmdpao_PAO_for_aD + S / Kmspao_PAO_for_aD)))) - (1.0 * Kadefflux_aD_efflux * aD);
    der(Met) = 0.0;
    der(ORN) = 0.0;
    der(AcCoA) = 0.0;
    der(CoA) = 0.0;
