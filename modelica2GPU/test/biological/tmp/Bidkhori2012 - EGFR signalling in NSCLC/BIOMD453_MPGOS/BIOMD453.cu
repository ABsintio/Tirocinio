...
#include "BIOMD453_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_mw71d03aab_fcb6_4f78_a788_48f183d0b931" << ',';
        DataFile.width(Width); DataFile << "X_mw741407c8_029b_44ed_9799_02eb9d90ec9a" << ',';
        ...
        DataFile.width(Width); DataFile << "X_mw9da19d39_6d91_41d0_b101_f7748391705a" << ',';
        ...
        DataFile.width(Width); DataFile << "X_mwbedcc124_dbf3_41ab_989e_6b0900d7590a" << ',';
