...
model BIOMD210 "Chickarmane2008 - Stem cell lineage - NANOG GATA-6 switch"
    ...
    parameter Real a1 = 0.02;
    parameter Real a2 = 0.0125;
    parameter Real a3 = 0.025;
    parameter Real b0 = 1.0;
    parameter Real b1 = 0.02;
    parameter Real b2 = 0.0125;
    parameter Real b3 = 0.03;
    parameter Real b4 = 10.0;
    parameter Real b5 = 10.0;
    parameter Real gamma1 = 0.1;
    parameter Real c0 = 0.001;
    parameter Real c1 = 0.05;
    parameter Real c2 = 0.0125;
    parameter Real d0 = 0.001;
    parameter Real d1 = 0.05;
    parameter Real d2 = 0.0125;
...
equation
    ...
    der(NANOG) = ((a1 * OCT4_SOX2 + a2 * OCT4_SOX2 * NANOG) / (1 + b1 * OCT4_SOX2 + b2 * OCT4_SOX2 * NANOG + b3 * OCT4_SOX2 * GATA6)) - (gamman * NANOG);
    der(GATA6) = ((c1 * OCT4_SOX2 + c2 * GATA6) / (1 + d1 * OCT4_SOX2 + d2 * GATA6 + d3 * NANOG)) - (gammag * GATA6);
