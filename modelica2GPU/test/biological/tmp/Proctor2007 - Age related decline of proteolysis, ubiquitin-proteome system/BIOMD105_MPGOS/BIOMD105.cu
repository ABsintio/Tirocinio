...
#include "BIOMD105_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_AggP" << ',';
        ...
        DataFile.width(Width); DataFile << "X_MisP_Ub" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub2" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub3" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub4" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub4_Proteasome" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub5" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub5_Proteasome" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub6" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub6_Proteasome" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub7" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub7_Proteasome" << ',';
        DataFile.width(Width); DataFile << "X_MisP_Ub8" << ',';
        ...
        DataFile.width(Width); DataFile << "X_degUb4" << ',';
        DataFile.width(Width); DataFile << "X_degUb5" << ',';
        DataFile.width(Width); DataFile << "X_degUb6" << ',';
        DataFile.width(Width); DataFile << "X_degUb7" << ',';
        DataFile.width(Width); DataFile << "X_degUb8" << ',';
        DataFile.width(Width); DataFile << "X_refNatP" << ',';
        DataFile.width(Width); DataFile << "X_totMisP" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k61r" << ',';
