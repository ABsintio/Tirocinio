...
#include "BIOMD230_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_IKKIkBa" << ',';
        DataFile.width(Width); DataFile << "X_IKKIkBaNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IKKIkBb" << ',';
        DataFile.width(Width); DataFile << "X_IKKIkBbNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IKKIkBe" << ',';
        DataFile.width(Width); DataFile << "X_IKKIkBeNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IkBa" << ',';
        DataFile.width(Width); DataFile << "X_IkBaNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IkBan" << ',';
        DataFile.width(Width); DataFile << "X_IkBanNFkBn" << ',';
        DataFile.width(Width); DataFile << "X_IkBat" << ',';
        DataFile.width(Width); DataFile << "X_IkBb" << ',';
        DataFile.width(Width); DataFile << "X_IkBbNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IkBbn" << ',';
        DataFile.width(Width); DataFile << "X_IkBbnNFkBn" << ',';
        DataFile.width(Width); DataFile << "X_IkBbt" << ',';
        DataFile.width(Width); DataFile << "X_IkBe" << ',';
        DataFile.width(Width); DataFile << "X_IkBeNFkB" << ',';
        DataFile.width(Width); DataFile << "X_IkBen" << ',';
        DataFile.width(Width); DataFile << "X_IkBenNFkBn" << ',';
        DataFile.width(Width); DataFile << "X_IkBet" << ',';
        DataFile.width(Width); DataFile << "X_NFkB" << ',';
        DataFile.width(Width); DataFile << "X_NFkBn" << ',';
