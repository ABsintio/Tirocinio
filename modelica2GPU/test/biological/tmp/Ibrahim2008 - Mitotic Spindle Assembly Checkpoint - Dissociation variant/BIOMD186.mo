...
equation
    ...
    der(Mad1_CMad2) = (u * k2f * Mad1_CMad2_OMad2 * 1.0 * Cdc20) - (1.0 * (u * k1f * Mad1_CMad2 * OMad2 - k1r * Mad1_CMad2_OMad2));
    der(OMad2) = (k3f * Cdc20_CMad2 * 1.0) - (1.0 * (u * k1f * Mad1_CMad2 * OMad2 - k1r * Mad1_CMad2_OMad2)) - (kf6 * OMad2 * Cdc20 * 1.0);
    der(Mad1_CMad2_OMad2) = (1.0 * (u * k1f * Mad1_CMad2 * OMad2 - k1r * Mad1_CMad2_OMad2)) - (u * k2f * Mad1_CMad2_OMad2 * 1.0 * Cdc20);
    der(Cdc20) = (k3f * Cdc20_CMad2 * 1.0) - (u * k2f * Mad1_CMad2_OMad2 * 1.0 * Cdc20) - (1.0 * (u * k5f * Bub3_BubR1 * Cdc20 - k5r * Bub3_BubR1_Cdc20)) - (kf6 * OMad2 * Cdc20 * 1.0) - (1.0 * (k8f * APC * Cdc20 - k8r * APC_Cdc20));
    der(Cdc20_CMad2) = (u * k2f * Mad1_CMad2_OMad2 * 1.0 * Cdc20) + (kf6 * OMad2 * Cdc20 * 1.0) - (k3f * Cdc20_CMad2 * 1.0) - (1.0 * (u * k4f * Cdc20_CMad2 * Bub3_BubR1 - k4r * MCC));
    der(Bub3_BubR1) =  - (1.0 * (u * k4f * Cdc20_CMad2 * Bub3_BubR1 - k4r * MCC)) - (1.0 * (u * k5f * Bub3_BubR1 * Cdc20 - k5r * Bub3_BubR1_Cdc20));
    der(MCC) = (1.0 * (u * k4f * Cdc20_CMad2 * Bub3_BubR1 - k4r * MCC)) + (u_prime * k7r * MCC_APC * 1.0) - (u * k7f * MCC * APC * 1.0);
