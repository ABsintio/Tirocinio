...
equation
    ...
    der(P) = (cytoplasm * (VmPGK_6 * (KeqPGK_6 * BPG * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / (1 - 4 * KeqAK_6) - ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) * P3G / (2 - 8 * KeqAK_6)) / (KmPGKATP_6 * KmPGKP3G_6 * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((1 - 4 * KeqAK_6) * KmPGKADP_6) + ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((2 - 8 * KeqAK_6) * KmPGKATP_6)) * (1 + BPG / KmPGKBPG_6 + P3G / KmPGKP3G_6)))) + (cytoplasm * ((VmPYK_9 / (KmPYKPEP_9 * KmPYKADP_9)) * (PEP * (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) - PYR * ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KeqPYK_9) / ((1 + PEP / KmPYKPEP_9 + PYR / KmPYKPYR_9) * (1 + ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KmPYKATP_9 + (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) / KmPYKADP_9)))) - (cytoplasm * (VmGLK_0 * (-(G6P * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KeqGLK_0)) + GLCi * ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / (2 - 8 * KeqAK_0)) / (KmGLKATP_0 * KmGLKGLCi_0 * (1 + G6P / KmGLKG6P_0 + GLCi / KmGLKGLCi_0) * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KmGLKADP_0) + ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((2 - 8 * KeqAK_0) * KmGLKATP_0))))) - (cytoplasm * (gR_2 * VmPFK_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) * (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2)) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2 * (L0_2 * (1 + CPFKF26BP_2 * F26BP / KPFKF26BP_2 + CPFKF16BP_2 * F16P / KPFKF16BP_2)^2 * (1 + 2 * CPFKAMP_2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + CiPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2 * (1 + CPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2))^2 / ((1 + F26BP / KPFKF26BP_2 + F16P / KPFKF16BP_2)^2 * (1 + 2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2) + (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2))^2)))) - (cytoplasm * (KATPASE_13 * ((P - 4 * KeqAK_13 * P - SUMAXP) + ((P^2 - 4 * KeqAK_13 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_13 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_13)));
    der(G6P) = (cytoplasm * (VmGLK_0 * (-(G6P * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KeqGLK_0)) + GLCi * ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / (2 - 8 * KeqAK_0)) / (KmGLKATP_0 * KmGLKGLCi_0 * (1 + G6P / KmGLKG6P_0 + GLCi / KmGLKGLCi_0) * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KmGLKADP_0) + ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((2 - 8 * KeqAK_0) * KmGLKATP_0))))) - (cytoplasm * ((VmPGI_1 / KmPGIG6P_1) * (G6P - F6P / KeqPGI_1) / (1 + G6P / KmPGIG6P_1 + F6P / KmPGIF6P_1))) - (cytoplasm * (VmG6PDH_15 * G6P * NADP / (KmG6P_15 * KmNADP_15) / ((1 + G6P / KmG6P_15 + NADPH / KiNADPH_15) * (1 + NADP / KmNADP_15))));
    der(F6P) = (cytoplasm * ((VmPGI_1 / KmPGIG6P_1) * (G6P - F6P / KeqPGI_1) / (1 + G6P / KmPGIG6P_1 + F6P / KmPGIF6P_1))) + (cytoplasm * ((VmTransaldf_21 * GA3P * Seduhept7P / (KmGA3P_21 * KmSeduhept_21) - VmTransaldr_21 * F6P * Erythrose4P / (KmF6P_21 * KmEry4P_21)) / ((1 + GA3P / KmGA3P_21 + F6P / KmF6P_21) * (1 + Seduhept7P / KmSeduhept_21 + Erythrose4P / KmEry4P_21)))) + (cytoplasm * ((VmTransk2f_22 * Erythrose4P * Xyl5P / (KmEry4P_22 * KmXyl5P_22) - VmTransk2r_22 * F6P * GA3P / (KmF6P_22 * KmGA3P_22)) / ((1 + Xyl5P / KmXyl5P_22 + GA3P / KmGA3P_22) * (1 + Erythrose4P / KmEry4P_22 + F6P / KmF6P_22)))) - (cytoplasm * (gR_2 * VmPFK_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) * (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2)) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2 * (L0_2 * (1 + CPFKF26BP_2 * F26BP / KPFKF26BP_2 + CPFKF16BP_2 * F16P / KPFKF16BP_2)^2 * (1 + 2 * CPFKAMP_2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + CiPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2 * (1 + CPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2))^2 / ((1 + F26BP / KPFKF26BP_2 + F16P / KPFKF16BP_2)^2 * (1 + 2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2) + (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2))^2))));
    der(F16P) = (cytoplasm * (gR_2 * VmPFK_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) * (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2)) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2 * (L0_2 * (1 + CPFKF26BP_2 * F26BP / KPFKF26BP_2 + CPFKF16BP_2 * F16P / KPFKF16BP_2)^2 * (1 + 2 * CPFKAMP_2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + CiPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2 * (1 + CPFKATP_2 * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2))^2 / ((1 + F26BP / KPFKF26BP_2 + F16P / KPFKF16BP_2)^2 * (1 + 2 * KeqAK_2 * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)^2 / ((-1 + 4 * KeqAK_2) * KPFKAMP_2 * ((SUMAXP - P) + 4 * KeqAK_2 * P - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5)))^2 * (1 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KiPFKATP_2))^2) + (1 + F6P / KmPFKF6P_2 + ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2) + gR_2 * F6P * ((-SUMAXP + P - 4 * KeqAK_2 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_2 * SUMAXP * P + P^2 - 4 * KeqAK_2 * P^2)^0.5) / ((2 - 8 * KeqAK_2) * KmPFKATP_2 * KmPFKF6P_2))^2)))) - (cytoplasm * ((VmALD_3 * F16P / KmALDF16P_3) * (1 - DHAP * GA3P / (F16P * KeqALD_3)) / (1 + F16P / KmALDF16P_3 + DHAP / KmALDDHAP_3 + GA3P / KmALDGAP_3 + F16P * GA3P / (KmALDF16P_3 * KmALDGAP_3i) + DHAP * GA3P / (KmALDDHAP_3 * KmALDGAP_3))));
    ...
    der(BPG) = (cytoplasm * ((k_rel_GAPDH * VmGAPDHf_5 * GA3P * NAD / (KmGAPDHGAP_5 * KmGAPDHNAD_5)) * (1 - BPG * NADH / (GA3P * NAD * KeqGAPDH_5)) / ((1 + GA3P / KmGAPDHGAP_5 + BPG / KmGAPDHBPG_5) * (1 + NAD / KmGAPDHNAD_5 + NADH / KmGAPDHNAD_5H_5)))) - (cytoplasm * (VmPGK_6 * (KeqPGK_6 * BPG * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / (1 - 4 * KeqAK_6) - ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) * P3G / (2 - 8 * KeqAK_6)) / (KmPGKATP_6 * KmPGKP3G_6 * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((1 - 4 * KeqAK_6) * KmPGKADP_6) + ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((2 - 8 * KeqAK_6) * KmPGKATP_6)) * (1 + BPG / KmPGKBPG_6 + P3G / KmPGKP3G_6))));
    der(P3G) = (cytoplasm * (VmPGK_6 * (KeqPGK_6 * BPG * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / (1 - 4 * KeqAK_6) - ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) * P3G / (2 - 8 * KeqAK_6)) / (KmPGKATP_6 * KmPGKP3G_6 * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((1 - 4 * KeqAK_6) * KmPGKADP_6) + ((-SUMAXP + P - 4 * KeqAK_6 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_6 * SUMAXP * P + P^2 - 4 * KeqAK_6 * P^2)^0.5) / ((2 - 8 * KeqAK_6) * KmPGKATP_6)) * (1 + BPG / KmPGKBPG_6 + P3G / KmPGKP3G_6)))) - (cytoplasm * ((VmPGM_7 / KmPGMP3G_7) * (P3G - P2G / KeqPGM_7) / (1 + P3G / KmPGMP3G_7 + P2G / KmPGMP2G_7)));
    ...
    der(PEP) = (cytoplasm * ((VmENO_8 / KmENOP2G_8) * (P2G - PEP / KeqENO_8) / (1 + P2G / KmENOP2G_8 + PEP / KmENOPEP_8))) - (cytoplasm * ((VmPYK_9 / (KmPYKPEP_9 * KmPYKADP_9)) * (PEP * (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) - PYR * ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KeqPYK_9) / ((1 + PEP / KmPYKPEP_9 + PYR / KmPYKPYR_9) * (1 + ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KmPYKATP_9 + (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) / KmPYKADP_9))));
    der(PYR) = (cytoplasm * ((VmPYK_9 / (KmPYKPEP_9 * KmPYKADP_9)) * (PEP * (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) - PYR * ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KeqPYK_9) / ((1 + PEP / KmPYKPEP_9 + PYR / KmPYKPYR_9) * (1 + ((P - 4 * KeqAK_9 * P - SUMAXP) + ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (2 - 8 * KeqAK_9) / KmPYKATP_9 + (SUMAXP - ((P^2 - 4 * KeqAK_9 * P^2 - 2 * P * SUMAXP) + 8 * KeqAK_9 * P * SUMAXP + SUMAXP^2)^0.5) / (1 - 4 * KeqAK_9) / KmPYKADP_9)))) - (cytoplasm * (VmPDC_10 * PYR^nPDC_10 / KmPDCPYR_10^nPDC_10 / (1 + PYR^nPDC_10 / KmPDCPYR_10^nPDC_10)));
    der(ACE) = (cytoplasm * (VmPDC_10 * PYR^nPDC_10 / KmPDCPYR_10^nPDC_10 / (1 + PYR^nPDC_10 / KmPDCPYR_10^nPDC_10))) - (2.0 * cytoplasm * KSUCC_11 * ACE) - (cytoplasm * -((VmADH_12 / (KiADHNAD_12 * KmADHETOH_12)) * (NAD * ETOH - NADH * ACE / KeqADH_12) / (1 + NAD / KiADHNAD_12 + KmADHNAD_12 * ETOH / (KiADHNAD_12 * KmADHETOH_12) + KmADHNAD_12H * ACE / (KiADHNAD_12H * KmADHACE_12) + NADH / KiADHNAD_12H + NAD * ETOH / (KiADHNAD_12 * KmADHETOH_12) + KmADHNAD_12H * NAD * ACE / (KiADHNAD_12 * KiADHNAD_12H * KmADHACE_12) + KmADHNAD_12 * ETOH * NADH / (KiADHNAD_12 * KmADHETOH_12 * KiADHNAD_12H) + NADH * ACE / (KiADHNAD_12H * KmADHACE_12) + NAD * ETOH * ACE / (KiADHNAD_12 * KmADHETOH_12 * KiADHACE_12) + ETOH * NADH * ACE / (KiADHETOH_12 * KiADHNAD_12H * KmADHACE_12))));
    der(CO2) = 0.0;
    der(ETOH) = 0.0;
    der(SUCC) = 0.0;
    der(X) = 0.0;
    ...
    der(GLCo) = 0.0;
    der(GLCi) = (cytoplasm * (VmGLT_24 * (GLCo - GLCi / KeqGLT_24) / (KmGLTGLCo_24 * (1 + GLCo / KmGLTGLCo_24 + GLCi / KmGLTGLCi_24 + 0.91 * GLCo * GLCi / (KmGLTGLCi_24 * KmGLTGLCo_24))))) - (cytoplasm * (VmGLK_0 * (-(G6P * (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KeqGLK_0)) + GLCi * ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / (2 - 8 * KeqAK_0)) / (KmGLKATP_0 * KmGLKGLCi_0 * (1 + G6P / KmGLKG6P_0 + GLCi / KmGLKGLCi_0) * (1 + (SUMAXP - ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((1 - 4 * KeqAK_0) * KmGLKADP_0) + ((-SUMAXP + P - 4 * KeqAK_0 * P) + ((SUMAXP^2 - 2 * SUMAXP * P) + 8 * KeqAK_0 * SUMAXP * P + P^2 - 4 * KeqAK_0 * P^2)^0.5) / ((2 - 8 * KeqAK_0) * KmGLKATP_0)))));
    der(F26BP) = 0.0;
