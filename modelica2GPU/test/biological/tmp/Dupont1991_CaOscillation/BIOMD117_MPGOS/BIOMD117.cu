...
#include "BIOMD117_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_flag" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_intracellular_Ca_storepool" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_tstim" << ',';
