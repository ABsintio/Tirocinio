...
model BIOMD180 "Kim2007_CellularMemory_SymmetricModel"
    ...
    parameter Real d_P4_prime = 0.37048;
    parameter Real sP4_prime_P1_prime = 0.5;
...
equation
    i2 = piecewise(1, and(geq(t, 175), leq(t, 225)), 0);
    i1 = piecewise(1, and(geq(t, 50), leq(t, 100)), 0);
    der(R1) = (i1) - (d_R1 * R1);
    ...
    der(P2_prime) = (sP2_prime_P2 * P2) + (s2 / (1 + P1_prime^n)) + (s3 / (1 + P4_prime^n)) - (d_P2_prime * P2_prime);
    der(P3_prime) = (sP3_prime_P2_prime * (P2_prime^n / (1 + P2_prime^n))) - (d_P3_prime * P3_prime);
    der(P4_prime) = (sP4_prime_P1_prime * (P1_prime^n / (1 + P1_prime^n))) - (d_P4_prime * P4_prime);
