...
#include "BIOMD168_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_theta_1" << ',';
        DataFile.width(Width); DataFile << "ACC_E2F_1" << ',';
        DataFile.width(Width); DataFile << "ACC_RP_1" << ',';
        DataFile.width(Width); DataFile << "ACC_unpho_RB" << ',';
