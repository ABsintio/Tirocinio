...
model BIOMD541 "Yugi2014 - Insulin induced signalling (PFKL phosphorylation) - model 2"
    ...
    parameter Real insulin = 1.0;
    parameter Real k1_10 = 0.0477985900779305;
    parameter Real k1_11 = 7.78160761103111;
    parameter Real k2_11 = 1.61147523779118;
    parameter Real k1_12 = 9.93311225447353;
    parameter Real k1_13 = 0.363030286526969;
    parameter Real k2_13 = 0.408127912886804;
    parameter Real k1_14 = 3.88248960751442e-05;
    parameter Real k1_15 = 0.28442597446931;
    parameter Real k1_16 = 1.00000000282413e-05;
    parameter Real k1_17 = 0.0948960328385619;
    parameter Real k1_18 = 0.00919578911309774;
    parameter Real k1_19 = 7.70618517548016;
    parameter Real k1_20 = 1.00277786609339e-05;
    parameter Real k1_21 = 0.00792717614041237;
    parameter Real k1_22 = 0.419682384304397;
    parameter Real k1_23 = 0.124330492920416;
    parameter Real k1_24 = 0.00752464611370891;
    parameter Real k1_25 = 1.95497593092361;
    parameter Real k1_26 = 0.00105342379833469;
    parameter Real k1_27 = 0.00145811601430322;
    parameter Real k1_28 = 26.8316707654711;
    parameter Real k1_29 = 0.0166525139097609;
...
initial equation
    ...
    s19 = 0.0;
    s23 = 37.81914621;
    s24 = 46.2222520609226;
    s25 = 2.507671281;
    s26 = 852.608418;
    s27 = 3.930695895;
    s28 = 4.33812187331668;
    s29 = 0.012942682;
    s30 = 0.0959163701057347;
    s31 = 0.004015031;
    s32 = 2.7769943784158;
    s33 = 0.000988831;
    s34 = 14.9913345914433;
    s35 = 0.043352951;
    s36 = 0.0;
    s37 = 0.0;
    s38 = 0.0;
...
equation
    ...
    der(s11) = (k_ALDO * s4) ;
    der(s12) = 0.0;
    der(s13) = (k1_28 * (s1 - s13) * s33) - (k1_29 * s13);
    der(s14) = ((-k_mal)) ;
    der(s15) = ((-k_akg)) ;
    der(s16) = ((-k_pep)) ;
    der(s17) = ((-k_icit)) ;
    ...
    der(s21) = ((-k_f6p)) ;
    der(s19) = ((-k_cit)) ;
    der(s23) = (k1_10 * (s24 - s23)) + (k1_16 * s26) - (k1_11 * insulin * s23 - k2_11 * s25) - (k1_12 * s23 * s31);
    der(s24) = 0.0;
    der(s25) = (k1_11 * insulin * s23 - k2_11 * s25) + (k1_15 * s27) - (k1_14 * s25 * s31) - (k1_21 * s25);
    der(s26) = (k1_12 * s23 * s31) - (k1_13 * insulin * s26 - k2_13 * s27) - (k1_16 * s26) - (k1_20 * s26);
    der(s27) = (k1_13 * insulin * s26 - k2_13 * s27) + (k1_14 * s25 * s31) - (k1_15 * s27) - (k1_17 * s27);
    der(s28) = 0.0;
    der(s29) = (k1_18 * (s28 - s29) * s25) - (k1_19 * s29);
    der(s30) = 0.0;
    der(s31) = (k1_22 * (s30 - s31) * s29) - (k1_23 * s31);
    der(s32) = 0.0;
    der(s33) = (k1_24 * (s32 - s33) * s31) - (k1_25 * s33 * s35);
    der(s34) = 0.0;
    der(s35) = (k1_26 * (s34 - s35) * s31) - (k1_27 * s35);
    der(s36) = (k1_17 * s27) ;
    der(s37) = (k1_20 * s26) ;
    der(s38) = (k1_21 * s25) ;
    der(k_mal)=0.0;
