...
#include "BIOMD371_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_V_m" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_n" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_s" << ',';
        DataFile.width(Width); DataFile << "sPAR_g_Ca" << ',';
        DataFile.width(Width); DataFile << "sPAR_g_K" << ',';
        DataFile.width(Width); DataFile << "sPAR_g_K_ATP" << ',';
        DataFile.width(Width); DataFile << "sPAR_g_s" << ',';
        DataFile.width(Width); DataFile << "sPAR_lamda" << ',';
        DataFile.width(Width); DataFile << "sPAR_p" << ',';
        DataFile.width(Width); DataFile << "sPAR_tau_membrane" << ',';
        DataFile.width(Width); DataFile << "sPAR_tau_potassium_current_n_gate" << ',';
        DataFile.width(Width); DataFile << "sPAR_tau_s" << ',';
        DataFile.width(Width); DataFile << "sPAR_theta_m" << ',';
        DataFile.width(Width); DataFile << "sPAR_theta_n" << ',';
        DataFile.width(Width); DataFile << "sPAR_theta_s" << ',';
        DataFile.width(Width); DataFile << "ACC_i_Ca" << ',';
        DataFile.width(Width); DataFile << "ACC_i_K" << ',';
        DataFile.width(Width); DataFile << "ACC_i_K_ATP" << ',';
        DataFile.width(Width); DataFile << "ACC_i_s" << ',';
        DataFile.width(Width); DataFile << "ACC_m_infinity" << ',';
        DataFile.width(Width); DataFile << "ACC_n_infinity" << ',';
        DataFile.width(Width); DataFile << "ACC_s_infinity" << ',';
