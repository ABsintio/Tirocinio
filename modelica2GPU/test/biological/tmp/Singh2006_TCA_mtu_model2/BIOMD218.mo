...
equation
    ...
    der(akg) = (1.0 * ((Vf_icd1_ICD1 * (icit / Kicit_icd1_ICD1) - Vr_icd1_ICD1 * (akg / Kakg_icd1_ICD1)) / (1 + icit / Kicit_icd1_ICD1 + akg / Kakg_icd1_ICD1))) + (1.0 * ((Vf_icd2_ICD2 * (icit / Kicit_icd2_ICD2) - Vr_icd2_ICD2 * (akg / Kakg_icd2_ICD2)) / (1 + icit / Kicit_icd2_ICD2 + akg / Kakg_icd2_ICD2))) - (1.0 * ((Vf_kgd_KGD * (akg / Kakg_kgd_KGD) - Vr_kgd_KGD * (ssa / Kssa_kgd_KGD)) / (1 + akg / Kakg_kgd_KGD + ssa / Kssa_kgd_KGD))) - (1.0 * 0.0341 * ((Vf_icd1_SYN * (icit / Kicit_icd1_SYN) - Vr_icd1_SYN * (akg / Kakg_icd1_SYN)) / (1 + icit / Kicit_icd1_SYN + akg / Kakg_icd1_SYN) + (Vf_icd2_SYN * (icit / Kicit_icd2_SYN) - Vr_icd2_SYN * (akg / Kakg_icd2_SYN)) / (1 + icit / Kicit_icd2_SYN + akg / Kakg_icd2_SYN)));
    ...
    der(sca) =  - (1.0 * ((Vf_scas_ScAS * (sca / Ksca_scas_ScAS) - Vr_scas_ScAS * (suc / Ksuc_scas_ScAS)) / (1 + sca / Ksca_scas_ScAS + suc / Ksuc_scas_ScAS)));
