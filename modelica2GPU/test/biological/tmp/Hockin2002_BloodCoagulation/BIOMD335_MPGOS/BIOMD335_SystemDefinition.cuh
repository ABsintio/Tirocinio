...
#ifndef BIOMD335_PERTHREAD_SYSTEMDEFINITION_H
#define BIOMD335_PERTHREAD_SYSTEMDEFINITION_H
...
template<class Precision> __forceinline__ __device__ void PerThread_OdeFunction(
    ...
    F[32]=(sPAR[0] * ((sPAR[25] * X[31]) + (X[32] * (((-(sPAR[26])) * X[30]) - (sPAR[33] * X[0])))));
    ...
    F[25]=(sPAR[0] * ((sPAR[19] * (X[2] * X[18])) + ((sPAR[20] * X[30]) - (sPAR[21] * (X[27] * X[25])))));
    F[18]=((-(sPAR[0])) * (sPAR[19] * (X[2] * X[18])));
    ...
    F[5]=(sPAR[0] * ((sPAR[18] * (X[8] + X[7])) + ((sPAR[7] * X[14]) + ((sPAR[10] * X[7]) + (X[5] * (((-(sPAR[11])) * X[21]) - (sPAR[35] * X[0])))))));
    ...
    F[26]=(sPAR[0] * ((sPAR[18] * X[8]) + ((sPAR[41] * X[15]) + ((sPAR[13] * X[8]) + (((-(sPAR[14])) * (X[7] * X[26])) - (sPAR[42] * (X[12] * X[26])))))));
    F[15]=(sPAR[0] * ((sPAR[42] * (X[12] * X[26])) + (((-(sPAR[41])) - sPAR[2]) * X[15])));
    F[2]=(sPAR[0] * ((sPAR[40] * (X[2] * X[19])) + ((sPAR[8] * (X[27] * X[1])) + ((X[2] * ((sPAR[9] * X[20]) + (sPAR[19] * X[18]))) + ((sPAR[26] * (X[32] * X[30])) + (X[2] * (((((-(sPAR[9])) * X[20]) - (sPAR[40] * X[19])) - (sPAR[36] * X[0])) - (sPAR[19] * X[18]))))))));
    F[27]=(sPAR[0] * ((X[27] * ((sPAR[39] * X[19]) + (sPAR[8] * X[1]))) + ((sPAR[15] * X[8]) + ((sPAR[3] * X[16]) + ((X[27] * (((-(sPAR[39])) * X[19]) - (sPAR[8] * X[1]))) + ((sPAR[20] * X[30]) + ((sPAR[27] * X[29]) + ((X[27] * (((-(sPAR[21])) * X[25]) - (sPAR[32] * X[0]))) + (((-(sPAR[4])) * (X[12] * X[27])) - (sPAR[28] * (X[27] * X[10])))))))))));
    F[24]=(sPAR[0] * ((sPAR[38] * (X[12] * X[19])) + ((sPAR[39] * (X[27] * X[19])) + ((sPAR[40] * (X[2] * X[19])) + ((sPAR[23] * X[12]) - (sPAR[34] * (X[9] * X[24])))))));
    F[12]=(sPAR[0] * ((sPAR[34] * (X[9] * X[24])) + ((X[12] * ((sPAR[38] * X[19]) - sPAR[23])) + ((sPAR[7] * X[14]) + ((sPAR[41] * X[15]) + ((sPAR[3] * X[16]) + ((sPAR[5] * X[14]) + (X[12] * (((((((-(sPAR[42])) * X[26]) - (sPAR[38] * X[19])) - (sPAR[37] * X[0])) - (sPAR[6] * X[4])) - (sPAR[31] * X[29])) - (sPAR[4] * X[27]))))))))));
    F[19]=((-(sPAR[0])) * ((sPAR[12] * (X[9] * X[19])) + ((sPAR[38] * (X[12] * X[19])) + ((sPAR[39] * (X[27] * X[19])) + ((sPAR[40] * (X[2] * X[19])) - (sPAR[1] * X[11]))))));
...
template<class Precision> __forceinline__ __device__ void PerThread_Initialization(
    ...
    sPAR[37]=230.0; //k42
    sPAR[38]=440000.0; //k5
    sPAR[39]=13000000.0; //k6
    sPAR[40]=23000.0; //k7
    sPAR[41]=1.05; //k8
    sPAR[42]=25000000.0; //k9
    X[0]=3.4e-06; //ATIII
    X[1]=1.4e-06; //II
    X[2]=0.0; //IIa
    X[3]=0.0; //IIa_ATIII
