...
variables_to_plot = ["IR","IRins","IRp","IRip","IRi","IRS","IRSip","X","Xp","V1a","V1b","V1c","V1d","V1e","V1g","V1r","V2","Vm2","V3","Vm3","simXP","intamount","measIRp","measdoublestep","measanna","measdosR"]
