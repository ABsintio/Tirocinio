...
model BIOMD430 "Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_USEQ)"
    ...
    parameter Real k1_7 = 0.086;
    parameter Real k1_8 = 0.0;
    parameter Real k2_8 = 0.0;
    ...
    parameter Real k1_16 = 0.086;
    parameter Real k1_17 = 0.0;
    parameter Real k2_17 = 0.0;
    ...
    parameter Real k1_25 = 0.086;
    parameter Real k1_26 = 0.0;
    parameter Real k2_26 = 0.0;
    parameter Real k1_27 = 0.0;
    parameter Real k2_27 = 0.0;
...
equation
    ...
    der(species_1) = (compartment_1 * k1_7 * species_22) + (compartment_1 * (k1_8 * species_23 - k2_8 * species_1 * species_13)) - (compartment_1 * (k1_0 * species_1 * species_2 - k2_0 * species_3));
    ...
    der(species_7) = (compartment_1 * k1_16 * species_14) + (compartment_1 * (k1_17 * species_15 - k2_17 * species_7 * species_13)) + (compartment_1 * k1_25 * species_25) + (compartment_1 * (k1_26 * species_26 - k2_26 * species_7 * species_20)) - (compartment_1 * (k1_9 * species_7 * species_8 - k2_9 * species_9));
    ...
    der(species_13) = (compartment_1 * k1_5 * species_21) + (compartment_1 * k1_7 * species_22) + (compartment_1 * (k1_8 * species_23 - k2_8 * species_1 * species_13)) + (compartment_1 * k1_14 * species_12) + (compartment_1 * k1_16 * species_14) + (compartment_1 * (k1_17 * species_15 - k2_17 * species_7 * species_13)) - (compartment_1 * (k1_4 * species_6 * species_13 - k2_4 * species_21)) - (compartment_1 * (k1_6 * species_4 * species_13 - k2_6 * species_22)) - (compartment_1 * (k1_13 * species_2 * species_13 - k2_13 * species_12)) - (compartment_1 * (k1_15 * species_10 * species_13 - k2_15 * species_14));
    der(species_14) = (compartment_1 * (k1_15 * species_10 * species_13 - k2_15 * species_14)) - (compartment_1 * k1_16 * species_14);
    der(species_15) =  - (compartment_1 * (k1_17 * species_15 - k2_17 * species_7 * species_13));
    der(species_16) = (compartment_1 * k1_21 * species_19) + (compartment_1 * (k1_27 * species_27 - k2_27 * species_16 * species_20)) - (compartment_1 * (k1_18 * species_16 * species_18 - k2_18 * species_17));
    ...
    der(species_23) =  - (compartment_1 * (k1_8 * species_23 - k2_8 * species_1 * species_13));
    ...
    der(species_26) =  - (compartment_1 * (k1_26 * species_26 - k2_26 * species_7 * species_20));
    der(species_27) =  - (compartment_1 * (k1_27 * species_27 - k2_27 * species_16 * species_20));
