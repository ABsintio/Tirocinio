...
#include "BIOMD381_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_Ba" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_Amax" << ',';
        DataFile.width(Width); DataFile << "sPAR_J" << ',';
        DataFile.width(Width); DataFile << "sPAR_Wmax" << ',';
