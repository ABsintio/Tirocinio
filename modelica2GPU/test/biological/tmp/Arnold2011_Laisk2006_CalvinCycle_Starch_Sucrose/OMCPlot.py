...
variables_to_plot = ["RuBP","ER","EPP","EPG","EP","EOP","PGA","TP","FBP","HeP","E4P","SBP","S7P","PeP","ADPG","ATP","PiPi","H","O2","NADPH","NADP","PGAc","TPc","FBPc","F26BPc","HePc","UDPGc","UTPc","UDPc","ATPc","SucPc","Succ","PiPic","Hc"]
