...
#include "BIOMD043_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_Fraction_Inactive_Channels" << ',';
        DataFile.width(Width); DataFile << "X_Rho" << ',';
