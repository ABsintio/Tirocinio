...
#include "BIOMD020_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_E_R" << ',';
        DataFile.width(Width); DataFile << "sPAR_I" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_V_L" << ',';
        DataFile.width(Width); DataFile << "ACC_V_Na" << ',';
