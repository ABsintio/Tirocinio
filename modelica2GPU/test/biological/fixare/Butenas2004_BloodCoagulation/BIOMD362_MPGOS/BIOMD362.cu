...
#include "BIOMD362_SystemDefinition.cuh"
...
int main() {
    ...
    Solver.SolverOption(MinimumTimeStep, 1e-2);
    ...
    Solver.SolverOption(AbsoluteTolerance, 0, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 1, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 2, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 3, 1e-09);
    ...
    Solver.SolverOption(AbsoluteTolerance, 8, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 9, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 10, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 11, 1e-09);
    Solver.SolverOption(AbsoluteTolerance, 12, 1e-18);
    Solver.SolverOption(AbsoluteTolerance, 13, 1e-18);
    Solver.SolverOption(AbsoluteTolerance, 14, 1e-18);
    Solver.SolverOption(AbsoluteTolerance, 15, 1e-18);
    ...
    Solver.SolverOption(AbsoluteTolerance, 20, 1e-11);
    Solver.SolverOption(AbsoluteTolerance, 21, 1e-11);
    Solver.SolverOption(AbsoluteTolerance, 22, 1e-11);
    ...
    Solver.SolverOption(AbsoluteTolerance, 32, 1e-07);
    Solver.SolverOption(AbsoluteTolerance, 33, 1e-07);
