...
#include "BIOMD054_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_U" << ',';
        DataFile.width(Width); DataFile << "sPAR_W" << ',';
        DataFile.width(Width); DataFile << "sPAR_W2" << ',';
        DataFile.width(Width); DataFile << "sPAR_W3" << ',';
        DataFile.width(Width); DataFile << "sPAR_k" << ',';
        DataFile.width(Width); DataFile << "sPAR_n" << ',';
        DataFile.width(Width); DataFile << "ACC_M" << ',';
