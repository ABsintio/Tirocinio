...
#include "BIOMD481_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_CL" << ',';
        ...
        DataFile.width(Width); DataFile << "X_Foll" << ',';
        DataFile.width(Width); DataFile << "X_GnRH_Hyp" << ',';
        DataFile.width(Width); DataFile << "X_GnRH_Pit" << ',';
        DataFile.width(Width); DataFile << "X_IOF" << ',';
        DataFile.width(Width); DataFile << "X_Inh" << ',';
        DataFile.width(Width); DataFile << "X_LH_Bld" << ',';
        DataFile.width(Width); DataFile << "X_LH_Pit" << ',';
        DataFile.width(Width); DataFile << "X_OT" << ',';
        DataFile.width(Width); DataFile << "X_P4" << ',';
        DataFile.width(Width); DataFile << "X_PGF" << ',';
        DataFile.width(Width); DataFile << "X_snk_CL" << ',';
        DataFile.width(Width); DataFile << "X_snk_E2" << ',';
        DataFile.width(Width); DataFile << "X_snk_Enz" << ',';
        DataFile.width(Width); DataFile << "X_snk_FSH" << ',';
        DataFile.width(Width); DataFile << "X_snk_Foll" << ',';
        DataFile.width(Width); DataFile << "X_snk_GnRH_Hyp" << ',';
        DataFile.width(Width); DataFile << "X_snk_GnRH_Pit" << ',';
        DataFile.width(Width); DataFile << "X_snk_IOF" << ',';
        DataFile.width(Width); DataFile << "X_snk_Inh" << ',';
        DataFile.width(Width); DataFile << "X_snk_LH" << ',';
        DataFile.width(Width); DataFile << "X_snk_OT" << ',';
        DataFile.width(Width); DataFile << "X_snk_P4" << ',';
        DataFile.width(Width); DataFile << "X_snk_PGF" << ',';
        DataFile.width(Width); DataFile << "X_species_1" << ',';
        DataFile.width(Width); DataFile << "X_src_CL" << ',';
        DataFile.width(Width); DataFile << "X_src_E2" << ',';
        DataFile.width(Width); DataFile << "X_src_Enz" << ',';
        DataFile.width(Width); DataFile << "X_src_FSH" << ',';
        DataFile.width(Width); DataFile << "X_src_Foll" << ',';
        DataFile.width(Width); DataFile << "X_src_GnRH" << ',';
        DataFile.width(Width); DataFile << "X_src_GnRH_Pit" << ',';
        DataFile.width(Width); DataFile << "X_src_IOF" << ',';
        DataFile.width(Width); DataFile << "X_src_Inh" << ',';
        DataFile.width(Width); DataFile << "X_src_LH" << ',';
        DataFile.width(Width); DataFile << "X_src_OT" << ',';
        DataFile.width(Width); DataFile << "X_src_P4" << ',';
        DataFile.width(Width); DataFile << "X_src_PGF" << ',';
