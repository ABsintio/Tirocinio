...
#include "BIOMD499_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "ACC_species_11" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_species_18" << ',';
        DataFile.width(Width); DataFile << "ACC_species_20" << ',';
        DataFile.width(Width); DataFile << "ACC_species_21" << ',';
        DataFile.width(Width); DataFile << "ACC_species_23" << ',';
        DataFile.width(Width); DataFile << "ACC_species_25" << ',';
