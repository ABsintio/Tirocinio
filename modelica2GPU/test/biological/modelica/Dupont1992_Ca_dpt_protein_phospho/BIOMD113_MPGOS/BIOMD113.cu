...
#include "BIOMD113_SystemDefinition.cuh"
#include "SingleSystem_PerThread_Interface.cuh"

using namespace std;

#define SOLVER RK4//CK45 // Runge-Kutta Order 4th
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_W_star" << ',';
        DataFile.width(Width); DataFile << "X_Wt" << ',';
        DataFile.width(Width); DataFile << "X_Y" << ',';
        DataFile.width(Width); DataFile << "X_Z" << ',';
        DataFile.width(Width); DataFile << "X_vMK" << ',';
