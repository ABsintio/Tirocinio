...
#include "BIOMD412_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_cCOP1c" << ',';
        DataFile.width(Width); DataFile << "X_cCOP1d" << ',';
        DataFile.width(Width); DataFile << "X_cCOP1n" << ',';
        DataFile.width(Width); DataFile << "X_cE3" << ',';
        DataFile.width(Width); DataFile << "X_cE3_m" << ',';
        DataFile.width(Width); DataFile << "X_cE3n" << ',';
        DataFile.width(Width); DataFile << "X_cE4" << ',';
        DataFile.width(Width); DataFile << "X_cE4_m" << ',';
        DataFile.width(Width); DataFile << "X_cEC" << ',';
        DataFile.width(Width); DataFile << "X_cEG" << ',';
        DataFile.width(Width); DataFile << "X_cG" << ',';
        DataFile.width(Width); DataFile << "X_cG_m" << ',';
        DataFile.width(Width); DataFile << "X_cL" << ',';
        DataFile.width(Width); DataFile << "X_cLUX" << ',';
        DataFile.width(Width); DataFile << "X_cLUX_m" << ',';
        DataFile.width(Width); DataFile << "X_cL_m" << ',';
        DataFile.width(Width); DataFile << "X_cLm" << ',';
        DataFile.width(Width); DataFile << "X_cNI" << ',';
        DataFile.width(Width); DataFile << "X_cNI_m" << ',';
        DataFile.width(Width); DataFile << "X_cP" << ',';
        DataFile.width(Width); DataFile << "X_cP7" << ',';
        DataFile.width(Width); DataFile << "X_cP7_m" << ',';
        DataFile.width(Width); DataFile << "X_cP9" << ',';
        DataFile.width(Width); DataFile << "X_cP9_m" << ',';
        DataFile.width(Width); DataFile << "X_cT" << ',';
        DataFile.width(Width); DataFile << "X_cT_m" << ',';
        DataFile.width(Width); DataFile << "X_cZG" << ',';
        DataFile.width(Width); DataFile << "X_cZTL" << ',';
        ...
        DataFile.width(Width); DataFile << "X_s43" << ',';
        DataFile.width(Width); DataFile << "X_s44" << ',';
        DataFile.width(Width); DataFile << "X_s45" << ',';
