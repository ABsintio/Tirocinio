...
#include "BIOMD206_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_at" << ',';
        ...
        DataFile.width(Width); DataFile << "X_s6o" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_ntot" << ',';
