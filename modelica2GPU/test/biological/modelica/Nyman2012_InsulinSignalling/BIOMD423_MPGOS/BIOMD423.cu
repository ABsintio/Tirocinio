...
#include "BIOMD423_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "ACC_IRmem" << ',';
        DataFile.width(Width); DataFile << "ACC_measIRS1" << ',';
        DataFile.width(Width); DataFile << "ACC_measIRp" << ',';
