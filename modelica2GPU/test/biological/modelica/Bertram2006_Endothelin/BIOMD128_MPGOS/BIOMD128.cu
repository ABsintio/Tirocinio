...
#include "BIOMD128_SystemDefinition.cuh"
...
void FillSolverObject(
    ...
    while (k_begin < k_end) {
        ...
        Solver.SetHost(ProblemNumber, TimeDomain, 1, 175000.0);  
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_cAMPlow" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_taudir" << ',';
        DataFile.width(Width); DataFile << "sPAR_tauh" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_binf" << ',';
        DataFile.width(Width); DataFile << "ACC_hinf" << ',';
        DataFile.width(Width); DataFile << "ACC_hinfer" << ',';
        DataFile.width(Width); DataFile << "ACC_ica" << ',';
        DataFile.width(Width); DataFile << "ACC_igirk" << ',';
        DataFile.width(Width); DataFile << "ACC_ik" << ',';
        DataFile.width(Width); DataFile << "ACC_jerip3" << ',';
        DataFile.width(Width); DataFile << "ACC_jerleak" << ',';
        DataFile.width(Width); DataFile << "ACC_jerp" << ',';
        DataFile.width(Width); DataFile << "ACC_jertot" << ',';
        DataFile.width(Width); DataFile << "ACC_jmemtot" << ',';
        DataFile.width(Width); DataFile << "ACC_minf" << ',';
        DataFile.width(Width); DataFile << "ACC_ninf" << ',';
        DataFile.width(Width); DataFile << "ACC_o" << ',';
        DataFile.width(Width); DataFile << "ACC_perl_inf" << ',';
