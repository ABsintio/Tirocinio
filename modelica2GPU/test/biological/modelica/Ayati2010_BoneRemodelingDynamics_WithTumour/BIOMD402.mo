...
model BIOMD402 "Ayati2010_BoneRemodelingDynamics_WithTumour"
...
equation
    ...
    der(B) = alpha2 * pow(C, g12 / (1 + r12 * Tumour / LT)) * pow(B, g22 - r22 * Tumour / LT) - beta2 * B;
    der(z) = k2 * y2 - k1 * y1;
    der(Tumour) = gammaT * Tumour * log(LT / Tumour);
