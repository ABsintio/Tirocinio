...
model BIOMD455 "Smallbone2013 - Metabolic Control Analysis - Example 2"
    ...
    parameter Real e5_4 = 1.0;
    parameter Real p5_4 = 0.0;
...
equation
    ...
    der(x3) = (e1_0 * (p1_0 * y1 * x2 - x1 * x3) / (1 + y1 + x2 + x1 + x3 + y1 * x2 + x1 * x3)) - (e2_1 * (p2_1 * y4 * x3 - y5 * x2) / (1 + x3 + x2 + y4 + y5 + x3 * y4 + x2 * y5)) - (e5_4 * p5_4 * x3);
    der(y1) = 0.0;
    der(y2) = 0.0;
    der(y3) = 0.0;
    der(y4) = 0.0;
