...
#include "BIOMD474_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_AMPK" << ',';
        DataFile.width(Width); DataFile << "X_AS160" << ',';
        DataFile.width(Width); DataFile << "X_AS160_P" << ',';
        DataFile.width(Width); DataFile << "X_Akt" << ',';
        DataFile.width(Width); DataFile << "X_Akt_P2" << ',';
        DataFile.width(Width); DataFile << "X_CBPP300" << ',';
        DataFile.width(Width); DataFile << "X_CDK2" << ',';
        DataFile.width(Width); DataFile << "X_DUSP" << ',';
        DataFile.width(Width); DataFile << "X_DUSP_ox" << ',';
        DataFile.width(Width); DataFile << "X_E2F1" << ',';
        DataFile.width(Width); DataFile << "X_E3" << ',';
        DataFile.width(Width); DataFile << "X_GSH" << ',';
        DataFile.width(Width); DataFile << "X_GSSG" << ',';
        DataFile.width(Width); DataFile << "X_IKK" << ',';
        DataFile.width(Width); DataFile << "X_IKK_P" << ',';
        DataFile.width(Width); DataFile << "X_IRS1" << ',';
        DataFile.width(Width); DataFile << "X_IRS1_PolySerP" << ',';
        DataFile.width(Width); DataFile << "X_IRS1_TyrP" << ',';
        DataFile.width(Width); DataFile << "X_IRS1_TyrP_PI3K" << ',';
        DataFile.width(Width); DataFile << "X_IRS1_TyrP_PolySerP" << ',';
        DataFile.width(Width); DataFile << "X_InR" << ',';
        DataFile.width(Width); DataFile << "X_Ins" << ',';
        DataFile.width(Width); DataFile << "X_Ins_2_InR_P" << ',';
        DataFile.width(Width); DataFile << "X_Ins_InR" << ',';
        DataFile.width(Width); DataFile << "X_Ins_InR_P" << ',';
        DataFile.width(Width); DataFile << "X_JNK" << ',';
        DataFile.width(Width); DataFile << "X_JNK_P" << ',';
        DataFile.width(Width); DataFile << "X_Mt" << ',';
        DataFile.width(Width); DataFile << "X_NOX" << ',';
        DataFile.width(Width); DataFile << "X_NOX_deact" << ',';
        DataFile.width(Width); DataFile << "X_NOX_inact" << ',';
        DataFile.width(Width); DataFile << "X_NULL" << ',';
        DataFile.width(Width); DataFile << "X_PI345P3" << ',';
        DataFile.width(Width); DataFile << "X_PI3K" << ',';
        DataFile.width(Width); DataFile << "X_PIP2" << ',';
        DataFile.width(Width); DataFile << "X_PKC" << ',';
        DataFile.width(Width); DataFile << "X_PKC_P" << ',';
        DataFile.width(Width); DataFile << "X_PP2A" << ',';
        DataFile.width(Width); DataFile << "X_PTEN" << ',';
        DataFile.width(Width); DataFile << "X_PTEN_ox" << ',';
        DataFile.width(Width); DataFile << "X_PTP1B" << ',';
        DataFile.width(Width); DataFile << "X_PTP1B_ox" << ',';
        DataFile.width(Width); DataFile << "X_Proteasome" << ',';
        DataFile.width(Width); DataFile << "X_ROS" << ',';
        DataFile.width(Width); DataFile << "X_SCF" << ',';
        DataFile.width(Width); DataFile << "X_SGK" << ',';
        DataFile.width(Width); DataFile << "X_SIRT1" << ',';
        DataFile.width(Width); DataFile << "X_USP7" << ',';
        DataFile.width(Width); DataFile << "X_cellsurface_GLUT4" << ',';
        DataFile.width(Width); DataFile << "X_cytoplasm
pUb1" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd0_Pe1_pUb0" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd0_Pe1_pUb1" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd1_Pe0_pUb0" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd1_Pe0_pUb1" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd1_Pe1_pUb0" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_Foxo1_Pa1_Pd1_Pe1_pUb1" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_RNA_InR" << ',';
        DataFile.width(Width); DataFile << "X_nucleus_RNA_SOD2" << ',';
        DataFile.width(Width); DataFile << "X_null" << ',';
        DataFile.width(Width); DataFile << "ACC_DUSP_plus_DUSP_ox" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pa0_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pa1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pd0_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pd1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pe0_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_Pe1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_all" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_pUb0_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_Foxo1_pUb1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_IKK_plus_IKK_P" << ',';
        DataFile.width(Width); DataFile << "ACC_IRS_total" << ',';
        DataFile.width(Width); DataFile << "ACC_InR_active" << ',';
        DataFile.width(Width); DataFile << "ACC_InR_bound" << ',';
        DataFile.width(Width); DataFile << "ACC_InR_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_JNK_plus_JNK_P" << ',';
        DataFile.width(Width); DataFile << "ACC_NOX_total" << ',';
        DataFile.width(Width); DataFile << "ACC_PI345P3_mol" << ',';
        DataFile.width(Width); DataFile << "ACC_PIP2_mol" << ',';
        DataFile.width(Width); DataFile << "ACC_PTEN_plus_PTEN_ox" << ',';
        DataFile.width(Width); DataFile << "ACC_PTP1B_plus_PTP1B_ox" << ',';
        DataFile.width(Width); DataFile << "ACC_cytoplasm_Foxo1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_dnabound_Foxo1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_insconc" << ',';
        DataFile.width(Width); DataFile << "ACC_k_ros_perm" << ',';
        DataFile.width(Width); DataFile << "ACC_nucleus_Foxo1_tot" << ',';
        DataFile.width(Width); DataFile << "ACC_ros_cyto_conc" << ',';
        DataFile.width(Width); DataFile << "ACC_ros_ext_conc" << ',';
        DataFile.width(Width); DataFile << "ACC_rosconc" << ',';
