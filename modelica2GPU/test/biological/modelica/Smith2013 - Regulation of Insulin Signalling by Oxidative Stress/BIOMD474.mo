...
model BIOMD474 "Smith2013 - Regulation of Insulin Signalling by Oxidative Stress"
	...
	input Real pip3_basal;
        output Real y;
    algorithm
        y :=  k12 * PKC * cytoplasm * piecewise(PI345P3 * cytoplasm - pip3_basal, (PI345P3 * cytoplasm) > pip3_basal, 0) / cytoplasm;
    end function_21;
	...
	input Real pip3_basal;
        output Real y;
    algorithm
        y :=  k11 * Akt * cytoplasm * piecewise(PI345P3 * cytoplasm - pip3_basal, (PI345P3 * cytoplasm) > pip3_basal, 0) / cytoplasm;
    end function_17;
