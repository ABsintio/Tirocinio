...
#include "BIOMD058_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_h2" << ',';
        DataFile.width(Width); DataFile << "sPAR_D" << ',';
        DataFile.width(Width); DataFile << "sPAR_Jleak" << ',';
        ...
        DataFile.width(Width); DataFile << "ACC_Phi1_c1" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi1_c2" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi2_c1" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi2_c2" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi3_c1" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi3_c2" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi_minus1_c1" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi_minus1_c2" << ',';
