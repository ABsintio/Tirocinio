...
#include "BIOMD560_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_ADAMTS5" << ',';
        DataFile.width(Width); DataFile << "X_AGEprod" << ',';
        DataFile.width(Width); DataFile << "X_AcanmRNA" << ',';
        ...
        DataFile.width(Width); DataFile << "X_Alk1" << ',';
        DataFile.width(Width); DataFile << "X_Alk1_Alk5" << ',';
        DataFile.width(Width); DataFile << "X_Alk5" << ',';
        DataFile.width(Width); DataFile << "X_Alk5_dimer" << ',';
        DataFile.width(Width); DataFile << "X_Bax" << ',';
        DataFile.width(Width); DataFile << "X_Bax_Bcl2" << ',';
        DataFile.width(Width); DataFile << "X_Bax_Bcl2_Beclin" << ',';
        DataFile.width(Width); DataFile << "X_Bax_Bcl2_Beclin_I" << ',';
        DataFile.width(Width); DataFile << "X_Bcl2" << ',';
        DataFile.width(Width); DataFile << "X_Bcl2_Beclin" << ',';
        DataFile.width(Width); DataFile << "X_Bcl2_Beclin_I" << ',';
        DataFile.width(Width); DataFile << "X_Beclin" << ',';
        DataFile.width(Width); DataFile << "X_Beclin_I" << ',';
        DataFile.width(Width); DataFile << "X_Caspase_A" << ',';
        DataFile.width(Width); DataFile << "X_Caspase_I" << ',';
        DataFile.width(Width); DataFile << "X_Col2mRNA" << ',';
        DataFile.width(Width); DataFile << "X_ColFrag" << ',';
        DataFile.width(Width); DataFile << "X_Collagen2" << ',';
        DataFile.width(Width); DataFile << "X_DamP" << ',';
        DataFile.width(Width); DataFile << "X_IL1" << ',';
        DataFile.width(Width); DataFile << "X_IkB" << ',';
        DataFile.width(Width); DataFile << "X_IkB_NFkB" << ',';
        DataFile.width(Width); DataFile << "X_Integrin" << ',';
        DataFile.width(Width); DataFile << "X_IntegrinCount" << ',';
        DataFile.width(Width); DataFile << "X_Lys_A" << ',';
        DataFile.width(Width); DataFile << "X_Lys_I" << ',';
        DataFile.width(Width); DataFile << "X_MMP13" << ',';
        DataFile.width(Width); DataFile << "X_MMP2" << ',';
        DataFile.width(Width); DataFile << "X_NFkB" << ',';
        DataFile.width(Width); DataFile << "X_NFkB_P" << ',';
        DataFile.width(Width); DataFile << "X_NatP" << ',';
        DataFile.width(Width); DataFile << "X_RAGE" << ',';
        DataFile.width(Width); DataFile << "X_ROS" << ',';
        DataFile.width(Width); DataFile << "X_Runx2_A" << ',';
        DataFile.width(Width); DataFile << "X_Runx2_I" << ',';
        DataFile.width(Width); DataFile << "X_SOD" << ',';
        DataFile.width(Width); DataFile << "X_Sink" << ',';
        DataFile.width(Width); DataFile << "X_Smad1" << ',';
        DataFile.width(Width); DataFile << "X_Smad1_P" << ',';
        DataFile.width(Width); DataFile << "X_Smad1_P_Smad4" << ',';
        DataFile.width(Width); DataFile << "X_Smad2" << ',';
        DataFile.width(Width); DataFile << "X_Smad2_P" << ',';
        DataFile.width(Width); DataFile << "X_Smad2_P_Smad4" << ',';
        DataFile.width(Width); DataFile << "X_Smad4" << ',';
        DataFile.width(Width); DataFile << "X_Smad7" << ',';
        DataFile.width(Width); DataFile << "X_Source" << ',';
        DataFile.width(Width); DataFile << "X_Sox9" << ',';
        DataFile.width(Width); DataFile << "X_Sox9_A" << ',';
        DataFile.width(Width); DataFile << "X_Sox9mRNA" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_A" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_Alk1_Alk5" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_Alk1_Alk5_Smad7" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_Alk5_dimer" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_Alk5_dimer_Smad7" << ',';
        DataFile.width(Width); DataFile << "X_Tgfb_I" << ',';
        DataFile.width(Width); DataFile << "X_p38" << ',';
        DataFile.width(Width); DataFile << "X_p38_P" << ',';
        DataFile.width(Width); DataFile << "X_proMMP13" << ',';
        DataFile.width(Width); DataFile << "X_proMMP2" << ',';
