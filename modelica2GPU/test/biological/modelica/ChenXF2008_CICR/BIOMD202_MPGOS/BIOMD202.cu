...
#include "BIOMD202_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_IP3_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_O_o" << ',';
        DataFile.width(Width); DataFile << "X_Oc" << ',';
        DataFile.width(Width); DataFile << "X_S2a" << ',';
        DataFile.width(Width); DataFile << "X_S4" << ',';
        DataFile.width(Width); DataFile << "X_h" << ',';
        DataFile.width(Width); DataFile << "sPAR_A" << ',';
        DataFile.width(Width); DataFile << "sPAR_Ca_ec" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_K_PLC" << ',';
        DataFile.width(Width); DataFile << "sPAR_K_PMCA" << ',';
        DataFile.width(Width); DataFile << "sPAR_K_SERCA" << ',';
        DataFile.width(Width); DataFile << "sPAR_K_deg" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_Orai1_t" << ',';
        DataFile.width(Width); DataFile << "sPAR_PM" << ',';
        DataFile.width(Width); DataFile << "sPAR_P_IP3R" << ',';
        DataFile.width(Width); DataFile << "sPAR_St" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_PLC" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_PMCA" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_PMleak" << ',';
        DataFile.width(Width); DataFile << "sPAR_V_SERCA" << ',';
        DataFile.width(Width); DataFile << "sPAR_Vcp" << ',';
        DataFile.width(Width); DataFile << "sPAR_Vs4" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_a" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_i" << ',';
        DataFile.width(Width); DataFile << "sPAR_k_soc" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd_oligo" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdc" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdeg" << ',';
        DataFile.width(Width); DataFile << "sPAR_kdo" << ',';
        DataFile.width(Width); DataFile << "sPAR_kod" << ',';
        DataFile.width(Width); DataFile << "sPAR_kop" << ',';
        DataFile.width(Width); DataFile << "sPAR_l_hill" << ',';
        DataFile.width(Width); DataFile << "sPAR_n_hill" << ',';
        DataFile.width(Width); DataFile << "sPAR_p" << ',';
        DataFile.width(Width); DataFile << "sPAR_q" << ',';
        DataFile.width(Width); DataFile << "sPAR_r_hill" << ',';
        DataFile.width(Width); DataFile << "ACC_$cse1" << ',';
        DataFile.width(Width); DataFile << "ACC_$cse2" << ',';
        DataFile.width(Width); DataFile << "ACC_Orai1" << ',';
