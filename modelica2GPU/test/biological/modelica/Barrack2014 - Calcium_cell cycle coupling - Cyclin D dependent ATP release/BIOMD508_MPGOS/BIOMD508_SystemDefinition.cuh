...
#ifndef BIOMD508_PERTHREAD_SYSTEMDEFINITION_H
#define BIOMD508_PERTHREAD_SYSTEMDEFINITION_H
...
template<class Precision> __forceinline__ __device__ void PerThread_OdeFunction(
    ...
    ACC[2]=(0.5 + (0.5 * tanh((-50.0 + (100.0 * X[1])))));
    ACC[5]=(0.5 + (0.5 * tanh((-1.2 + (100.0 * X[3])))));
    ACC[7]=(X[0] / (25.0 + X[0]));
    ACC[6]=8.823529411764705;
    ACC[3]=(0.001356002920621675 * ACC[6]);
    ACC[4]=((ACC[7] + ACC[3]) / (ACC[6] + (ACC[3] + ACC[7])));
    ...
    F[0]=(3600.0 * ((50.0 * ((X[7] - X[0]) * (ACC[2] * (ACC[5] * ((-0.012 + X[3]) / (10.0 + X[3])))))) + (-2.0 * (X[0] / (50.0 + X[0])))));
    F[7]=(3600.0 * ((0.083 * (500.0 - X[7])) + (-50.0 * (ACC[2] * (ACC[5] * ((X[7] - X[0]) * ((-0.012 + X[3]) / (10.0 + X[3]))))))));
    F[3]=(3600.0 * ((0.6 * ACC[4]) + (-0.0625 * X[3])));
