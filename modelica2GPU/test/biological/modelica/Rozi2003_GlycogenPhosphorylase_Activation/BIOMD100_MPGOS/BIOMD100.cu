...
#include "BIOMD100_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_Ka1" << ',';
        DataFile.width(Width); DataFile << "sPAR_Ka2" << ',';
        DataFile.width(Width); DataFile << "sPAR_Ka5" << ',';
        DataFile.width(Width); DataFile << "sPAR_Ka6" << ',';
        DataFile.width(Width); DataFile << "sPAR_Kd" << ',';
        DataFile.width(Width); DataFile << "sPAR_Kf" << ',';
        DataFile.width(Width); DataFile << "sPAR_Kp2" << ',';
        DataFile.width(Width); DataFile << "sPAR_Ky" << ',';
        DataFile.width(Width); DataFile << "sPAR_Kz" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_Vpm1" << ',';
        DataFile.width(Width); DataFile << "sPAR_Vpm2" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_intravesicular" << ',';
