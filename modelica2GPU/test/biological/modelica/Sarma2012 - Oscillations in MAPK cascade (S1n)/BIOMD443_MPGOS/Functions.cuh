...
#ifndef BIOMD443_FUNCTIONS_H
#define BIOMD443_FUNCTIONS_H
...
__device__ PRECISION function_2(PRECISION V12,PRECISION n12,PRECISION K12,PRECISION M_PP_n){
    PRECISION y = 0.0;
...
__device__ PRECISION function_4(PRECISION M_PP_n,PRECISION M_P_n,PRECISION P3_n,PRECISION k21,PRECISION K21,PRECISION K21i){
    PRECISION y = 0.0;
...
__device__ PRECISION function_5(PRECISION P3_n,PRECISION M_P_n,PRECISION M_PP_n,PRECISION k22,PRECISION K22,PRECISION K22i){
    PRECISION y = 0.0;
