...
model BIOMD218 "Singh2006_TCA_mtu_model2"
...
equation
    ...
    der(icit) = (cell * ((Vf_acn_ACN * (cit / Kcit_acn_ACN) - Vr_acn_ACN * (icit / Kicit_acn_ACN)) / (1 + cit / Kcit_acn_ACN + icit / Kicit_acn_ACN))) - (cell * ((Vf_icd1_ICD1 * (icit / Kicit_icd1_ICD1) - Vr_icd1_ICD1 * (akg / Kakg_icd1_ICD1)) / (1 + icit / Kicit_icd1_ICD1 + akg / Kakg_icd1_ICD1))) - (cell * ((Vf_icd2_ICD2 * (icit / Kicit_icd2_ICD2) - Vr_icd2_ICD2 * (akg / Kakg_icd2_ICD2)) / (1 + icit / Kicit_icd2_ICD2 + akg / Kakg_icd2_ICD2))) - (cell * ((Vf_icl1_ICL1 * (icit / Kicit_icl1_ICL1) - Vr_icl1_ICL1 * (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)) / (1 + icit / Kicit_icl1_ICL1 + suc / Ksuc_icl1_ICL1 + gly / Kgly_icl1_ICL1 + (icit / Kicit_icl1_ICL1) * (suc / Ksuc_icl1_ICL1) + (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)))) - (cell * ((Vf_icl2_ICL2 * (icit / Kicit_icl2_ICL2) - Vr_icl2_ICL2 * (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2)) / (1 + icit / Kicit_icl2_ICL2 + suc / Ksuc_icl2_ICL2 + gly / Kgly_icl2_ICL2 + (icit / Kicit_icl2_ICL2) * (suc / Ksuc_icl2_ICL2) + (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2))));
    der(akg) = (cell * ((Vf_icd1_ICD1 * (icit / Kicit_icd1_ICD1) - Vr_icd1_ICD1 * (akg / Kakg_icd1_ICD1)) / (1 + icit / Kicit_icd1_ICD1 + akg / Kakg_icd1_ICD1))) + (cell * ((Vf_icd2_ICD2 * (icit / Kicit_icd2_ICD2) - Vr_icd2_ICD2 * (akg / Kakg_icd2_ICD2)) / (1 + icit / Kicit_icd2_ICD2 + akg / Kakg_icd2_ICD2))) - (cell * ((Vf_kgd_KGD * (akg / Kakg_kgd_KGD) - Vr_kgd_KGD * (ssa / Kssa_kgd_KGD)) / (1 + akg / Kakg_kgd_KGD + ssa / Kssa_kgd_KGD))) - (cell * 0.0341 * ((Vf_icd1_SYN * (icit / Kicit_icd1_SYN) - Vr_icd1_SYN * (akg / Kakg_icd1_SYN)) / (1 + icit / Kicit_icd1_SYN + akg / Kakg_icd1_SYN) + (Vf_icd2_SYN * (icit / Kicit_icd2_SYN) - Vr_icd2_SYN * (akg / Kakg_icd2_SYN)) / (1 + icit / Kicit_icd2_SYN + akg / Kakg_icd2_SYN)));
    der(ssa) = (cell * ((Vf_kgd_KGD * (akg / Kakg_kgd_KGD) - Vr_kgd_KGD * (ssa / Kssa_kgd_KGD)) / (1 + akg / Kakg_kgd_KGD + ssa / Kssa_kgd_KGD))) - (cell * ((Vf_ssadh_SSADH * (ssa / Kssa_ssadh_SSADH) - Vr_ssadh_SSADH * (suc / Ksuc_ssadh_SSADH)) / (1 + ssa / Kssa_ssadh_SSADH + suc / Ksuc_ssadh_SSADH)));
    der(suc) = (cell * ((Vf_ssadh_SSADH * (ssa / Kssa_ssadh_SSADH) - Vr_ssadh_SSADH * (suc / Ksuc_ssadh_SSADH)) / (1 + ssa / Kssa_ssadh_SSADH + suc / Ksuc_ssadh_SSADH))) + (cell * ((Vf_scas_ScAS * (sca / Ksca_scas_ScAS) - Vr_scas_ScAS * (suc / Ksuc_scas_ScAS)) / (1 + sca / Ksca_scas_ScAS + suc / Ksuc_scas_ScAS))) + (cell * ((Vf_icl1_ICL1 * (icit / Kicit_icl1_ICL1) - Vr_icl1_ICL1 * (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)) / (1 + icit / Kicit_icl1_ICL1 + suc / Ksuc_icl1_ICL1 + gly / Kgly_icl1_ICL1 + (icit / Kicit_icl1_ICL1) * (suc / Ksuc_icl1_ICL1) + (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)))) + (cell * ((Vf_icl2_ICL2 * (icit / Kicit_icl2_ICL2) - Vr_icl2_ICL2 * (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2)) / (1 + icit / Kicit_icl2_ICL2 + suc / Ksuc_icl2_ICL2 + gly / Kgly_icl2_ICL2 + (icit / Kicit_icl2_ICL2) * (suc / Ksuc_icl2_ICL2) + (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2)))) - (cell * ((Vf_sdh_SDH * (suc / Ksuc_sdh_SDH) - Vr_sdh_SDH * (fa / Kfa_sdh_SDH)) / (1 + suc / Ksuc_sdh_SDH + fa / Kfa_sdh_SDH)));
    der(sca) =  - (cell * ((Vf_scas_ScAS * (sca / Ksca_scas_ScAS) - Vr_scas_ScAS * (suc / Ksuc_scas_ScAS)) / (1 + sca / Ksca_scas_ScAS + suc / Ksuc_scas_ScAS)));
    ...
    der(gly) = (cell * ((Vf_icl1_ICL1 * (icit / Kicit_icl1_ICL1) - Vr_icl1_ICL1 * (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)) / (1 + icit / Kicit_icl1_ICL1 + suc / Ksuc_icl1_ICL1 + gly / Kgly_icl1_ICL1 + (icit / Kicit_icl1_ICL1) * (suc / Ksuc_icl1_ICL1) + (suc / Ksuc_icl1_ICL1) * (gly / Kgly_icl1_ICL1)))) + (cell * ((Vf_icl2_ICL2 * (icit / Kicit_icl2_ICL2) - Vr_icl2_ICL2 * (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2)) / (1 + icit / Kicit_icl2_ICL2 + suc / Ksuc_icl2_ICL2 + gly / Kgly_icl2_ICL2 + (icit / Kicit_icl2_ICL2) * (suc / Ksuc_icl2_ICL2) + (suc / Ksuc_icl2_ICL2) * (gly / Kgly_icl2_ICL2)))) - (cell * ((Vf_ms_MS * (gly / Kgly_ms_MS) * (aca / Kaca_ms_MS) - Vr_ms_MS * (mal / Kmal_ms_MS) * (coa / Kcoa_ms_MS)) / ((1 + gly / Kgly_ms_MS + mal / Kmal_ms_MS) * (1 + aca / Kaca_ms_MS + coa / Kcoa_ms_MS))));
    der(biosyn) = 0.0;
