...
#include "BIOMD123_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_Act_C_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_Act_C_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_Ca_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_Ca_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_Inact_C_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_Inact_C_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Act_C_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Act_C_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Pi_Act_C_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Pi_Act_C_Nuc" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Pi_Cyt" << ',';
        DataFile.width(Width); DataFile << "X_NFAT_Pi_Nuc" << ',';
