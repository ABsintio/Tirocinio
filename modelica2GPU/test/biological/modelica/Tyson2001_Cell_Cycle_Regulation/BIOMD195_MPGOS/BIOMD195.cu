...
#include "BIOMD195_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_CKIt" << ',';
        DataFile.width(Width); DataFile << "X_Cdc20a" << ',';
        DataFile.width(Width); DataFile << "X_Cdc20t" << ',';
        DataFile.width(Width); DataFile << "X_Cdh1" << ',';
        DataFile.width(Width); DataFile << "X_CycBt" << ',';
        DataFile.width(Width); DataFile << "X_IEP" << ',';
        DataFile.width(Width); DataFile << "X_SK" << ',';
        DataFile.width(Width); DataFile << "X_m" << ',';
        DataFile.width(Width); DataFile << "sPAR_J15" << ',';
        DataFile.width(Width); DataFile << "sPAR_J16" << ',';
        DataFile.width(Width); DataFile << "sPAR_J3" << ',';
        DataFile.width(Width); DataFile << "sPAR_J4" << ',';
        DataFile.width(Width); DataFile << "sPAR_J5" << ',';
        DataFile.width(Width); DataFile << "sPAR_J7" << ',';
        DataFile.width(Width); DataFile << "sPAR_J8" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k12p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k12pp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k12ppp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k13" << ',';
        DataFile.width(Width); DataFile << "sPAR_k14" << ',';
        DataFile.width(Width); DataFile << "sPAR_k15p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k15pp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k16p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k16pp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k2p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k2pp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k2ppp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k3p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k3pp" << ',';
        DataFile.width(Width); DataFile << "sPAR_k4" << ',';
        DataFile.width(Width); DataFile << "sPAR_k4p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k5p" << ',';
        DataFile.width(Width); DataFile << "sPAR_k5pp" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_mmax" << ',';
        DataFile.width(Width); DataFile << "sPAR_mu" << ',';
        DataFile.width(Width); DataFile << "sPAR_n" << ',';
        DataFile.width(Width); DataFile << "ACC_CycB" << ',';
        DataFile.width(Width); DataFile << "ACC_Mad" << ',';
        DataFile.width(Width); DataFile << "ACC_TF" << ',';
        DataFile.width(Width); DataFile << "ACC_Trimer" << ',';
