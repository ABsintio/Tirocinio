...
#include "BIOMD106_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_KI19" << ',';
        DataFile.width(Width); DataFile << "sPAR_KI20" << ',';
        DataFile.width(Width); DataFile << "sPAR_KI21" << ',';
        DataFile.width(Width); DataFile << "sPAR_KI22" << ',';
        DataFile.width(Width); DataFile << "sPAR_KI23" << ',';
        DataFile.width(Width); DataFile << "sPAR_KI24" << ',';
        DataFile.width(Width); DataFile << "sPAR_a24" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_kd12" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd13" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd16" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd2" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd3" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd8" << ',';
        DataFile.width(Width); DataFile << "sPAR_kd9" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki1" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki10" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki11" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki12" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki14" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki15" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki16" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki17" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki18" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki2" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki3" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki4" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki5" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki6" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki7" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki8" << ',';
        DataFile.width(Width); DataFile << "sPAR_ki9" << ',';
        DataFile.width(Width); DataFile << "sPAR_ks" << ',';
        DataFile.width(Width); DataFile << "sPAR_lin" << ',';
