...
#include "BIOMD509_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_rs" << ',';
        DataFile.width(Width); DataFile << "X_x" << ',';
        DataFile.width(Width); DataFile << "X_y" << ',';
        DataFile.width(Width); DataFile << "ACC_ad" << ',';
        DataFile.width(Width); DataFile << "ACC_ca" << ',';
        DataFile.width(Width); DataFile << "ACC_delta" << ',';
        DataFile.width(Width); DataFile << "ACC_gstar" << ',';
        DataFile.width(Width); DataFile << "ACC_ip3con" << ',';
        DataFile.width(Width); DataFile << "ACC_kg" << ',';
        DataFile.width(Width); DataFile << "ACC_ro" << ',';
        DataFile.width(Width); DataFile << "ACC_rscon" << ',';
