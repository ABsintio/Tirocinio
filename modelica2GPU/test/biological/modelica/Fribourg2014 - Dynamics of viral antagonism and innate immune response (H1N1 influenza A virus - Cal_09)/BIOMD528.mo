...
model BIOMD528 "Fribourg2014 - Dynamics of viral antagonism and innate immune response (H1N1 influenza A virus - Cal_09)"
    ...
    parameter Real n3 = 5.0;
    parameter Real bm = 6.0;
    parameter Real sp = 0.3;
    ...
    parameter Real r0 = 0.001;
    parameter Real k15 = 3.6e-08;
