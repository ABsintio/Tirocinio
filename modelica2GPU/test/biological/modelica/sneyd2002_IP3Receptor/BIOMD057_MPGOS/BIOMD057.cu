...
#include "BIOMD057_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "sPAR_kminus2" << ',';
        DataFile.width(Width); DataFile << "sPAR_kminus3" << ',';
        DataFile.width(Width); DataFile << "sPAR_kminus4" << ',';
        DataFile.width(Width); DataFile << "sPAR_l2" << ',';
        DataFile.width(Width); DataFile << "sPAR_l4" << ',';
        DataFile.width(Width); DataFile << "sPAR_l6" << ',';
        DataFile.width(Width); DataFile << "sPAR_lminus2" << ',';
        DataFile.width(Width); DataFile << "sPAR_lminus4" << ',';
        DataFile.width(Width); DataFile << "sPAR_lminus6" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi1" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi2" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi3" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi4" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi5" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi_minus2" << ',';
        DataFile.width(Width); DataFile << "ACC_Phi_minus4" << ',';
        DataFile.width(Width); DataFile << "ACC_open_probability" << ',';
