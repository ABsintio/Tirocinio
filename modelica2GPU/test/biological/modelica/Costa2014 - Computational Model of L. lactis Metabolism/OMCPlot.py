...
variables_to_plot = ["G6P","ATP","ADP","Pint","F6P","FBP","G3P","BPG","PEP","NAD","NADH","PYR","AcetCoA","Acetoin","Mannitol","Mannitol1Phosphate","CoA","Pext","Lactate","Ethanol","Acetate","Butanediol","Glucose","Acetoin_Ext","Mannitol_Ext","Formate"]
