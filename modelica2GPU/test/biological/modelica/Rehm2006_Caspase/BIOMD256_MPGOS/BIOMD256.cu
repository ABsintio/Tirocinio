...
#include "BIOMD256_SystemDefinition.cuh"
...
void SaveData(
    ...
    {
        DataFile.width(Width); DataFile << "X_APAF1" << ',';
        DataFile.width(Width); DataFile << "X_APAF1_tot" << ',';
        DataFile.width(Width); DataFile << "X_BIR12" << ',';
        DataFile.width(Width); DataFile << "X_BIR12_C3" << ',';
        DataFile.width(Width); DataFile << "X_BIR12_SMAC" << ',';
        DataFile.width(Width); DataFile << "X_BIR3R" << ',';
        DataFile.width(Width); DataFile << "X_BIR3R_C9" << ',';
        DataFile.width(Width); DataFile << "X_BIR3R_SMAC" << ',';
        DataFile.width(Width); DataFile << "X_BIR3R_p2frag" << ',';
        DataFile.width(Width); DataFile << "X_C3" << ',';
        DataFile.width(Width); DataFile << "X_C3_tot" << ',';
        DataFile.width(Width); DataFile << "X_C9" << ',';
        DataFile.width(Width); DataFile << "X_C9P" << ',';
        DataFile.width(Width); DataFile << "X_C9_tot" << ',';
        DataFile.width(Width); DataFile << "X_ClvgPrds" << ',';
        DataFile.width(Width); DataFile << "X_CytC_cell" << ',';
        DataFile.width(Width); DataFile << "X_CytC_mit" << ',';
        DataFile.width(Width); DataFile << "X_CytC_tot" << ',';
        DataFile.width(Width); DataFile << "X_PC3" << ',';
        DataFile.width(Width); DataFile << "X_PC9" << ',';
        DataFile.width(Width); DataFile << "X_SMAC" << ',';
        DataFile.width(Width); DataFile << "X_SMAC_mito" << ',';
        DataFile.width(Width); DataFile << "X_SMAC_tot" << ',';
        DataFile.width(Width); DataFile << "X_Substrate" << ',';
        DataFile.width(Width); DataFile << "X_XIAP" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_2SMAC" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_C3" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_C9" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_C9_C3" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_ini" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_p2frag" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_p2frag_2SMAC" << ',';
        DataFile.width(Width); DataFile << "X_XIAP_p2frag_C3" << ',';
        DataFile.width(Width); DataFile << "X_k1" << ',';
        DataFile.width(Width); DataFile << "X_k1r" << ',';
        DataFile.width(Width); DataFile << "X_k2" << ',';
        DataFile.width(Width); DataFile << "X_k2r" << ',';
        DataFile.width(Width); DataFile << "X_k38" << ',';
        DataFile.width(Width); DataFile << "X_k39" << ',';
        DataFile.width(Width); DataFile << "X_k40" << ',';
        DataFile.width(Width); DataFile << "X_k43" << ',';
        DataFile.width(Width); DataFile << "X_k44" << ',';
        DataFile.width(Width); DataFile << "X_k46" << ',';
        DataFile.width(Width); DataFile << "X_k48" << ',';
        DataFile.width(Width); DataFile << "X_k50" << ',';
        DataFile.width(Width); DataFile << "X_k51" << ',';
        DataFile.width(Width); DataFile << "sPAR_S_breakdown" << ',';
        DataFile.width(Width); DataFile << "sPAR_cell" << ',';
        DataFile.width(Width); DataFile << "sPAR_k10" << ',';
        DataFile.width(Width); DataFile << "sPAR_k10r" << ',';
        ...
        DataFile.width(Width); DataFile << "sPAR_k9r" << ',';
        DataFile.width(Width); DataFile << "sPAR_mito" << ',';
        DataFile.width(Width); DataFile << "sPAR_th_Apop" << ',';
        DataFile.width(Width); DataFile << "sPAR_th_CytC" << ',';
        DataFile.width(Width); DataFile << "sPAR_th_SMAC" << ',';
        DataFile.width(Width); DataFile << "ACC_Apoform" << ',';
        DataFile.width(Width); DataFile << "ACC_BIR12_C3_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_BIR12_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_BIR3R_C9_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_BIR3R_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_BIR3R_p2frag_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_C3norm" << ',';
        DataFile.width(Width); DataFile << "ACC_C9Pnorm" << ',';
        DataFile.width(Width); DataFile << "ACC_C9norm" << ',';
        DataFile.width(Width); DataFile << "ACC_PC3norm" << ',';
        DataFile.width(Width); DataFile << "ACC_SMAC_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_SMAC_rel" << ',';
        DataFile.width(Width); DataFile << "ACC_XIAP_2SMAC_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_XIAP_C3_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_XIAP_C9_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_XIAP_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_XIAP_p2frag_norm" << ',';
        DataFile.width(Width); DataFile << "ACC_apo_lim" << ',';
