...
#include "BIOMD052_SystemDefinition.cuh"
...
void SaveData(
    ...
    for (int tid=0; tid<NumberOfThreads; tid++)
    {
        ...
        DataFile.width(Width); DataFile << "X_Acetic_acid" << ',';
        DataFile.width(Width); DataFile << "X_Amadori" << ',';
        DataFile.width(Width); DataFile << "X_C5" << ',';
        DataFile.width(Width); DataFile << "X_Cn" << ',';
        DataFile.width(Width); DataFile << "X_Formic_acid" << ',';
        DataFile.width(Width); DataFile << "X_Fru" << ',';
        DataFile.width(Width); DataFile << "X_Glu" << ',';
        DataFile.width(Width); DataFile << "X_Melanoidin" << ',';
        DataFile.width(Width); DataFile << "X_Triose" << ',';
        DataFile.width(Width); DataFile << "X_lys_R" << ',';
