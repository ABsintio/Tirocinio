...
model BIOMD362 "Butenas2004_BloodCoagulation"
    ...
    parameter Real k43 = 5700.0;
    parameter Real k44 = 3000000.0;
    parameter Real compartment_1 = 1.0;

    Real IIa_plus_1_2mIIa(start=1e-09);
...
equation
    ...
    der(Xa) = (compartment_1 * k6 * Xa * VII) + (compartment_1 * k16 * Xa * II) + (compartment_1 * k22 * IXa_VIIIa_X) + (compartment_1 * k43 * IXa * X) - (compartment_1 * k6 * Xa * VII) - (compartment_1 * (k12 * TF_VIIa * Xa - k11 * TF_VIIa_Xa)) - (compartment_1 * k16 * Xa * II) - (compartment_1 * (k28 * Xa * Va - k27 * Xa_Va)) - (compartment_1 * (k34 * Xa * TFPI - k33 * Xa_TFPI)) - (compartment_1 * k38 * Xa * ATIII);
    ...
    der(X) = (compartment_1 * k25 * IXa_VIIIa_X) - (compartment_1 * (k9 * TF_VIIa * X - k8 * TF_VIIa_X)) - (compartment_1 * (k21 * IXa_VIIIa * X - k20 * IXa_VIIIa_X)) - (compartment_1 * k43 * IXa * X);
    ...
    der(IXa) = (compartment_1 * k25 * IXa_VIIIa_X) + (compartment_1 * k25 * IXa_VIIIa) + (compartment_1 * k15 * TF_VIIa_IX) + (compartment_1 * k43 * IXa * X) - (compartment_1 * (k19 * IXa * VIIIa - k18 * IXa_VIIIa)) - (compartment_1 * k40 * IXa * ATIII) - (compartment_1 * k43 * IXa * X);
    ...
    der(V) =  - (compartment_1 * k26 * IIa * V) - (compartment_1 * k44 * mIIa * V);
    der(Va) = (compartment_1 * k26 * IIa * V) + (compartment_1 * k44 * mIIa * V) - (compartment_1 * (k28 * Xa * Va - k27 * Xa_Va));
    ...
    der(mIIa) = (compartment_1 * k31 * Xa_Va_II) + (compartment_1 * k44 * mIIa * V) - (compartment_1 * k32 * mIIa * Xa_Va) - (compartment_1 * k39 * mIIa * ATIII) - (compartment_1 * k44 * mIIa * V);
