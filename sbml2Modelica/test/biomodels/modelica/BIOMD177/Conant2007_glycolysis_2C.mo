within BIOMD177;
model Conant2007_glycolysis_2C "Conant2007_glycolysis_2C" annotation(Documentation(info="<annotation>
  <jd:header>
  ...
  <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:vCard=\"http://www.w3.org/2001/vcard-rdf/3.0#\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
    ...
    equation
        ...
        Reacs.elmt_t_m = Params.elmt_t_m;
        Reacs.elmt_PYRmito = elmt_mito.elmt_PYRmito;
        ...
        elmt_cyto.elmt_PYR_shut = Reacs.elmt_PYR_shut;
        ...
        elmt_mito.elmt_PDH = Reacs.elmt_PDH;
        elmt_mito.elmt_PYR_shut = Reacs.elmt_PYR_shut;

end Conant2007_glycolysis_2C;
