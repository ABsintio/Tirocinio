within BIOMD122;
model Fisher2006_Ca_Oscillation_dpdnt_NFAT_dynamics "Fisher2006_Ca_Oscillation_dpdnt_NFAT_dynamics" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_cytosol.elmt_event_0000001 = elmt_event_0000001.trigger;
        elmt_cytosol.elmt_event_0000002 = elmt_event_0000002.trigger;
        elmt_cytosol.elmt_event_0000003 = elmt_event_0000003.trigger;
        ...
        elmt_nucleus.elmt_event_0000001 = elmt_event_0000001.trigger;
        elmt_nucleus.elmt_event_0000002 = elmt_event_0000002.trigger;
        elmt_nucleus.elmt_event_0000003 = elmt_event_0000003.trigger;
        elmt_event_0000001.elmt_Time_in_Seconds = Params.elmt_Time_in_Seconds;
        elmt_event_0000002.elmt_Time_in_Seconds = Params.elmt_Time_in_Seconds;

        Params.assign_elmt_Time_in_Seconds = elmt_event_0000001.value_elmt_Time_in_Seconds;
        elmt_nucleus.assign_elmt_Ca_Nuc = prioritize_between_3({Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY}, {elmt_event_0000001.value_elmt_Ca_Nuc, elmt_event_0000002.value_elmt_Ca_Nuc, elmt_event_0000003.value_elmt_Ca_Nuc}, {edge(elmt_event_0000001.trigger), edge(elmt_event_0000002.trigger), edge(elmt_event_0000003.trigger)});
        elmt_cytosol.assign_elmt_Ca_Cyt = prioritize_between_3({Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY}, {elmt_event_0000001.value_elmt_Ca_Cyt, elmt_event_0000002.value_elmt_Ca_Cyt, elmt_event_0000003.value_elmt_Ca_Cyt}, {edge(elmt_event_0000001.trigger), edge(elmt_event_0000002.trigger), edge(elmt_event_0000003.trigger)});
end Fisher2006_Ca_Oscillation_dpdnt_NFAT_dynamics;
