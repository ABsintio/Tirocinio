...
class Parameters
    ...
    Real elmt_mw583e0056_50f9_47a5_b3c3_0571754b92fb(unit = "") "infusionTime";
          ...
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
              <rdf:Description rdf:about=\"#COPASI3\">
                <dcterms:created>
                  <rdf:Description>
                    <dcterms:W3CDTF>2014-07-30T15:56:59Z</dcterms:W3CDTF>
                  </rdf:Description>
                </dcterms:created>
              </rdf:Description>
            </rdf:RDF>
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_Metabolite_3(unit = "") "Initial for CRP";
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        elmt_kRLOn = 0.384;
        elmt_mw583e0056_50f9_47a5_b3c3_0571754b92fb = 1.0;
        ...
        elmt_Metabolite_3 = elmt_mw114aa90f_5f5b_4fe8_9406_361c8489b6a1;
    ...
    equation
        der(elmt_kRLOn) = 0;
        der(elmt_mw583e0056_50f9_47a5_b3c3_0571754b92fb) = 0;
