...
class Class_elmt_cellsurface
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_SAv_EpoR_conc(unit = "");
    Real elmt_SAv_EpoR_amount(unit = "");
    Real elmt_SAv_EpoR(unit = "") "SAv_EpoR";
 annotation(Documentation(info="<annotation>
          <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_SAv_EpoR = elmt_SAv_EpoR_conc;
        elmt_EpoR = elmt_EpoR_conc;
        der(elmt_SAv_EpoR_amount) = ((- (elmt_reaction_5 * elmt_reactant8)) + (elmt_reaction_3 * elmt_product4) + (- (elmt_reaction_4 * elmt_reactant5)));
        der(elmt_EpoR_amount) = ((- (elmt_reaction_3 * elmt_reactant3)) + (elmt_reaction_4 * elmt_product7) + (elmt_reaction_1 * elmt_product0) + (- (elmt_reaction_2 * elmt_reactant1)));

    algorithm
        elmt_SAv_EpoR_conc := elmt_SAv_EpoR_amount / elmt_cellsurface;
