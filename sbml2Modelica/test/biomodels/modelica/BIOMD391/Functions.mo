...
class Functions
    ...
    function elmt_function_4
        ...
        output Real result;
        algorithm
            result := ((arg_Vm * arg_S1 * arg_S2) / ((arg_S1 + (arg_K1 * (1.0 + (arg_R1 / arg_KR1) + (arg_R2 / arg_KR2) + (arg_R3 / arg_KR3)))) * ((arg_S2 * (1.0 + (arg_R4 / arg_KR41))) + (arg_K2 * (1.0 + (arg_R4 / arg_KR42))))));
    end elmt_function_4;
    ...
    function elmt_function_2
        ...
        output Real result;
        algorithm
            result := ((arg_Vm * arg_S) / (arg_S + (arg_K * (1.0 + (arg_R1 / arg_KR1) + (arg_R2 / arg_KR2)))));
    end elmt_function_2;
    ...
    function elmt_function_3
        ...
        output Real result;
        algorithm
            result := ((arg_Vm * arg_S) / (arg_S + (arg_K * (1.0 + (arg_R1 / arg_KR1)))));
    end elmt_function_3;
