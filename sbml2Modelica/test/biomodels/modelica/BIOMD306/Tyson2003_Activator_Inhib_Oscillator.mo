within BIOMD306;
model Tyson2003_Activator_Inhib_Oscillator "Tyson2003_Activator_Inhibitor" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_env.elmt_r2_prime = Reacs.elmt_r2_prime;
        elmt_env.elmt_reactant9 = Reacs.elmt_reactant9;
        elmt_env.elmt_r0 = Reacs.elmt_r0;

end Tyson2003_Activator_Inhib_Oscillator;
