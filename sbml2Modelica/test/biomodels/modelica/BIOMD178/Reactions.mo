...
class Reactions
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_bulk_movement_elmt_kS(unit "s-1.0") = 1.5E-4 "";
    Real elmt_product7 "";
    Real elmt_reactant6 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        elmt_bulk_movement = (elmt_bulk_movement_elmt_kS * elmt_bulk * elmt_extracellular);
