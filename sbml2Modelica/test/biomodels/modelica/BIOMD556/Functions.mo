...
class Functions
    ...
    function elmt_V1_3_4_5
        ...
        output Real result;
        algorithm
            result := (((arg_Vm * arg_S) / arg_Km1) / (1.0 + (arg_S / arg_Km1) + (arg_M / arg_Km2)));
    end elmt_V1_3_4_5;
    ...
    function elmt_VD
        ...
        output Real result;
        algorithm
            result := ((((arg_Vm / (1.0 + (arg_X / arg_Kx))) * arg_S) / arg_Km) / arg_Den);
    end elmt_VD;
    ...
    function elmt_V2
        ...
        output Real result;
        algorithm
            result := (((arg_Vm * arg_S) / arg_Km) / (1.0 + (arg_S / arg_Km)));
    end elmt_V2;
