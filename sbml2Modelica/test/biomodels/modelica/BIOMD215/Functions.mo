...
class Functions
    ...
    function elmt_function_1
        input Real arg_Ag;
        input Real arg_K1;
        input Real arg_Ifn_Prot;
        input Real arg_K2;
        input Real arg_a2;

        output Real result;
        algorithm
            result := (arg_a2 * (arg_Ag / (arg_K1 + arg_Ag)) * (arg_Ifn_Prot / (arg_K2 + arg_Ifn_Prot)));
    end elmt_function_1;
    ...
    function elmt_function_4
        ...
        output Real result;
        algorithm
            result := (arg_b * arg_mRNA);
    end elmt_function_4;

    function elmt_function_5
        input Real arg_a4;
        input Real arg_Tbet_Prot;
        input Real arg_K4;
        input Real arg_Ag;

        output Real result;
        algorithm
            result := (arg_a4 * arg_Tbet_Prot * (arg_K4 / (arg_K4 + arg_Ag)));
    end elmt_function_5;

    function elmt_function_2
        input Real arg_a3;
        input Real arg_Rec_Prot;

        output Real result;
        algorithm
            result := (arg_a3 * arg_Rec_Prot);
    end elmt_function_2;
    ...
    function elmt_function_6
        ...
        output Real result;
        algorithm
            result := (arg_a5 * (arg_Tbet_Prot / (arg_K5 + arg_Tbet_Prot)) * (arg_Rec_Prot / (arg_K6 + arg_Rec_Prot)) * (arg_Ag / (arg_K7 + arg_Ag)));
    end elmt_function_6;
