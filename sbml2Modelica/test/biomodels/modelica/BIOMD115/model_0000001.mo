within BIOMD115;
model model_0000001 "Somogyi1990_CaOscillations_SingleCaSpike" annotation(Documentation(info="<annotation>
    ...
    equation
        Params.elmt_y = elmt_Cytosol.elmt_y;
        ...
        Reacs.elmt_y = elmt_Cytosol.elmt_y;
        ...
        elmt_ER.elmt_reaction_0000003 = Reacs.elmt_reaction_0000003;
