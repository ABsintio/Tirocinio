...
class Class_elmt_compartment
 ...
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        ...
        elmt_N1_conc = (43.8146704098797 / elmt_compartment);
        elmt_N2_conc = (27.4558812768926 / elmt_compartment);
    ...
    equation
        ...
        der(elmt_N0_amount) = ((- (elmt_R01 * elmt_reactant1)) + (elmt_R01 * elmt_product2) + (- (elmt_R00 * elmt_reactant4)) + (elmt_R00 * elmt_product5) + (- (elmt_R0X * elmt_reactant0)));
