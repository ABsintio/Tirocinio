...
class Class_elmt_compartment
    ...
    input Real elmt_React19;
    input Real elmt_React17;
    input Real elmt_React18;
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_P4_prime_amount(unit = "");
    Real elmt_P4_prime_conc(unit = "");
    Real elmt_P4_prime(unit = "") "";
 annotation(Documentation(info="<annotation>
      <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
    ...
    equation
        ...
        elmt_P4_prime = elmt_P4_prime_amount;
        der(elmt_P2_prime_amount) = ((elmt_React18 * elmt_product17) + (- (elmt_React15 * elmt_reactant14)) + (elmt_React13 * elmt_product12) + (elmt_React14 * elmt_product13));
        ...
        der(elmt_P4_prime_amount) = ((- (elmt_React20 * elmt_reactant19)) + (elmt_React19 * elmt_product18));
    ...
    algorithm
        ...
        elmt_P4_prime_conc := elmt_P4_prime_amount / elmt_compartment;
