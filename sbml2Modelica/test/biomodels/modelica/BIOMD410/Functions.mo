...
class Functions
    ...
    function elmt_function_5
        ...
        output Real result;
        algorithm
            result := (arg_k + (arg_k1 * arg_m));
    end elmt_function_5;

    function elmt_function_2
        input Real arg_TGFbeta;
        input Real arg_k;
        input Real arg_s;
        input Real arg_s2;
        ...
        output Real result;
        algorithm
            result := (arg_k * arg_s * arg_s2 * arg_TGFbeta);
    end elmt_function_2;
    ...
    function elmt_function_3
        ...
        output Real result;
        algorithm
            result := ((arg_k * arg_rec * arg_s) / (arg_km + arg_s));
    end elmt_function_3;
    ...
    function elmt_function_6
        ...
        output Real result;
        algorithm
            result := ((arg_k + (arg_k1 * arg_m)) / (1.0 + arg_m2 + arg_m3));
    end elmt_function_6;

    function elmt_function_7
        input Real arg_k1;
        input Real arg_substrate;
        input Real arg_modifier;

        output Real result;
        algorithm
            result := (arg_k1 * arg_substrate * (1.0 + arg_modifier));
    end elmt_function_7;
