within BIOMD264;
model Model_1 "Fujita2010_Akt_Signalling_EGFRinhib" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_EGF_binding_kf = Params.elmt_EGF_binding_kf;
        Reacs.elmt_inhibitor_binding_kb = Params.elmt_inhibitor_binding_kb;
        Reacs.elmt_inhibitor_binding_kf = Params.elmt_inhibitor_binding_kf;
        Reacs.elmt_EGF_EGFR_i = elmt_Cell.elmt_EGF_EGFR_i;
        Reacs.elmt_pEGFR = elmt_Cell.elmt_pEGFR;
        Reacs.elmt_Akt = elmt_Cell.elmt_Akt;
        elmt_Cell.elmt_product30 = Reacs.elmt_product30;
        elmt_Cell.elmt_EGF_conc_pulse = Params.elmt_EGF_conc_pulse;
        elmt_Cell.elmt_product33 = Reacs.elmt_product33;
        elmt_Cell.elmt_inhibitor_binding_kb = Params.elmt_inhibitor_binding_kb;
        elmt_Cell.elmt_product27 = Reacs.elmt_product27;
        elmt_Cell.elmt_reactant9 = Reacs.elmt_reactant9;
        elmt_Cell.elmt_inhibitor_binding_kf = Params.elmt_inhibitor_binding_kf;
        ...
        elmt_Cell.elmt_EGFR_turnover = Params.elmt_EGFR_turnover;
