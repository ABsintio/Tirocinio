...
class Functions
    ...
    function elmt_HenriMichaelisMenten_irreversible_kcat
        input Real arg_kcat;
        ...
        output Real result;
        algorithm
            result := ((arg_kcat * arg_enzyme * arg_substrate) / (arg_Km + arg_substrate));
    end elmt_HenriMichaelisMenten_irreversible_kcat;
