...
class Reactions
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_R2 = (elmt_u * elmt_k2f * elmt_Mad1_CMad2_OMad2 * elmt_Cdc20 * elmt_Cytoplasm);
        elmt_R7b = (elmt_u_prime * elmt_k7bf * elmt_MCC_APC * elmt_Cytoplasm);
