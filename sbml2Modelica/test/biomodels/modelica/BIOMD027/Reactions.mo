...
class Reactions
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_v1 = (elmt_uVol * (((elmt_k1cat * elmt_MAPKK * elmt_M) / elmt_Km1) / (1.0 + (elmt_M / elmt_Km1) + (elmt_Mp / elmt_Km2))));
        elmt_v2 = (elmt_uVol * (((elmt_k2cat * elmt_MAPKK * elmt_Mp) / elmt_Km2) / (1.0 + (elmt_M / elmt_Km1) + (elmt_Mp / elmt_Km2))));
