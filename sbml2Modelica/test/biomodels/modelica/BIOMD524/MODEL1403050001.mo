within BIOMD524;
model MODEL1403050001 "Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans variant)" annotation(Documentation(info="<annotation>
