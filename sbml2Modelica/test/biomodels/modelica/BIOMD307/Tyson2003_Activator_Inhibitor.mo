within BIOMD307;
model Tyson2003_Activator_Inhibitor "Tyson2003_Substrate_Depletion_Osc" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_k0_prime = Params.elmt_k0_prime;
...
end Tyson2003_Activator_Inhibitor;
