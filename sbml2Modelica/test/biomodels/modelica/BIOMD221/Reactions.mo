...
class Reactions
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_SYN_elmt_Vf_icd(unit "m-3.0..s-1.0") = 6.625 "";
    parameter Real elmt_SYN_elmt_Kicit_icd(unit "m-3.0.") = 0.008 "";
    parameter Real elmt_SYN_elmt_Vr_icd(unit "m-3.0..s-1.0") = 0.06625 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_SDH_elmt_Vr_sdh(unit "m-3.0..s-1.0") = 16.24 "";
    parameter Real elmt_SDH_elmt_Kfa_sdh(unit "m-3.0.") = 0.4 "";
    parameter Real elmt_SDH_elmt_Ksuc_sdh(unit "m-3.0.") = 0.02 "";
    parameter Real elmt_SDH_elmt_Vf_sdh(unit "m-3.0..s-1.0") = 17.7 "";
    Real elmt_product13 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_MS_elmt_Vr_ms(unit "m-3.0..s-1.0") = 0.285 "";
    ...
    parameter Real elmt_MS_elmt_Vf_ms(unit "m-3.0..s-1.0") = 28.5 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_MDH_elmt_Vr_mdh(unit "m-3.0..s-1.0") = 1276.06 "";
    parameter Real elmt_MDH_elmt_Vf_mdh(unit "m-3.0..s-1.0") = 1390.9 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_CS_elmt_Vr_cs(unit "m-3.0..s-1.0") = 4.4688 "";
    parameter Real elmt_CS_elmt_Vf_cs(unit "m-3.0..s-1.0") = 446.88 "";
    Real elmt_reactant1 "";
    Real elmt_reactant0 "";
    Real elmt_product3 "";
    Real elmt_product2 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_ICL_elmt_Vr_icl(unit "m-3.0..s-1.0") = 0.285 "";
    parameter Real elmt_ICL_elmt_Kgly_icl(unit "m-3.0.") = 0.13 "";
    parameter Real elmt_ICL_elmt_Vf_icl(unit "m-3.0..s-1.0") = 28.5 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_ScAS_elmt_Vr_scas(unit "m-3.0..s-1.0") = 0.0896 "";
    parameter Real elmt_ScAS_elmt_Vf_scas(unit "m-3.0..s-1.0") = 8.96 "";
    Real elmt_product11 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_FUM_elmt_Vr_fum(unit "m-3.0..s-1.0") = 144.67 "";
    parameter Real elmt_FUM_elmt_Kfa_fum(unit "m-3.0.") = 0.15 "";
    parameter Real elmt_FUM_elmt_Vf_fum(unit "m-3.0..s-1.0") = 156.24 "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_ACN_elmt_Vf_acn(unit "m-3.0..s-1.0") = 629.28 "";
    parameter Real elmt_ACN_elmt_Kicit_acn(unit "m-3.0.") = 3.33 "";
    parameter Real elmt_ACN_elmt_Kcit_acn(unit "m-3.0.") = 1.7 "";
    parameter Real elmt_ACN_elmt_Vr_acn(unit "m-3.0..s-1.0") = 6.2928 "";
    Real elmt_reactant4 "";
    Real elmt_product5 "";
    Real elmt_ICD(unit = "") "";
 annotation(Documentation(info="<annotation>
    ...
    parameter Real elmt_ICD_elmt_Vf_icd(unit "m-3.0..s-1.0") = 6.625 "";
    parameter Real elmt_ICD_elmt_Kicit_icd(unit "m-3.0.") = 0.008 "";
    parameter Real elmt_ICD_elmt_Vr_icd(unit "m-3.0..s-1.0") = 0.06625 "";
    ...
    equation
        elmt_SYN = (elmt_cell * 0.0341 * (((elmt_SYN_elmt_Vf_icd * (elmt_icit / elmt_SYN_elmt_Kicit_icd)) - (elmt_SYN_elmt_Vr_icd * (elmt_akg / elmt_SYN_elmt_Kakg_icd))) / (1.0 + (elmt_icit / elmt_SYN_elmt_Kicit_icd) + (elmt_akg / elmt_SYN_elmt_Kakg_icd))));
