...
<COPASI xmlns=\"http://www.copasi.org/static/sbml\">
        <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
          <rdf:Description rdf:about=\"#COPASI2\">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2011-10-28T13:33:55Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
    ...
    Real elmt_species_2(unit = "") "MKKK_P";
 annotation(Documentation(info="<annotation>
	<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
...
<COPASI xmlns=\"http://www.copasi.org/static/sbml\">
        <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
          <rdf:Description rdf:about=\"#COPASI4\">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2011-07-20T16:46:42Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_species_4(unit = "") "MKK_P";
 annotation(Documentation(info="<annotation>
	<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
    ...
    Real elmt_species_5(unit = "") "MKK_PP";
 annotation(Documentation(info="<annotation>
	<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
...
<COPASI xmlns=\"http://www.copasi.org/static/sbml\">
        <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
          <rdf:Description rdf:about=\"#COPASI6\">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2011-01-27T15:05:54Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_species_8(unit = "") "MK_PP";
 annotation(Documentation(info="<annotation>
	<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
...
<COPASI xmlns=\"http://www.copasi.org/static/sbml\">
        <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
          <rdf:Description rdf:about=\"#COPASI5\">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2011-01-27T15:05:52Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
    ...
    initial equation
        ...
        elmt_species_3_conc = 1199.99994221325;
        elmt_species_1_conc = 300.0;
        elmt_species_6_conc = 1199.99994221325;
        elmt_species_7_conc = 0.0;
        elmt_species_4_conc = 0.0;
        elmt_species_5_conc = 0.0;
        elmt_species_10_conc = 200.0;
        elmt_species_11_conc = 20.0;
        elmt_species_8_conc = 0.0;
        elmt_species_9_conc = 100.0;
    ...
    equation
        ...
        der(elmt_species_11_amount) = 0;
        der(elmt_species_9_amount) = 0;
        der(elmt_species_2_amount) = ((elmt_reaction_1 * elmt_product1) + (- (elmt_reaction_2 * elmt_reactant2)));
        der(elmt_species_3_amount) = ((elmt_reaction_6 * elmt_product11) + (- (elmt_reaction_3 * elmt_reactant4)));
        der(elmt_species_1_amount) = ((- (elmt_reaction_1 * elmt_reactant0)) + (elmt_reaction_2 * elmt_product3));
        der(elmt_species_6_amount) = ((- (elmt_reaction_7 * elmt_reactant12)) + (elmt_reaction_10 * elmt_product19));
        der(elmt_species_7_amount) = ((elmt_reaction_9 * elmt_product17) + (elmt_reaction_7 * elmt_product13) + (- (elmt_reaction_8 * elmt_reactant14)) + (- (elmt_reaction_10 * elmt_reactant18)));
        der(elmt_species_4_amount) = ((elmt_reaction_5 * elmt_product9) + (- (elmt_reaction_6 * elmt_reactant10)) + (elmt_reaction_3 * elmt_product5) + (- (elmt_reaction_4 * elmt_reactant6)));
        der(elmt_species_5_amount) = ((- (elmt_reaction_5 * elmt_reactant8)) + (elmt_reaction_4 * elmt_product7));
        der(elmt_species_8_amount) = ((- (elmt_reaction_9 * elmt_reactant16)) + (elmt_reaction_8 * elmt_product15));
