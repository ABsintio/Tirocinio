...
class Functions
    ...
    function elmt_function_1
        ...
        output Real result;
        algorithm
            result := (arg_v * exp((((arg_E / arg_R) * (arg_T2 - arg_T1)) / (arg_T1 * arg_T2))) * arg_S);
    end elmt_function_1;
    ...
    function elmt_function_5
        ...
        output Real result;
        algorithm
            result := (arg_v * exp((((arg_E / arg_R) * (arg_T2 - arg_T1)) / (arg_T1 * arg_T2))) * arg_S1 * Functions.pow(arg_S2, arg_a));
    end elmt_function_5;
    ...
    function elmt_function_2
        ...
        output Real result;
        algorithm
            result := ((arg_v * exp((((arg_E / arg_R) * (arg_T2 - arg_T1)) / (arg_T1 * arg_T2)))) / (arg_k + Functions.pow(arg_S, arg_h)));
    end elmt_function_2;
    ...
    function elmt_function_3
        ...
        output Real result;
        algorithm
            result := ((arg_v * exp((((arg_E / arg_R) * (arg_T2 - arg_T1)) / (arg_T1 * arg_T2))) * arg_S) / (arg_Km + arg_S));
    end elmt_function_3;
