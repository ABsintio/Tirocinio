...
class Functions
    ...
    function elmt_function_0
        ...
        output Real result;
        algorithm
            result := ((arg_vsb * Functions.pow(arg_K, arg_m)) / (Functions.pow(arg_K, arg_m) + Functions.pow(arg_Bn, arg_m)));
    end elmt_function_0;
    ...
    function elmt_function_1
        ...
        output Real result;
        algorithm
            result := (arg_k * arg_mRNA);
    end elmt_function_1;

    function elmt_function_5
        input Real arg_length;
        input Real arg_model_time;

        output Real result;
        algorithm
            result := ceil((sin((((3.141592653589793 * arg_model_time) / arg_length) + 0.001)) / 2.0));
    end elmt_function_5;
    ...
    function elmt_function_3
        ...
        output Real result;
        algorithm
            result := ((arg_Vs * Functions.pow(arg_B, arg_n)) / (Functions.pow(arg_K, arg_n) + Functions.pow(arg_B, arg_n)));
    end elmt_function_3;
