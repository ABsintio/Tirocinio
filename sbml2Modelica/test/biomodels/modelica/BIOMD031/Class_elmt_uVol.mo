...
class Class_elmt_uVol
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_MAPKK1_conc(unit = "");
    Real elmt_MAPKK1_amount(unit = "");
    Real elmt_MAPKK1(unit = "") "MAPKK1";
 annotation(Documentation(info="<annotation>
          <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
	
          </rdf:RDF>
        </annotation>"));
    Real elmt_MAPKK2_conc(unit = "");
    Real elmt_MAPKK2_amount(unit = "");
    Real elmt_MAPKK2(unit = "") "MAPKK2";
 annotation(Documentation(info="<annotation>
          <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
 ...
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        ...
        elmt_MAPKK1_conc = (100.0 / elmt_uVol);
        elmt_MAPKK2_conc = (1.0 / elmt_uVol);
    ...
    equation
        ...
        elmt_MAPKK1 = elmt_MAPKK1_conc;
        elmt_MAPKK2 = elmt_MAPKK2_conc;
        elmt_Mpp = elmt_Mpp_conc;
        der(elmt_MKP3_amount) = 0;
        der(elmt_MAPKK1_amount) = 0;
        der(elmt_MAPKK2_amount) = 0;
    ...
    algorithm
        ...
        elmt_MAPKK1_conc := elmt_MAPKK1_amount / elmt_uVol;
        elmt_MAPKK2_conc := elmt_MAPKK2_amount / elmt_uVol;
