...
class Class_elmt_cell
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_dcon_conc(unit = "");
    Real elmt_dcon_amount(unit = "");
    Real elmt_dcon(unit = "") "";
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_atp_amount / elmt_cell) = (elmt_scale * ((elmt_vatp_s * (elmt_y - elmt_atp) * elmt_dcon * elmt_ip3con * ((elmt_ip3 - elmt_ip3min) / (elmt_krel + elmt_ip3))) - ((elmt_vdeg * elmt_atp) / (elmt_kkdeg + elmt_atp))));
        der(elmt_d_amount / elmt_cell) = ((elmt_ad * ((elmt_k * elmt_gf) / (1.0 + (elmt_k * elmt_gf)))) - (elmt_ddd * elmt_e * elmt_d));
        elmt_dcon_amount = ((tanh(((elmt_d - elmt_dcrit) / 0.01)) + 1.0) / 2.0) * elmt_cell;
        der(elmt_y_amount / elmt_cell) = (elmt_scale * ((elmt_alpha * (elmt_ymax - elmt_y)) - (elmt_dcon * elmt_ip3con * elmt_vatp_s * (elmt_y - elmt_atp) * ((elmt_ip3 - elmt_ip3min) / (elmt_krel + elmt_ip3)))));
    ...
    algorithm
        ...
        elmt_dcon_conc := elmt_dcon_amount / elmt_cell;
