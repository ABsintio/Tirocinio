...
class Functions
    ...
    function elmt_v2sub2prod
        ...
        output Real result;
        algorithm
            result := ((arg_Vfmax * arg_S1 * arg_S2 * (1.0 - ((arg_P1 * arg_P2) / (arg_Keq * arg_S1 * arg_S2)))) / (arg_Ks1 * arg_Ks2 * (1.0 + (arg_S2 / arg_Ks2) + (arg_P2 / arg_Kp2)) * (1.0 + (arg_S1 / arg_Ks1) + (arg_P1 / arg_Kp1))));
    end elmt_v2sub2prod;
