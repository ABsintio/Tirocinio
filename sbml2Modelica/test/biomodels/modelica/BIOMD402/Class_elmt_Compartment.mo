...
class Class_elmt_Compartment
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_Tumour_amount / elmt_Compartment) = (elmt_gammaT * elmt_Tumour * log((elmt_LT / elmt_Tumour)));
        der(elmt_B_amount / elmt_Compartment) = ((elmt_alpha2 * Functions.pow(elmt_C, (elmt_g12 / (1.0 + ((elmt_r12 * elmt_Tumour) / elmt_LT)))) * Functions.pow(elmt_B, (elmt_g22 - ((elmt_r22 * elmt_Tumour) / elmt_LT)))) - (elmt_beta2 * elmt_B));
