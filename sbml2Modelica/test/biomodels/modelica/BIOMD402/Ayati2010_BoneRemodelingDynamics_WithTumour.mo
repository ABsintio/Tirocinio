within BIOMD402;
model Ayati2010_BoneRemodelingDynamics_WithTumour "Ayati2010_BoneRemodelingDynamics_WithTumour" annotation(Documentation(info="<annotation>
...
end Ayati2010_BoneRemodelingDynamics_WithTumour;
