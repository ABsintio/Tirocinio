...
class Functions
    ...
    function elmt_function_1
        input Real arg_k_syn_mRNA;
        input Real arg_species_7;

        output Real result;
        algorithm
            result := (arg_k_syn_mRNA * arg_species_7);
    end elmt_function_1;

    function elmt_function_4
        input Real arg_k_syn_prot;
        input Real arg_species_1;

        output Real result;
        algorithm
            result := (arg_k_syn_prot * arg_species_1);
    end elmt_function_4;

    function elmt_function_2
        input Real arg_k_syn_miRNA_1;
        input Real arg_species_8;

        output Real result;
        algorithm
            result := (arg_k_syn_miRNA_1 * arg_species_8);
    end elmt_function_2;

    function elmt_function_3
        input Real arg_k_syn_miRNA_2;
        input Real arg_species_9;

        output Real result;
        algorithm
            result := (arg_k_syn_miRNA_2 * arg_species_9);
    end elmt_function_3;
