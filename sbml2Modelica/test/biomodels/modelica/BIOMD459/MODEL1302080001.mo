within BIOMD459;
model MODEL1302080001 "Liebal2012 - B.subtilis post-transcriptional instability model" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_kzx = Params.elmt_kzx;
