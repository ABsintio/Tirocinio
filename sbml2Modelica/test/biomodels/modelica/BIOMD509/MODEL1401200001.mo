within BIOMD509;
model MODEL1401200001 "Barrack2014 - Calcium/cell cycle coupling - Rs dependent ATP release" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_cell.elmt_rscrit = Params.elmt_rscrit;
