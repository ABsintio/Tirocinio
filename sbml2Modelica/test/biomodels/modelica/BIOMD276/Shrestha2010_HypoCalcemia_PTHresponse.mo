within BIOMD276;
model Shrestha2010_HypoCalcemia_PTHresponse "Shrestha2010_HypoCalcemia_PTHresponse" annotation(Documentation(info="<annotation>
...
end Shrestha2010_HypoCalcemia_PTHresponse;
