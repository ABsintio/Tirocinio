...
class Parameters
    ...
    equation
        ...
        elmt_dspksp = ((elmt_Ksp / 2.0) * ((1.0 + ((elmt_s + (elmt_P * elmt_univ)) / elmt_Ksp)) - Functions.pow((Functions.pow((1.0 + ((elmt_s + (elmt_P * elmt_univ)) / elmt_Ksp)), 2.0) - ((4.0 * elmt_s * elmt_P * elmt_univ) / Functions.pow(elmt_Ksp, 2.0))), 0.5)));
        der(elmt_h) = 0;
        der(elmt_Kd) = 0;
        der(elmt_s) = 0;
        der(elmt_ku) = 0;
