within BIOMD152;
class Class_elmt_ca_off9 "ca_off9"
    ...
    equation
        trigger = (time >= (elmt_cAMP_delay + elmt_cAMP_Ca_delay + elmt_spike_duration + (8.0 * (elmt_spike_interval + elmt_spike_duration))));
        algorithm
            value_elmt_k57 := elmt_kon_low;
end Class_elmt_ca_off9;
