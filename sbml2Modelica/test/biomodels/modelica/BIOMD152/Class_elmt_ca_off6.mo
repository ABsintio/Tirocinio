within BIOMD152;
class Class_elmt_ca_off6 "ca_off6"
    ...
    equation
        trigger = (time >= (elmt_cAMP_delay + elmt_cAMP_Ca_delay + elmt_spike_duration + (5.0 * (elmt_spike_interval + elmt_spike_duration))));
        algorithm
            value_elmt_k57 := elmt_kon_low;
end Class_elmt_ca_off6;
