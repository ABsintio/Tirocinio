...
class Reactions
    ...
    equation
        elmt_PGA_prod_Vo = (elmt_chloroplast * (((elmt_phi * (((((elmt_Vc + elmt_Vj) - abs((elmt_Vc - elmt_Vj))) / 2.0) + elmt_Vp) - abs(((((elmt_Vc + elmt_Vj) - abs((elmt_Vc - elmt_Vj))) / 2.0) - elmt_Vp)))) / 2.0)));
        elmt_PGA_prod_Vc = (elmt_chloroplast * (((((((elmt_Vc + elmt_Vj) - abs((elmt_Vc - elmt_Vj))) / 2.0) + elmt_Vp) - abs(((((elmt_Vc + elmt_Vj) - abs((elmt_Vc - elmt_Vj))) / 2.0) - elmt_Vp))) / 2.0)));
