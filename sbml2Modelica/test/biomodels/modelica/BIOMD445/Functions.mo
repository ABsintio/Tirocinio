...
class Functions
    ...
    function elmt_function_4_cP7_m_trscr_1
        ...
        output Real result;
        algorithm
            result := (((Functions.pow(arg_parameter_6, arg_parameter_7) / (Functions.pow(arg_parameter_6, arg_parameter_7) + Functions.pow(arg_cT, arg_parameter_7))) * (((arg_n8 * Functions.pow((arg_cLm + arg_cL), arg_e)) / (Functions.pow((arg_cLm + arg_cL), arg_e) + Functions.pow(arg_g10, arg_e))) + ((arg_n9 * Functions.pow(arg_cP9, arg_f)) / (Functions.pow(arg_cP9, arg_f) + Functions.pow(arg_g11, arg_f))))) / arg_def);
    ...
    function elmt_function_4_cL_m_trscr
        ...
        output Real result;
        algorithm
            result := ((arg_L * arg_q1 * arg_cP) + ((arg_n1 * Functions.pow(arg_g1, arg_a)) / (Functions.pow((arg_cP9 + arg_cP7 + arg_cNI + arg_cT), arg_a) + Functions.pow(arg_g1, arg_a))));
    ...
    function elmt_function_4_cT_m_trscr
        ...
        output Real result;
        algorithm
            result := ((((arg_n2 / (1.0 + Functions.pow((arg_cL / (arg_g5 * (1.0 + Functions.pow((arg_species_3 / arg_parameter_14), arg_parameter_11)))), arg_e))) * arg_g4) / (arg_cEC + arg_g4)) / arg_def);
