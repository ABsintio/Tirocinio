...
class Parameters
    ...
    Real elmt_kdephosp53(unit = "s-1.0") "";
    Real elmt_kproteff(unit = "") "";
    Real elmt_kphosMdm2(unit = "mol-1.0.s-1.0") "";
    Real elmt_krepair(unit = "s-1.0") "";
    Real elmt_kphosp53(unit = "mol-1.0.s-1.0") "";
    Real elmt_ksynp53mRNA(unit = "s-1.0") "";
    ...
    Real elmt_kdegATMMdm2(unit = "s-1.0") "";
    Real elmt_kactATM(unit = "mol-1.0.s-1.0") "";
    Real elmt_kdam(unit = "m-2.0..") "";
    Real elmt_ksynMdm2mRNA(unit = "s-1.0") "";
    Real elmt_kinactATM(unit = "s-1.0") "";
    Real elmt_kdegp53mRNA(unit = "s-1.0") "";
    Real elmt_ksynp53(unit = "s-1.0") "";
    Real elmt_kbinMdm2p53(unit = "mol-1.0.s-1.0") "";
    Real elmt_kdephosMdm2(unit = "s-1.0") "";
