...
class Functions
    ...
    function elmt_function_1
        input Real arg_V;
        input Real arg_Shalve;
        input Real arg_h;
        input Real arg_substrate;

        output Real result;
        algorithm
            result := (arg_V / (Functions.pow(arg_Shalve, arg_h) + Functions.pow(arg_substrate, arg_h)));
    end elmt_function_1;
    ...
    function elmt_function_2
        ...
        output Real result;
        algorithm
            result := ((arg_V * Functions.pow(arg_substrate, arg_h)) / (Functions.pow(arg_Shalve, arg_h) + Functions.pow(arg_substrate, arg_h)));
    end elmt_function_2;
