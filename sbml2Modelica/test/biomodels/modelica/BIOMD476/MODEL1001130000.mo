within BIOMD476;
model MODEL1001130000 "Adams2012 - Locke2006 Circadian Rhythm model refined with Input Signal Light Function" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_lightAmplitude = Params.elmt_lightAmplitude;
        Reacs.elmt_r1 = Params.elmt_r1;
        Reacs.elmt_r2 = Params.elmt_r2;
        Reacs.elmt_phase = Params.elmt_phase;
        ...
        Reacs.elmt_twilightPeriod = Params.elmt_twilightPeriod;
        ...
        Reacs.elmt_photoPeriod = Params.elmt_photoPeriod;
