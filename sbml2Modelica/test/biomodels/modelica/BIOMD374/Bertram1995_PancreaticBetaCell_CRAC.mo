within BIOMD374;
model Bertram1995_PancreaticBetaCell_CRAC "Bertram1995_PancreaticBetaCell_CRAC" annotation(Documentation(info="<annotation>
...
end Bertram1995_PancreaticBetaCell_CRAC;
