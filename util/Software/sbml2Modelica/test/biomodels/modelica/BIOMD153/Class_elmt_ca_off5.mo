within BIOMD153;
class Class_elmt_ca_off5 "ca_off5"
    ...
    equation
        trigger = (time >= (elmt_cAMP_delay + elmt_cAMP_Ca_delay + elmt_spike_duration + (4.0 * (elmt_spike_interval + elmt_spike_duration))));
        algorithm
            value_elmt_k57 := elmt_kon_low;
end Class_elmt_ca_off5;
