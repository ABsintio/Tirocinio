within BIOMD222;
model Singh2006_TCA_Ecoli_glucose "Singh2006_TCA_Ecoli_glucose" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_cell.elmt_ICL = Reacs.elmt_ICL;
        ...
        elmt_cell.elmt_KDH = Reacs.elmt_KDH;
        ...
        elmt_cell.elmt_ICD = Reacs.elmt_ICD;

end Singh2006_TCA_Ecoli_glucose;
