...
class Functions
    ...
    function elmt_function_4_1_1
        ...
        output Real result;
        algorithm
            result := (((arg_V1 * arg_species_0) / arg_K1) / ((1.0 + (arg_species_0 / arg_K1)) * (1.0 + (arg_species_7 / arg_KI))));
    ...
    function elmt_function_4_3_1
        ...
        output Real result;
        algorithm
            result := ((((arg_k3 * arg_species_1 * arg_species_2) / arg_K3) / (1.0 + (arg_species_2 / arg_K3) + (arg_species_3 / arg_K3))) * ((1.0 + ((arg_A * arg_species_7) / arg_Ka)) / (1.0 + (arg_species_7 / arg_Ka))));
    ...
    function elmt_function_4_4_1
        ...
        output Real result;
        algorithm
            result := ((((arg_k4 * arg_species_1 * arg_species_3) / arg_K4) / (1.0 + (arg_species_3 / arg_K4) + (arg_species_2 / arg_K4))) * ((1.0 + ((arg_A * arg_species_7) / arg_Ka)) / (1.0 + (arg_species_7 / arg_Ka))));
