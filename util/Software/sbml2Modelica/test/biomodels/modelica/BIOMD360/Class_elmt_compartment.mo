...
class Class_elmt_compartment
 ...
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        ...
        elmt_VIIa_TF_conc = 0.9999997;
        elmt_Xa_TFPI_conc = 0.0;
        elmt_TFPI_conc = 2.399999;
        elmt_X_conc = 169.9999;
    ...
    equation
        ...
        der(elmt_VIIa_TF_X_amount) = ((elmt_reaction_1 * elmt_product2) + (- (elmt_reaction_2 * elmt_reactant3)));
        der(elmt_VIIa_TF_amount) = ((elmt_reaction_7 * elmt_product18) + (- (elmt_reaction_5 * elmt_reactant11)) + (elmt_reaction_3 * elmt_product7) + (- (elmt_reaction_1 * elmt_reactant1)));
        der(elmt_Xa_TFPI_amount) = ((elmt_reaction_7 * elmt_product19) + (- (elmt_reaction_5 * elmt_reactant12)) + (elmt_reaction_4 * elmt_product10));
        der(elmt_TFPI_amount) = ((- (elmt_reaction_6 * elmt_reactant15)) + (- (elmt_reaction_4 * elmt_reactant9)));
        der(elmt_X_amount) = (- (elmt_reaction_1 * elmt_reactant0));
        der(elmt_Xa_TFPI_VIIa_TF_amount) = ((elmt_reaction_8 * elmt_product21) + (elmt_reaction_5 * elmt_product13));
        der(elmt_VIIa_TF_Xa_amount) = ((- (elmt_reaction_6 * elmt_reactant14)) + (- (elmt_reaction_3 * elmt_reactant5)) + (elmt_reaction_2 * elmt_product4));
        der(elmt_VIIa_TF_Xa_TFPI_amount) = ((- (elmt_reaction_7 * elmt_reactant17)) + (- (elmt_reaction_8 * elmt_reactant20)) + (elmt_reaction_6 * elmt_product16));
