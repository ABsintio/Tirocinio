within BIOMD027;
model Markevich2004_MAPK_orderedMM "Markevich2004 - MAPK double phosphorylation,  ordered Michaelis-Menton" annotation(Documentation(info="<annotation>
...
end Markevich2004_MAPK_orderedMM;
