...
class Functions
    ...
    function elmt_function_4_cP7_m_trscr
        input Real arg_cL;
        input Real arg_cLm;
        input Real arg_cP9;
        input Real arg_def;
    ...
    end elmt_function_4_cP7_m_trscr;
    ...
    function elmt_function_4_cP_trsl
        ...
        output Real result;
        algorithm
            result := ((arg_p7 * (1.0 - arg_L) * (1.0 - arg_cP)) / arg_def);
    ...
    function elmt_function_4_cEG_degr
    ...
    function elmt_function_4_cG_degr
        input Real arg_cE3n;
        input Real arg_cG;
        input Real arg_def;
        input Real arg_m19;
    ...
    function elmt_function_4_cLUX_degr
        input Real arg_cCOP1d;
        input Real arg_cCOP1n;
        input Real arg_cE3n;
        input Real arg_cE4;
    ...
    function elmt_lightfun
        input Real arg_t;
        input Real arg_lightOffset;
        input Real arg_lightAmplitude;
        input Real arg_cyclePeriod;
        input Real arg_photoPeriod;
        input Real arg_phase;
        input Real arg_twilightPeriod;

        output Real result;
        algorithm
            result := (((arg_lightOffset + (0.5 * arg_lightAmplitude * (1.0 + tanh(((arg_cyclePeriod * (((arg_t + arg_phase) / arg_cyclePeriod) - floor((floor((arg_t + arg_phase)) / arg_cyclePeriod)))) / arg_twilightPeriod))))) - (0.5 * arg_lightAmplitude * (1.0 + tanh((((arg_cyclePeriod * (((arg_t + arg_phase) / arg_cyclePeriod) - floor((floor((arg_t + arg_phase)) / arg_cyclePeriod)))) - arg_photoPeriod) / arg_twilightPeriod))))) + (0.5 * arg_lightAmplitude * (1.0 + tanh((((arg_cyclePeriod * (((arg_t + arg_phase) / arg_cyclePeriod) - floor((floor((arg_t + arg_phase)) / arg_cyclePeriod)))) - arg_cyclePeriod) / arg_twilightPeriod)))));
    end elmt_lightfun;

    function elmt_function_4_cNI_m_trscr
        input Real arg_b;
        input Real arg_cLm;
        input Real arg_cP7;
        input Real arg_def;
    ...
    end elmt_function_4_cNI_m_trscr;
