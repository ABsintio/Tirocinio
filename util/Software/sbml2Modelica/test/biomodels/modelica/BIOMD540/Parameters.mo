...
class Parameters
    ...
    input Real assign_elmt_k_pfkl_s775;
    ...
    Real elmt_k_pfkl_s775(unit = "") "k_pfkl_s775";
    ...
    equation
        ...
        when elmt_ev2min then
            ...
            reinit(elmt_k_pfkl_s775, assign_elmt_k_pfkl_s775);
