within BIOMD279;
model Komarova2005_PTHaction_OsteoclastOsteoblastCoupling "Komarova2005_PTHaction_OsteoclastOsteoblastCoupling" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Params.elmt_x2 = elmt_Compartment.elmt_x2;
...
end Komarova2005_PTHaction_OsteoclastOsteoblastCoupling;
