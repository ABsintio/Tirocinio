within BIOMD043;
model Goldbeter_Calcium_Oscillation_based_on_CICR_AND_CA_channel_inhibition "Borghans1997 - Calcium Oscillation - Model 1" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_Rho = elmt_cytosol.elmt_Rho;
...
end Goldbeter_Calcium_Oscillation_based_on_CICR_AND_CA_channel_inhibition;
