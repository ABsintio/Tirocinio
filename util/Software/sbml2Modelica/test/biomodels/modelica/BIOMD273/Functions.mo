...
class Functions
    ...
    function elmt_function_4_cT_modif
        input Real arg_cT;
        input Real arg_def;
        input Real arg_f;
        input Real arg_g6;
    ...
    function elmt_function_4_cY_m_degr
        input Real arg_cY_m;
        input Real arg_def;
        input Real arg_m9;
    ...
    function elmt_function_4_cY_degr
        input Real arg_cY;
        input Real arg_def;
        input Real arg_m10;
    ...
    function elmt_function_4_cY_m_trscr
        input Real arg_D;
        input Real arg_L;
        input Real arg_cL;
        input Real arg_cP;
    ...
    end elmt_function_4_cY_m_trscr;

    function elmt_function_4_cTm_degr
        input Real arg_D;
        input Real arg_L;
        input Real arg_cTm;
        input Real arg_def;
    ...
    function elmt_function_4_cY_trsl
        input Real arg_cY_m;
        input Real arg_def;
        input Real arg_p6;
    ...
    function elmt_function_4_cP9_m_trscr
        input Real arg_L;
        input Real arg_cL;
        input Real arg_cP;
        input Real arg_cT;
    ...
    end elmt_function_4_cP9_m_trscr;
    ...
    function elmt_function_4_cG_m_trscr
        input Real arg_L;
        input Real arg_cL;
        input Real arg_cP;
        input Real arg_cT;
    ...
    end elmt_function_4_cG_m_trscr;
