...
class Reactions
    ...
    Real elmt_reaction_9(unit = "") "reaction_8";
    parameter Real elmt_reaction_9_elmt_k1(unit "") = 0.0 "";
    parameter Real elmt_reaction_9_elmt_k2(unit "") = 0.0 "";
    Real elmt_reactant17 "";
    Real elmt_product18 "";
    Real elmt_reaction_8(unit = "") "reaction_9";
    parameter Real elmt_reaction_8_elmt_k1(unit "") = 20.0 "";
    ...
    parameter Real elmt_reaction_5_elmt_k2(unit "") = 0.0 "";
    Real elmt_product13 "";
    Real elmt_reactant11 "";
    Real elmt_reactant12 "";
    Real elmt_reaction_6(unit = "") "reaction_6";
    parameter Real elmt_reaction_6_elmt_k1(unit "") = 6.0 "";
    parameter Real elmt_reaction_6_elmt_k2(unit "") = 0.02 "";
    ...
    equation
        elmt_reaction_9 = (elmt_compartment * ((elmt_reaction_9_elmt_k1 * elmt_VIIa_TF_Xa_TFPI) - (elmt_reaction_9_elmt_k2 * elmt_Xa_TFPI_VIIa_TF)));
        elmt_reaction_8 = (elmt_compartment * ((elmt_reaction_8_elmt_k1 * elmt_VIIa_TF_X * elmt_Xa_TFPI) - (elmt_reaction_8_elmt_k2 * elmt_X * elmt_VIIa_TF_Xa_TFPI)));
