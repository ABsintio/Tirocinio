within BIOMD610;
model PetelenzKuehn_osmoadaptation_gpd1D "PetelenzKuehn_osmoadaptation_gpd1D" annotation(Documentation(info="<annotation>
...
end PetelenzKuehn_osmoadaptation_gpd1D;
