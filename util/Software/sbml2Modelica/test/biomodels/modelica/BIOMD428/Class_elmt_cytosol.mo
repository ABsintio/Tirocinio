...
class Class_elmt_cytosol
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_Gly_c_conc(unit = "");
    Real elmt_Gly_c_amount(unit = "");
    Real elmt_Gly_c(unit = "") "Gly_c";
 annotation(Documentation(info="<annotation>
	<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt__3PGA_c_amount) = ((- (elmt_PGAM_c * elmt_reactant30)) + (elmt__3PGAT_g * elmt_product25));
        der(elmt_PEP_c_amount) = ((elmt_ENO_c * elmt_product19) + (- (elmt_PYK_c * elmt_reactant2)));
        der(elmt_ATP_c_amount) = ((elmt_PYK_c * elmt_product5) + (elmt_AK_c * elmt_product47) + (- (elmt_ATPu_c * elmt_reactant36)));
        der(elmt_Glc_c_amount) = ((elmt_GlcT_c * elmt_product13) + (- (elmt_GlcT_g * elmt_reactant8)));
        der(elmt_Gly3P_c_amount) = ((elmt_GDA_g * elmt_product60) + (- (elmt_GPO_c * elmt_reactant62)));
        der(elmt_Gly_c_amount) = ((- (elmt_GlyT_c * elmt_reactant6)) + (elmt_GlyT_g * elmt_product1));
        der(elmt_DHAP_c_amount) = ((- (elmt_GDA_g * elmt_reactant59)) + (elmt_GPO_c * elmt_product63));
        der(elmt_AMP_c_amount) = (elmt_AK_c * elmt_product46);
        der(elmt__2PGA_c_amount) = ((- (elmt_ENO_c * elmt_reactant18)) + (elmt_PGAM_c * elmt_product31));
        der(elmt_Pyr_c_amount) = ((elmt_PYK_c * elmt_product4) + (- (elmt_PyrT_c * elmt_reactant10)));
        der(elmt_ADP_c_amount) = ((- (elmt_PYK_c * elmt_reactant3)) + (- (elmt_AK_c * elmt_reactant45)) + (elmt_ATPu_c * elmt_product37));
    ...
    algorithm
        ...
        elmt_Gly_c_conc := elmt_Gly_c_amount / elmt_cytosol;
