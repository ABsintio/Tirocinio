...
class Class_elmt_Cytoplasm
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_Cdc20_amount) = ((- (elmt_R5 * elmt_reactant14)) + (- (elmt_R6 * elmt_reactant17)) + (elmt_R3 * elmt_product8) + (- (elmt_R2 * elmt_reactant4)));
        der(elmt_MCC_amount) = (elmt_R4 * elmt_product12);
