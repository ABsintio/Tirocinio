...
class Functions
    ...
    function elmt_linear_activation
        input Real arg_constant;
        input Real arg_Activator;

        output Real result;
        algorithm
            result := (arg_constant * arg_Activator);
    end elmt_linear_activation;

    function elmt_Irr_Michaelis_Menten__enzyme__userdefined
        input Real arg_V;
        input Real arg_E;
        input Real arg_S;
        input Real arg_Km;
        ...
        output Real result;
        algorithm
            result := ((arg_V * arg_E * arg_S) / (arg_Km + arg_S));
    end elmt_Irr_Michaelis_Menten__enzyme__userdefined;
