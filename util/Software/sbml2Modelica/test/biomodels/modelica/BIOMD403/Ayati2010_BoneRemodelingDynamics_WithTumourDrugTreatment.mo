within BIOMD403;
model Ayati2010_BoneRemodelingDynamics_WithTumourDrugTreatment "Ayati2010_BoneRemodelingDynamics_WithTumour+DrugTreatment" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_Compartment.elmt_gammaT = Params.elmt_gammaT;
        elmt_Compartment.elmt_r12 = Params.elmt_r12;
        elmt_Compartment.elmt_r11 = Params.elmt_r11;
        elmt_Compartment.elmt_r22 = Params.elmt_r22;
        elmt_Compartment.elmt_r21 = Params.elmt_r21;
        ...
        elmt_Compartment.elmt_LT = Params.elmt_LT;
...
end Ayati2010_BoneRemodelingDynamics_WithTumourDrugTreatment;
