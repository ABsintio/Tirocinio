...
class Class_elmt_compartment_0
 ...
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        ...
        elmt_species_11_conc = 99.9999903688752;
    ...
    equation
        ...
        der(elmt_species_6_amount) = ((elmt_reaction_3 * elmt_product7) + (- (elmt_reaction_4 * elmt_reactant8)) + (- (elmt_reaction_9 * elmt_reactant18)) + (elmt_reaction_8 * elmt_product17));
        der(elmt_species_7_amount) = ((elmt_reaction_4 * elmt_product9) + (- (elmt_reaction_8 * elmt_reactant16)));
        der(elmt_species_4_amount) = ((elmt_reaction_2 * elmt_product5) + (- (elmt_reaction_6 * elmt_reactant12)));
        der(elmt_species_5_amount) = ((- (elmt_reaction_3 * elmt_reactant6)) + (elmt_reaction_9 * elmt_product19));
        der(elmt_species_11_amount) = ((- (elmt_reaction_10 * elmt_reactant20)) + (elmt_reaction_11 * elmt_product23));
        der(elmt_species_12_amount) = ((elmt_reaction_10 * elmt_product21) + (- (elmt_reaction_11 * elmt_reactant22)));
