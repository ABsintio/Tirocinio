within BIOMD187;
model MODEL6655578762 "Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Convey variant" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_k7bf = Params.elmt_k7bf;
        ...
        elmt_Cytoplasm.elmt_R7b = Reacs.elmt_R7b;
