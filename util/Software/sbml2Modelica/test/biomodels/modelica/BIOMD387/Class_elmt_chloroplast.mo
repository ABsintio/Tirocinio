...
class Class_elmt_chloroplast
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_starch_conc(unit = "");
    Real elmt_starch_amount(unit = "");
    Real elmt_starch(unit = "") "starch";
 annotation(Documentation(info="<annotation>
          <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\">
 ...
 annotation(Documentation(info="<annotation>
    ...
    initial equation
        ...
        elmt_O2_conc = 21000.0;
        elmt_CO2_conc = 24.5;
        elmt_starch_conc = 0.5;
    ...
    algorithm
        ...
        elmt_starch_conc := elmt_starch_amount / elmt_chloroplast;
