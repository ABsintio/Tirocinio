within BIOMD133;
model Izhikevich2004_SpikingNeurons_resonator "Izhikevich2004_SpikingNeurons_resonator" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Params.assign_elmt_i = prioritize_between_3({Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY, Constants.NEGATIVE_INFINITY}, {elmt_event_0000004.value_elmt_i, elmt_event_0000005.value_elmt_i, elmt_event_0000003.value_elmt_i}, {edge(elmt_event_0000004.trigger), edge(elmt_event_0000005.trigger), edge(elmt_event_0000003.trigger)});
        Params.assign_elmt_u = elmt_event_0000001.value_elmt_u;
        Params.assign_elmt_v = elmt_event_0000001.value_elmt_v;
end Izhikevich2004_SpikingNeurons_resonator;
