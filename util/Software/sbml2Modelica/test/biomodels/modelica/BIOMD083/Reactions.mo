...
class Reactions
    ...
    input Real elmt_Rc;
    input Real elmt_Bnp;
    input Real elmt_parameter_0000097;
    input Real elmt_Bcp;
    input Real elmt_PCc;
    input Real elmt_Ccp;
    input Real elmt_Rn;
    input Real elmt_PCnp;
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        elmt_reaction_27 = (elmt_cell * elmt_reaction_27_elmt_k1 * elmt_Pc);
        elmt_reaction_28 = (elmt_cell * elmt_reaction_28_elmt_k1 * elmt_Cc);
        elmt_reaction_25 = (elmt_cell * (((elmt_reaction_25_elmt_V * elmt_Mc) / (elmt_reaction_25_elmt_Km + elmt_Mc))));
        elmt_reaction_26 = (elmt_cell * (((elmt_reaction_26_elmt_V * elmt_Mp) / (elmt_reaction_26_elmt_Km + elmt_Mp))));
        elmt_reaction_29 = (elmt_cell * elmt_reaction_29_elmt_k1 * elmt_Pcp);
        elmt_reaction_20 = (elmt_cell * (((elmt_reaction_20_elmt_Vs * Functions.pow(elmt_Bn, elmt_reaction_20_elmt_n)) / (Functions.pow(elmt_reaction_20_elmt_K, elmt_reaction_20_elmt_n) + Functions.pow(elmt_Bn, elmt_reaction_20_elmt_n)))));
        elmt_reaction_23 = (elmt_cell * ((elmt_reaction_23_elmt_k1 * elmt_PCn * elmt_Bn) - (elmt_reaction_23_elmt_k2 * elmt_In)));
        elmt_reaction_24 = (elmt_cell * (((elmt_reaction_24_elmt_V * elmt_Mb) / (elmt_reaction_24_elmt_Km + elmt_Mb))));
        elmt_reaction_21 = (elmt_cell * (((elmt_reaction_21_elmt_V * elmt_PCn) / (elmt_reaction_21_elmt_Km + elmt_PCn))));
        elmt_reaction_22 = (elmt_cell * elmt_reaction_22_elmt_k1 * elmt_Mp);
        elmt_reaction_3 = (elmt_cell * (((elmt_reaction_3_elmt_V * elmt_Bc) / (elmt_reaction_3_elmt_Km + elmt_Bc))));
        elmt_reaction_4 = (elmt_cell * ((elmt_reaction_4_elmt_k1 * elmt_Bc) - (elmt_reaction_4_elmt_k2 * elmt_Bn)));
        elmt_reaction_1 = (elmt_cell * ((elmt_reaction_1_elmt_k * elmt_Mb)));
        elmt_reaction_2 = (elmt_cell * elmt_reaction_2_elmt_k1 * elmt_Mb);
        elmt_reaction_0 = (elmt_cell * (((elmt_reaction_0_elmt_vsb * Functions.pow(elmt_reaction_0_elmt_K, elmt_reaction_0_elmt_m)) / (Functions.pow(elmt_reaction_0_elmt_K, elmt_reaction_0_elmt_m) + Functions.pow(elmt_Rn, elmt_reaction_0_elmt_m)))));
        elmt_reaction_16 = (elmt_cell * ((elmt_reaction_16_elmt_k1 * elmt_PCc) - (elmt_reaction_16_elmt_k2 * elmt_PCn)));
        elmt_reaction_17 = (elmt_cell * elmt_reaction_17_elmt_k1 * elmt_PCnp);
        elmt_reaction_9 = (elmt_cell * (((elmt_parameter_0000097 * Functions.pow(elmt_Bn, elmt_reaction_9_elmt_n)) / (Functions.pow(elmt_reaction_9_elmt_K, elmt_reaction_9_elmt_n) + Functions.pow(elmt_Bn, elmt_reaction_9_elmt_n)))));
        elmt_reaction_14 = (elmt_cell * (((elmt_reaction_14_elmt_V * elmt_PCc) / (elmt_reaction_14_elmt_Km + elmt_PCc))));
        elmt_reaction_15 = (elmt_cell * (((elmt_reaction_15_elmt_V * elmt_PCcp) / (elmt_reaction_15_elmt_Km + elmt_PCcp))));
        elmt_reaction_7 = (elmt_cell * (((elmt_reaction_7_elmt_V * elmt_Cc) / (elmt_reaction_7_elmt_Km + elmt_Cc))));
        elmt_reaction_8 = (elmt_cell * (((elmt_reaction_8_elmt_V * elmt_Ccp) / (elmt_reaction_8_elmt_Km + elmt_Ccp))));
        elmt_reaction_5 = (elmt_cell * ((elmt_reaction_5_elmt_k * elmt_Mc)));
        elmt_reaction_18 = (elmt_cell * elmt_reaction_18_elmt_k1 * elmt_Bcp);
        elmt_reaction_6 = (elmt_cell * elmt_reaction_6_elmt_k1 * elmt_Mc);
        elmt_reaction_19 = (elmt_cell * elmt_reaction_19_elmt_k1 * elmt_Bnp);
        elmt_reaction_52 = (elmt_cell * ((elmt_reaction_52_elmt_k1 * elmt_Rc) - (elmt_reaction_52_elmt_k2 * elmt_Rn)));
        elmt_reaction_53 = (elmt_cell * (((elmt_reaction_53_elmt_V * elmt_Rc) / (elmt_reaction_53_elmt_Km + elmt_Rc))));
        elmt_reaction_50 = (elmt_cell * (((elmt_reaction_50_elmt_V * elmt_Mr) / (elmt_reaction_50_elmt_Km + elmt_Mr))));
        elmt_reaction_51 = (elmt_cell * ((elmt_reaction_51_elmt_k * elmt_Mr)));
        elmt_reaction_12 = (elmt_cell * (((elmt_reaction_12_elmt_V * elmt_Pc) / (elmt_reaction_12_elmt_Km + elmt_Pc))));
        elmt_reaction_56 = (elmt_cell * elmt_reaction_56_elmt_k1 * elmt_Rn);
        elmt_reaction_13 = (elmt_cell * ((elmt_reaction_13_elmt_k1 * elmt_Cc * elmt_Pc) - (elmt_reaction_13_elmt_k2 * elmt_PCc)));
        elmt_reaction_10 = (elmt_cell * ((elmt_reaction_10_elmt_k * elmt_Mp)));
        elmt_reaction_54 = (elmt_cell * elmt_reaction_54_elmt_k1 * elmt_Rc);
        elmt_reaction_11 = (elmt_cell * (((elmt_reaction_11_elmt_V * elmt_Pcp) / (elmt_reaction_11_elmt_Km + elmt_Pcp))));
        elmt_reaction_55 = (elmt_cell * (((elmt_reaction_55_elmt_V * elmt_Rn) / (elmt_reaction_55_elmt_Km + elmt_Rn))));
        elmt_reaction_49 = (elmt_cell * elmt_reaction_49_elmt_k1 * elmt_Mr);
        elmt_reaction_47 = (elmt_cell * (((elmt_reaction_47_elmt_V * elmt_PCcp) / (elmt_reaction_47_elmt_Km + elmt_PCcp))));
        elmt_reaction_48 = (elmt_cell * (((elmt_reaction_48_elmt_Vs * Functions.pow(elmt_Bn, elmt_reaction_48_elmt_n)) / (Functions.pow(elmt_reaction_48_elmt_K, elmt_reaction_48_elmt_n) + Functions.pow(elmt_Bn, elmt_reaction_48_elmt_n)))));
        elmt_reaction_41 = (elmt_cell * (((elmt_reaction_41_elmt_V * elmt_Bcp) / (elmt_reaction_41_elmt_Km + elmt_Bcp))));
        elmt_reaction_42 = (elmt_cell * (((elmt_reaction_42_elmt_V * elmt_Bnp) / (elmt_reaction_42_elmt_Km + elmt_Bnp))));
        elmt_reaction_40 = (elmt_cell * elmt_reaction_40_elmt_k1 * elmt_Bn);
        elmt_reaction_45 = (elmt_cell * (((elmt_reaction_45_elmt_V * elmt_PCnp) / (elmt_reaction_45_elmt_Km + elmt_PCnp))));
        elmt_reaction_46 = (elmt_cell * elmt_reaction_46_elmt_k1 * elmt_PCn);
        elmt_reaction_43 = (elmt_cell * (((elmt_reaction_43_elmt_V * elmt_Ccp) / (elmt_reaction_43_elmt_Km + elmt_Ccp))));
        elmt_reaction_44 = (elmt_cell * (((elmt_reaction_44_elmt_V * elmt_Pcp) / (elmt_reaction_44_elmt_Km + elmt_Pcp))));
        elmt_reaction_38 = (elmt_cell * elmt_reaction_38_elmt_k1 * elmt_In);
        elmt_reaction_39 = (elmt_cell * (((elmt_reaction_39_elmt_V * elmt_In) / (elmt_reaction_39_elmt_Km + elmt_In))));
        elmt_reaction_36 = (elmt_cell * (((elmt_reaction_36_elmt_V * elmt_Bn) / (elmt_reaction_36_elmt_Km + elmt_Bn))));
        elmt_reaction_37 = (elmt_cell * (((elmt_reaction_37_elmt_V * elmt_Bnp) / (elmt_reaction_37_elmt_Km + elmt_Bnp))));
        elmt_reaction_30 = (elmt_cell * elmt_reaction_30_elmt_k1 * elmt_Ccp);
        elmt_reaction_31 = (elmt_cell * elmt_reaction_31_elmt_k1 * elmt_PCcp);
        elmt_reaction_34 = (elmt_cell * elmt_reaction_34_elmt_k1 * elmt_Bc);
        elmt_reaction_35 = (elmt_cell * (((elmt_reaction_35_elmt_V * elmt_Bcp) / (elmt_reaction_35_elmt_Km + elmt_Bcp))));
        elmt_reaction_32 = (elmt_cell * elmt_reaction_32_elmt_k1 * elmt_PCc);
        elmt_reaction_33 = (elmt_cell * (((elmt_reaction_33_elmt_V * elmt_PCnp) / (elmt_reaction_33_elmt_Km + elmt_PCnp))));
