...
class Class_elmt_univ
    ...
    input Real elmt____r6;
    input Real elmt____r5;
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_P2_amount) = ((elmt____r3 * elmt_product2) + (- (elmt____r4 * elmt_reactant3)));
        der(elmt_Target_amount) = ((- (elmt____r6 * elmt_reactant5)) + (elmt____r5 * elmt_product4));

    algorithm
        elmt_P1_conc := elmt_P1_amount / elmt_univ;
        elmt_P2_conc := elmt_P2_amount / elmt_univ;
