within BIOMD419;
model Ratushny2012_SPF_I "Ratushny2012_SPF_I" annotation(Documentation(info="<annotation>
    ...
    equation
        Params.elmt_P1 = elmt_univ.elmt_P1;
        ...
        Reacs.elmt_P1 = elmt_univ.elmt_P1;
        ...
        elmt_univ.elmt_reactant5 = Reacs.elmt_reactant5;
        elmt_univ.elmt_product0 = Reacs.elmt_product0;
        elmt_univ.elmt_product4 = Reacs.elmt_product4;
        elmt_univ.elmt____r6 = Reacs.elmt____r6;
        elmt_univ.elmt____r5 = Reacs.elmt____r5;
        elmt_univ.elmt_product2 = Reacs.elmt_product2;
        elmt_univ.elmt____r4 = Reacs.elmt____r4;

end Ratushny2012_SPF_I;
