within BIOMD267;
model Lebeda2008_BoNT_Paralysis_3stepModel "Lebeda2008 - BoNT paralysis (3 step model)" annotation(Documentation(info="<annotation>
...
end Lebeda2008_BoNT_Paralysis_3stepModel;
