...
class Parameters
    ...
    Real elmt_mw427cd601_2c01_42ea_85dc_ab7c5a601fd8(unit = "") "infusionTime";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
              <rdf:Description rdf:about=\"#COPASI42\">
                <dcterms:created>
                  <rdf:Description>
                    <dcterms:W3CDTF>2014-07-16T14:43:51Z</dcterms:W3CDTF>
                  </rdf:Description>
                </dcterms:created>
              </rdf:Description>
            </rdf:RDF>
    ...
    Real elmt_parameter_1(unit = "") "Dose";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
              <rdf:Description rdf:about=\"#COPASI43\">
                <dcterms:created>
                  <rdf:Description>
                    <dcterms:W3CDTF>2014-07-16T14:44:58Z</dcterms:W3CDTF>
                  </rdf:Description>
                </dcterms:created>
              </rdf:Description>
            </rdf:RDF>
    ...
    Real elmt_ModelValue_48(unit = "") "Initial for Dose";
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_mwa09d6284_843e_404e_abbb_052fbb535197(unit = "") "kIL6AbBind";
    ...
    Real elmt_Metabolite_6(unit = "") "Initial for Ab";
 annotation(Documentation(info="<annotation>
          <initialValue xmlns=\"http://copasi.org/initialValue\" parent=\"mwf345ed7a_0622_403c_b816_c8749a2c9ded\"/>
        </annotation>"));
    ...
    Real elmt_mw1c4bc9c3_52ad_4ef7_bf7f_97b0e2101ead(unit = "") "kIL6AbUnbind";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
              <rdf:Description rdf:about=\"#COPASI41\">
                <dcterms:created>
                  <rdf:Description>
                    <dcterms:W3CDTF>2014-07-09T14:26:46Z</dcterms:W3CDTF>
                  </rdf:Description>
                </dcterms:created>
              </rdf:Description>
            </rdf:RDF>
    ...
    initial equation
        ...
        elmt_ModelValue_48 = elmt_parameter_1;
        elmt_kRsynth = 0.0685;
        ...
        elmt_mwa8d72918_f6c2_4d81_bf3b_fc2b464d5e69 = 0.0017;
        ...
        elmt_kRdeg = 0.1561;
        elmt_mwa09d6284_843e_404e_abbb_052fbb535197 = 1000.0;
        ...
        elmt_Metabolite_6 = elmt_mwf345ed7a_0622_403c_b816_c8749a2c9ded;
        ...
        elmt_mw1c4bc9c3_52ad_4ef7_bf7f_97b0e2101ead = 2.5;
    ...
    equation
        ...
        der(elmt_kRLOff) = 0;
        der(elmt_mw427cd601_2c01_42ea_85dc_ab7c5a601fd8) = 0;
        ...
        der(elmt_kRdeg) = 0;
        der(elmt_mwa09d6284_843e_404e_abbb_052fbb535197) = 0;
        ...
        der(elmt_mw1c4bc9c3_52ad_4ef7_bf7f_97b0e2101ead) = 0;
