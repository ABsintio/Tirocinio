...
class Functions
    ...
    function elmt_function_4_v19f_1
        input Real arg_Hog1PP;
        input Real arg_Pfk2627i;
        input Real arg_kv19f_1;

        output Real result;
        algorithm
            result := (arg_kv19f_1 * arg_Hog1PP * arg_Pfk2627i);
    end elmt_function_4_v19f_1;
    ...
    function elmt_function_4_v22
        ...
        output Real result;
        algorithm
            result := ((((arg_kv22_1 * (- arg_Turgor)) / (arg_kv22_3 + (- arg_Turgor))) * 1.5 * (1.0 - ((arg_Hog1PP * 1.29462) / ((arg_Hog1PP * 1.29462) + arg_kv22_2)))) - (arg_kv22_1 * arg_Fps1r));
