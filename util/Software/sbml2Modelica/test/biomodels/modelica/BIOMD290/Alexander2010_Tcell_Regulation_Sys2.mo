within BIOMD290;
model Alexander2010_Tcell_Regulation_Sys2 "Alexander2010_Tcell_Regulation_Sys2" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_v_max = Params.elmt_v_max;
...
end Alexander2010_Tcell_Regulation_Sys2;
