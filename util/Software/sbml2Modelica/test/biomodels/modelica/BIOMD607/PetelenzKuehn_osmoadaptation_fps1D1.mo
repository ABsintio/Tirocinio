within BIOMD607;
model PetelenzKuehn_osmoadaptation_fps1D1 "PetelenzKuehn_osmoadaptation_fps1D1" annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        Reacs.elmt_kv16r_1VARIABLE = Params.elmt_kv16r_1VARIABLE;
...
end PetelenzKuehn_osmoadaptation_fps1D1;
