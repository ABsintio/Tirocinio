...
class Class_elmt_compartment
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_Xa_TFPI_amount) = ((- (elmt_reaction_5 * elmt_reactant12)) + (elmt_reaction_4 * elmt_product10));
        der(elmt_TFPI_amount) = (- (elmt_reaction_4 * elmt_reactant9));
        der(elmt_X_amount) = (- (elmt_reaction_1 * elmt_reactant0));
        der(elmt_Xa_TFPI_VIIa_TF_amount) = (elmt_reaction_5 * elmt_product13);
        der(elmt_VIIa_TF_Xa_amount) = ((- (elmt_reaction_3 * elmt_reactant5)) + (elmt_reaction_2 * elmt_product4));
