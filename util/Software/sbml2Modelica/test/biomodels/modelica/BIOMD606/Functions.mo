...
class Functions
    ...
    function elmt_function_4_v15f_1
        input Real arg_G6P;
        input Real arg_Pfk2627a;
        input Real arg_kv15f_1;
        input Real arg_kv15f_2;

        output Real result;
        algorithm
            result := ((arg_G6P * arg_kv15f_1 * arg_Pfk2627a) / (arg_kv15f_2 + arg_G6P));
    end elmt_function_4_v15f_1;
    ...
    function elmt_v22_t_1
        input Real arg_Fps1r;
        input Real arg_PetelenzKuehn_osmoadaptation_hog1D;
        input Real arg_Turgor;
        input Real arg_kv22_1;
        input Real arg_kv22_3;
        input Real arg_kv22_Hog1D_d;
        input Real arg_kv22_Hog1D_fT;
        input Real arg_kv22_Hog1D_t;

        output Real result;
        algorithm
            result := (if (arg_PetelenzKuehn_osmoadaptation_hog1D < arg_kv22_Hog1D_t) then ((((arg_kv22_1 * (- arg_Turgor)) / (arg_kv22_3 + (- arg_Turgor))) * 1.5 * 1.0) - (arg_kv22_1 * arg_Fps1r)) else (((((arg_kv22_1 * arg_kv22_Hog1D_fT) / (arg_kv22_3 + arg_kv22_Hog1D_fT)) * 1.5 * 1.0) - (arg_kv22_1 * arg_Fps1r)) * arg_kv22_Hog1D_d));
    end elmt_v22_t_1;
    ...
    function elmt_Henri_Michaelis_Menten__irreversible__3
    ...
    end elmt_Henri_Michaelis_Menten__irreversible__3;

    function elmt_Henri_Michaelis_Menten__irreversible__4
    ...
    end elmt_Henri_Michaelis_Menten__irreversible__4;

    function elmt_Henri_Michaelis_Menten__irreversible__5
    ...
    end elmt_Henri_Michaelis_Menten__irreversible__5;
    ...
    function elmt_Henri_Michaelis_Menten__irreversible__6
    ...
    end elmt_Henri_Michaelis_Menten__irreversible__6;
    ...
    function elmt_Henri_Michaelis_Menten__irreversible__2
        input Real arg_F26DP;
        input Real arg_kv15r_1;
        input Real arg_kv15r_2;

        output Real result;
        algorithm
            result := ((arg_kv15r_1 * arg_F26DP) / (arg_kv15r_2 + arg_F26DP));
    end elmt_Henri_Michaelis_Menten__irreversible__2;
