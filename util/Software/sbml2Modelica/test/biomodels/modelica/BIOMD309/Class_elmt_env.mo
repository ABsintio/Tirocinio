...
class Class_elmt_env
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        elmt_S = elmt_S_conc;
        elmt_R = elmt_R_conc;
        elmt_Ep_amount = (elmt_Et - elmt_E) * elmt_env;
        elmt_E_amount = (elmt_Et * (((2.0 * elmt_k3 * elmt_J4) / (((elmt_k4 * elmt_R) - elmt_k3) + (elmt_J3 * (elmt_k4 * elmt_R)) + (elmt_J4 * elmt_k3) + Functions.pow((Functions.pow((((elmt_k4 * elmt_R) - elmt_k3) + (elmt_J3 * (elmt_k4 * elmt_R)) + (elmt_J4 * elmt_k3)), 2.0) - (4.0 * ((elmt_k4 * elmt_R) - elmt_k3) * elmt_k3 * elmt_J4)), (1.0 / 2.0)))))) * elmt_env;
        der(elmt_S_amount) = 0;
        der(elmt_R_amount) = ((- (elmt_r2 * elmt_reactant1)) + (elmt_r0 * elmt_product0));
