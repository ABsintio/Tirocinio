...
class Functions
    ...
    function elmt_function_1
        ...
        output Real result;
        algorithm
            result := (arg_theta / (arg_theta + (arg_a * Functions.pow(arg_Xj, arg_n))));
    end elmt_function_1;
    ...
    function elmt_function_2
        ...
        output Real result;
        algorithm
            result := ((arg_theta + (arg_b * Functions.pow((arg_Yi * arg_Yj), arg_n))) / (arg_theta + (arg_c * Functions.pow(arg_Xi, arg_n)) + (arg_b * Functions.pow((arg_Yi * arg_Yj), arg_n))));
    end elmt_function_2;
