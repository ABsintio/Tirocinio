...
class Parameters
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_parameter_1(unit = "") "DoseQ2W";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
    ...
    Real elmt_ModelValue_98(unit = "") "Initial for Dose";
 annotation(Documentation(info="<annotation>
          <initialValue xmlns=\"http://copasi.org/initialValue\" parent=\"Dose\"/>
        </annotation>"));
    Real elmt_ModelValue_99(unit = "") "Initial for DoseQ2W";
 annotation(Documentation(info="<annotation>
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_mwa09d6284_843e_404e_abbb_052fbb535197(unit = "") "kIL6RBind";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
 ...
 annotation(Documentation(info="<annotation>
    ...
    Real elmt_Metabolite_40(unit = "") "Initial for CRP";
 annotation(Documentation(info="<annotation>
          <initialValue xmlns=\"http://copasi.org/initialValue\" parent=\"mw114aa90f_5f5b_4fe8_9406_361c8489b6a1\"/>
        </annotation>"));
    Real elmt_mw1c4bc9c3_52ad_4ef7_bf7f_97b0e2101ead(unit = "") "kIL6RUnbind";
 annotation(Documentation(info="<annotation>
          <COPASI xmlns=\"http://www.copasi.org/static/sbml\">
            <rdf:RDF xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\">
    ...
    initial equation
        ...
        elmt_ModelValue_98 = elmt_Dose;
        elmt_ModelValue_99 = elmt_parameter_1;
        ...
        elmt_Metabolite_40 = elmt_mw114aa90f_5f5b_4fe8_9406_361c8489b6a1;
    ...
    equation
        ...
        der(elmt_ModelValue_98) = 0;
        der(elmt_ModelValue_99) = 0;
