...
class Class_elmt_compartment
 ...
 annotation(Documentation(info="<annotation>
    ...
    equation
        ...
        der(elmt_y_amount) = ((elmt_R5 * elmt_product4) + (- (elmt_R6 * elmt_reactant5)));
        der(elmt_x_amount) = ((- (elmt_R3 * elmt_reactant1)) + (elmt_R1 * elmt_product0));
        der(elmt_y0_amount) = ((- (elmt_R5 * elmt_reactant3)) + (elmt_R4 * elmt_product2));
