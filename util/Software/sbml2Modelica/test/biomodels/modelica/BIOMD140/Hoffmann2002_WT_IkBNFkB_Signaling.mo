within BIOMD140;
model Hoffmann2002_WT_IkBNFkB_Signaling "Hoffmann2002_WT_IkBNFkB_Signaling" annotation(Documentation(info="<annotation>
...
end Hoffmann2002_WT_IkBNFkB_Signaling;
