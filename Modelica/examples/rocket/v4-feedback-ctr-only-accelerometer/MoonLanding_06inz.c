...
/*
 equation index: 4
 type: SIMPLE_ASSIGN
 $PRE._ctr._history = $_start(ctr.history)
 */
void MoonLanding_eqFunction_4(DATA *data)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,4};
  $P$PRE$Pctr$Phistory = $P$ATTRIBUTE$Pctr$Phistory.start;
  TRACE_POP
}
/*
 equation index: 5
...
/*
 equation index: 6
 type: SIMPLE_ASSIGN
 $PRE._ctr._thrust = $_start(ctr.thrust)
 */
void MoonLanding_eqFunction_6(DATA *data)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,6};
  $P$PRE$Pctr$Pthrust = $P$ATTRIBUTE$Pctr$Pthrust.start;
  TRACE_POP
}
/*
 equation index: 7
...
void MoonLanding_eqFunction_16(DATA *data)
{
  ...
  $Pctr$Pvelocity = $Pctr$Pinitial_velocity;
  TRACE_POP
}
/*
 equation index: 17
...
void MoonLanding_eqFunction_19(DATA *data)
{
  ...
  $Pctr$Paltitude = $Pctr$Pinitial_altitude;
  TRACE_POP
}
