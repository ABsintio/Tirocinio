...
LDFLAGS=-L"/home/enrico/Dropbox/teaching/2017/verifica-validazione-sistemi/modelica/examples/state-events/v3-noevent" -L"/usr/lib/omc" -L"/usr/lib" -Wl,-rpath,"/usr/lib/omc" -Wl,-rpath,"/usr/lib"    -Wl,-Bsymbolic-functions -Wl,-z,relro -lSimulationRuntimeC -llapack -lblas -lm -lgc -lpthread -rdynamic 
MAINFILE=System.c
MAINOBJ=System.o
...
omc_main_target: $(MAINOBJ) System_functions.h System_literals.h $(OFILES)
	$(CC) -I. -o System$(EXEEXT) $(MAINOBJ) $(OFILES) $(CPPFLAGS) -L"/home/enrico/Dropbox/teaching/2017/verifica-validazione-sistemi/modelica/examples/state-events/v3-noevent"   $(CFLAGS) $(LDFLAGS)
clean:
