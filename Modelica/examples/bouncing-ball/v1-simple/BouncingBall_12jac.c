...
int BouncingBall_initialAnalyticJacobianD(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int BouncingBall_initialAnalyticJacobianC(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int BouncingBall_initialAnalyticJacobianB(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
...
OMC_DISABLE_OPT
int BouncingBall_initialAnalyticJacobianA(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
...
int BouncingBall_functionJacA_column(void* inData, threadData_t *threadData)
{
  TRACE_PUSH
