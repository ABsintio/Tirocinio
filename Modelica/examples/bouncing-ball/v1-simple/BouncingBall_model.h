/* Simulation code for BouncingBall generated by the OpenModelica Compiler OpenModelica 1.13.0~dev-747-g0c1336f. */
...
extern int BouncingBall_initialAnalyticJacobianG(void* data, threadData_t *threadData);
extern int BouncingBall_initialAnalyticJacobianA(void* data, threadData_t *threadData);
extern int BouncingBall_initialAnalyticJacobianB(void* data, threadData_t *threadData);
extern int BouncingBall_initialAnalyticJacobianC(void* data, threadData_t *threadData);
extern int BouncingBall_initialAnalyticJacobianD(void* data, threadData_t *threadData);
extern int BouncingBall_functionJacG_column(void* data, threadData_t *threadData);
extern int BouncingBall_functionJacA_column(void* data, threadData_t *threadData);
extern int BouncingBall_functionJacB_column(void* data, threadData_t *threadData);
extern int BouncingBall_functionJacC_column(void* data, threadData_t *threadData);
extern int BouncingBall_functionJacD_column(void* data, threadData_t *threadData);
